...
8010003a:	c7 44 24 04 14 85 10 	movl   $0x80108514,0x4(%esp)
80100041:	80 
80100042:	c7 04 24 80 c6 10 80 	movl   $0x8010c680,(%esp)
80100049:	e8 ec 4f 00 00       	call   8010503a <initlock>
...
80100087:	c7 44 24 04 1b 85 10 	movl   $0x8010851b,0x4(%esp)
8010008e:	80 
8010008f:	89 04 24             	mov    %eax,(%esp)
80100092:	e8 40 4e 00 00       	call   80104ed7 <initsleeplock>
...
801000c9:	e8 8d 4f 00 00       	call   8010505b <acquire>
...
80100104:	e8 ba 4f 00 00       	call   801050c3 <release>
      acquiresleep(&b->lock);
80100109:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010010c:	83 c0 0c             	add    $0xc,%eax
8010010f:	89 04 24             	mov    %eax,(%esp)
80100112:	e8 fa 4d 00 00       	call   80104f11 <acquiresleep>
      return b;
...
8010017d:	e8 41 4f 00 00       	call   801050c3 <release>
      acquiresleep(&b->lock);
80100182:	8b 45 f4             	mov    -0xc(%ebp),%eax
80100185:	83 c0 0c             	add    $0xc,%eax
80100188:	89 04 24             	mov    %eax,(%esp)
8010018b:	e8 81 4d 00 00       	call   80104f11 <acquiresleep>
      return b;
...
801001a7:	c7 04 24 22 85 10 80 	movl   $0x80108522,(%esp)
...
801001fb:	e8 ae 4d 00 00       	call   80104fae <holdingsleep>
80100200:	85 c0                	test   %eax,%eax
80100202:	75 0c                	jne    80100210 <bwrite+0x24>
    panic("bwrite");
80100204:	c7 04 24 33 85 10 80 	movl   $0x80108533,(%esp)
...
8010023b:	e8 6e 4d 00 00       	call   80104fae <holdingsleep>
80100240:	85 c0                	test   %eax,%eax
80100242:	75 0c                	jne    80100250 <brelse+0x24>
    panic("brelse");
80100244:	c7 04 24 3a 85 10 80 	movl   $0x8010853a,(%esp)
...
80100259:	e8 0e 4d 00 00       	call   80104f6c <releasesleep>

  acquire(&bcache.lock);
8010025e:	c7 04 24 80 c6 10 80 	movl   $0x8010c680,(%esp)
80100265:	e8 f1 4d 00 00       	call   8010505b <acquire>
  b->refcnt--;
...
801002d1:	e8 ed 4d 00 00       	call   801050c3 <release>
}
801002d6:	c9                   	leave  
801002d7:	c3                   	ret    
...
801003e3:	e8 73 4c 00 00       	call   8010505b <acquire>
...
801003ed:	75 0c                	jne    801003fb <cprintf+0x33>
    panic("null fmt");
801003ef:	c7 04 24 41 85 10 80 	movl   $0x80108541,(%esp)
...
801004d6:	75 09                	jne    801004e1 <cprintf+0x119>
        s = "(null)";
801004d8:	c7 45 ec 4a 85 10 80 	movl   $0x8010854a,-0x14(%ebp)
      for(; *s; s++)
...
8010055b:	e8 63 4b 00 00       	call   801050c3 <release>
}
80100560:	c9                   	leave  
80100561:	c3                   	ret    
...
80100580:	c7 04 24 51 85 10 80 	movl   $0x80108551,(%esp)
...
80100592:	e8 31 fe ff ff       	call   801003c8 <cprintf>
  cprintf("\n");
80100597:	c7 04 24 65 85 10 80 	movl   $0x80108565,(%esp)
...
801005b0:	e8 59 4b 00 00       	call   8010510e <getcallerpcs>
  for(i=0; i<10; i++)
...
801005c9:	c7 04 24 67 85 10 80 	movl   $0x80108567,(%esp)
...
801006ba:	c7 04 24 6b 85 10 80 	movl   $0x8010856b,(%esp)
...
801006ee:	e8 a9 4c 00 00       	call   8010539c <memmove>
    pos -= 80;
...
8010071d:	e8 ab 4b 00 00       	call   801052cd <memset>
  }
...
801007fd:	e8 59 48 00 00       	call   8010505b <acquire>
  while((c = getc()) >= 0){
...
80100938:	e8 44 42 00 00       	call   80104b81 <wakeup>
        }
      }
      break;
...
80100959:	e8 65 47 00 00       	call   801050c3 <release>
  if(doprocdump) {
8010095e:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
80100962:	74 05                	je     80100969 <consoleintr+0x180>
    procdump();  // now call procdump() wo. cons.lock held
80100964:	e8 be 42 00 00       	call   80104c27 <procdump>
  }
}
80100969:	c9                   	leave  
8010096a:	c3                   	ret    
...
80100989:	e8 cd 46 00 00       	call   8010505b <acquire>
  while(n > 0){
...
801009a8:	e8 16 47 00 00       	call   801050c3 <release>
        ilock(ip);
...
801009d1:	e8 d4 40 00 00       	call   80104aaa <sleep>
    while(input.r == input.w){
...
80100a4d:	e8 71 46 00 00       	call   801050c3 <release>
  ilock(ip);
...
80100a81:	e8 d5 45 00 00       	call   8010505b <acquire>
  for(i = 0; i < n; i++)
...
80100abb:	e8 03 46 00 00       	call   801050c3 <release>
  ilock(ip);
...
80100ad6:	c7 44 24 04 7e 85 10 	movl   $0x8010857e,0x4(%esp)
80100add:	80 
80100ade:	c7 04 24 e0 b5 10 80 	movl   $0x8010b5e0,(%esp)
80100ae5:	e8 50 45 00 00       	call   8010503a <initlock>
...
80100b48:	e8 be 29 00 00       	call   8010350b <end_op>
    cprintf("exec: fail\n");
80100b4d:	c7 04 24 86 85 10 80 	movl   $0x80108586,(%esp)
...
80100bb1:	e9 85 03 00 00       	jmp    80100f3b <exec+0x41d>
  ...
  if((pgdir = setupkvm()) == 0)
80100bb6:	e8 a4 70 00 00       	call   80107c5f <setupkvm>
...
80100c74:	e8 bc 73 00 00       	call   80108035 <allocuvm>
...
80100cc6:	e8 87 72 00 00       	call   80107f52 <loaduvm>
...
80100d34:	e8 fc 72 00 00       	call   80108035 <allocuvm>
...
80100d59:	e8 4a 75 00 00       	call   801082a8 <clearpteu>
  sp = sz;
...
80100d8f:	e8 a3 47 00 00       	call   80105537 <strlen>
...
80100db8:	e8 7a 47 00 00       	call   80105537 <strlen>
...
80100de8:	e8 7e 76 00 00       	call   8010846b <copyout>
...
80100e8f:	e8 d7 75 00 00       	call   8010846b <copyout>
...
80100ee4:	e8 04 46 00 00       	call   801054ed <safestrcpy>
...
80100f24:	e8 10 6e 00 00       	call   80107d39 <switchuvm>
  freevm(oldpgdir);
80100f29:	8b 45 cc             	mov    -0x34(%ebp),%eax
80100f2c:	89 04 24             	mov    %eax,(%esp)
80100f2f:	e8 dd 72 00 00       	call   80108211 <freevm>
  return 0;
...
80100f47:	e8 c5 72 00 00       	call   80108211 <freevm>
  if(ip){
...
80100f6f:	c7 44 24 04 92 85 10 	movl   $0x80108592,0x4(%esp)
80100f76:	80 
80100f77:	c7 04 24 80 10 11 80 	movl   $0x80111080,(%esp)
80100f7e:	e8 b7 40 00 00       	call   8010503a <initlock>
}
80100f83:	c9                   	leave  
80100f84:	c3                   	ret    
...
80100f92:	e8 c4 40 00 00       	call   8010505b <acquire>
...
80100fbb:	e8 03 41 00 00       	call   801050c3 <release>
      return f;
...
80100fd9:	e8 e5 40 00 00       	call   801050c3 <release>
  return 0;
...
80100ff2:	e8 64 40 00 00       	call   8010505b <acquire>
  if(f->ref < 1)
...
80100fff:	7f 0c                	jg     8010100d <filedup+0x28>
    panic("filedup");
80101001:	c7 04 24 99 85 10 80 	movl   $0x80108599,(%esp)
...
80101023:	e8 9b 40 00 00       	call   801050c3 <release>
  return f;
...
8010103a:	e8 1c 40 00 00       	call   8010505b <acquire>
  if(f->ref < 1)
...
80101047:	7f 0c                	jg     80101055 <fileclose+0x28>
    panic("fileclose");
80101049:	c7 04 24 a1 85 10 80 	movl   $0x801085a1,(%esp)
...
80101075:	e8 49 40 00 00       	call   801050c3 <release>
...
801010bf:	e8 ff 3f 00 00       	call   801050c3 <release>
...
801011fe:	eb 0c                	jmp    8010120c <fileread+0xba>
  ...
  panic("fileread");
80101200:	c7 04 24 ab 85 10 80 	movl   $0x801085ab,(%esp)
...
8010130c:	c7 04 24 b4 85 10 80 	movl   $0x801085b4,(%esp)
...
8010133c:	eb 0c                	jmp    8010134a <filewrite+0x13c>
  ...
  panic("filewrite");
8010133e:	c7 04 24 c4 85 10 80 	movl   $0x801085c4,(%esp)
...
80101384:	e8 13 40 00 00       	call   8010539c <memmove>
  brelse(bp);
...
801013ca:	e8 fe 3e 00 00       	call   801052cd <memset>
  log_write(bp);
...
80101517:	c7 04 24 d0 85 10 80 	movl   $0x801085d0,(%esp)
...
801015a6:	c7 04 24 e6 85 10 80 	movl   $0x801085e6,(%esp)
...
80101600:	c7 44 24 04 f9 85 10 	movl   $0x801085f9,0x4(%esp)
80101607:	80 
80101608:	c7 04 24 a0 1a 11 80 	movl   $0x80111aa0,(%esp)
8010160f:	e8 26 3a 00 00       	call   8010503a <initlock>
  for(i = 0; i < NINODE; i++) {
...
80101635:	c7 44 24 04 00 86 10 	movl   $0x80108600,0x4(%esp)
8010163c:	80 
8010163d:	89 04 24             	mov    %eax,(%esp)
80101640:	e8 92 38 00 00       	call   80104ed7 <initsleeplock>
  for(i = 0; i < NINODE; i++) {
...
801016af:	c7 04 24 08 86 10 80 	movl   $0x80108608,(%esp)
...
80101732:	e8 96 3b 00 00       	call   801052cd <memset>
      dip->type = type;
...
8010178a:	c7 04 24 5b 86 10 80 	movl   $0x8010865b,(%esp)
...
80101839:	e8 5e 3b 00 00       	call   8010539c <memmove>
  log_write(bp);
...
80101863:	e8 f3 37 00 00       	call   8010505b <acquire>
...
801018ad:	e8 11 38 00 00       	call   801050c3 <release>
      return ip;
...
801018e3:	c7 04 24 6d 86 10 80 	movl   $0x8010866d,(%esp)
...
80101921:	e8 9d 37 00 00       	call   801050c3 <release>
...
80101938:	e8 1e 37 00 00       	call   8010505b <acquire>
  ip->ref++;
...
80101953:	e8 6b 37 00 00       	call   801050c3 <release>
  return ip;
...
80101971:	7f 0c                	jg     8010197f <ilock+0x22>
    panic("ilock");
80101973:	c7 04 24 7d 86 10 80 	movl   $0x8010867d,(%esp)
...
80101988:	e8 84 35 00 00       	call   80104f11 <acquiresleep>
...
80101a36:	e8 61 39 00 00       	call   8010539c <memmove>
    brelse(bp);
...
80101a5a:	75 0c                	jne    80101a68 <ilock+0x10b>
      panic("ilock: no type");
80101a5c:	c7 04 24 83 86 10 80 	movl   $0x80108683,(%esp)
...
80101a7f:	e8 2a 35 00 00       	call   80104fae <holdingsleep>
...
80101a90:	7f 0c                	jg     80101a9e <iunlock+0x34>
    panic("iunlock");
80101a92:	c7 04 24 92 86 10 80 	movl   $0x80108692,(%esp)
...
80101aa7:	e8 c0 34 00 00       	call   80104f6c <releasesleep>
}
80101aac:	c9                   	leave  
80101aad:	c3                   	ret    
...
80101abd:	e8 4f 34 00 00       	call   80104f11 <acquiresleep>
...
80101adf:	e8 77 35 00 00       	call   8010505b <acquire>
    int r = ip->ref;
...
80101af4:	e8 ca 35 00 00       	call   801050c3 <release>
    if(r == 1){
...
80101b31:	e8 36 34 00 00       	call   80104f6c <releasesleep>

  acquire(&icache.lock);
80101b36:	c7 04 24 a0 1a 11 80 	movl   $0x80111aa0,(%esp)
80101b3d:	e8 19 35 00 00       	call   8010505b <acquire>
  ip->ref--;
...
80101b58:	e8 66 35 00 00       	call   801050c3 <release>
}
80101b5d:	c9                   	leave  
80101b5e:	c3                   	ret    
...
80101c7e:	c7 04 24 9a 86 10 80 	movl   $0x8010869a,(%esp)
...
80101f2b:	e8 6c 34 00 00       	call   8010539c <memmove>
    brelse(bp);
...
8010208a:	e8 0d 33 00 00       	call   8010539c <memmove>
    log_write(bp);
...
80102108:	e8 32 33 00 00       	call   8010543f <strncmp>
}
8010210d:	c9                   	leave  
8010210e:	c3                   	ret    
...
80102122:	c7 04 24 ad 86 10 80 	movl   $0x801086ad,(%esp)
...
80102160:	c7 04 24 bf 86 10 80 	movl   $0x801086bf,(%esp)
...
80102243:	74 0c                	je     80102251 <dirlink+0x79>
      panic("dirlink read");
80102245:	c7 04 24 ce 86 10 80 	movl   $0x801086ce,(%esp)
...
8010228a:	e8 06 32 00 00       	call   80105495 <strncpy>
  de.inum = inum;
...
801022ba:	74 0c                	je     801022c8 <dirlink+0xf0>
    panic("dirlink");
801022bc:	c7 04 24 db 86 10 80 	movl   $0x801086db,(%esp)
...
80102341:	e8 56 30 00 00       	call   8010539c <memmove>
  else {
    memmove(name, s, len);
    name[len] = 0;
  }
...
8010235c:	e8 3b 30 00 00       	call   8010539c <memmove>
    name[len] = 0;
...
801025aa:	c7 44 24 04 e3 86 10 	movl   $0x801086e3,0x4(%esp)
801025b1:	80 
801025b2:	c7 04 24 20 b6 10 80 	movl   $0x8010b620,(%esp)
801025b9:	e8 7c 2a 00 00       	call   8010503a <initlock>
...
80102648:	75 0c                	jne    80102656 <idestart+0x18>
    panic("idestart");
8010264a:	c7 04 24 e7 86 10 80 	movl   $0x801086e7,(%esp)
...
80102663:	c7 04 24 f0 86 10 80 	movl   $0x801086f0,(%esp)
...
801026b5:	c7 04 24 e7 86 10 80 	movl   $0x801086e7,(%esp)
...
801027d5:	e8 81 28 00 00       	call   8010505b <acquire>
...
801027ef:	e8 cf 28 00 00       	call   801050c3 <release>
    return;
...
80102862:	e8 1a 23 00 00       	call   80104b81 <wakeup>
...
80102884:	e8 3a 28 00 00       	call   801050c3 <release>
}
80102889:	c9                   	leave  
8010288a:	c3                   	ret    
...
8010289a:	e8 0f 27 00 00       	call   80104fae <holdingsleep>
8010289f:	85 c0                	test   %eax,%eax
801028a1:	75 0c                	jne    801028af <iderw+0x24>
    panic("iderw: buf not locked");
801028a3:	c7 04 24 02 87 10 80 	movl   $0x80108702,(%esp)
...
801028bc:	c7 04 24 18 87 10 80 	movl   $0x80108718,(%esp)
...
80102949:	e8 5c 21 00 00       	call   80104aaa <sleep>
  while((b->flags & (B_VALID|B_DIRTY)) != B_VALID){
...
80102962:	e8 5c 27 00 00       	call   801050c3 <release>
}
80102967:	c9                   	leave  
80102968:	c3                   	ret    
...
801029e2:	c7 04 24 4c 87 10 80 	movl   $0x8010874c,(%esp)
...
80102a84:	c7 44 24 04 7e 87 10 	movl   $0x8010877e,0x4(%esp)
80102a8b:	80 
80102a8c:	c7 04 24 00 37 11 80 	movl   $0x80113700,(%esp)
80102a93:	e8 a2 25 00 00       	call   8010503a <initlock>
  kmem.use_lock = 0;
...
80102b3b:	76 0c                	jbe    80102b49 <kfree+0x36>
    panic("kfree");
80102b3d:	c7 04 24 83 87 10 80 	movl   $0x80108783,(%esp)
...
80102b5f:	e8 69 27 00 00       	call   801052cd <memset>
...
80102b74:	e8 e2 24 00 00       	call   8010505b <acquire>
  r = (struct run*)v;
...
80102ba2:	e8 1c 25 00 00       	call   801050c3 <release>
}
80102ba7:	c9                   	leave  
80102ba8:	c3                   	ret    
...
80102bbf:	e8 97 24 00 00       	call   8010505b <acquire>
  r = kmem.freelist;
...
80102bec:	e8 d2 24 00 00       	call   801050c3 <release>
  return (char*)r;
...
80103189:	e8 b6 21 00 00       	call   80105344 <memcmp>
...
80103289:	c7 44 24 04 89 87 10 	movl   $0x80108789,0x4(%esp)
80103290:	80 
80103291:	c7 04 24 40 37 11 80 	movl   $0x80113740,(%esp)
80103298:	e8 9d 1d 00 00       	call   8010503a <initlock>
  readsb(dev, &sb);
...
80103342:	e8 55 20 00 00       	call   8010539c <memmove>
...
80103494:	e8 c2 1b 00 00       	call   8010505b <acquire>
  while(1){
    if(log.committing){
...
801034b1:	e8 f4 15 00 00       	call   80104aaa <sleep>
...
801034e5:	e8 c0 15 00 00       	call   80104aaa <sleep>
...
80103500:	e8 be 1b 00 00       	call   801050c3 <release>
      break;
...
8010351f:	e8 37 1b 00 00       	call   8010505b <acquire>
  log.outstanding -= 1;
...
8010353a:	c7 04 24 8d 87 10 80 	movl   $0x8010878d,(%esp)
...
80103569:	e8 13 16 00 00       	call   80104b81 <wakeup>
  }
  release(&log.lock);
8010356e:	c7 04 24 40 37 11 80 	movl   $0x80113740,(%esp)
80103575:	e8 49 1b 00 00       	call   801050c3 <release>
...
80103629:	e8 6e 1d 00 00       	call   8010539c <memmove>
...
801036b4:	c7 04 24 9c 87 10 80 	movl   $0x8010879c,(%esp)
...
801036c9:	c7 04 24 b2 87 10 80 	movl   $0x801087b2,(%esp)
801036d0:	e8 8d ce ff ff       	call   80100562 <panic>

  acquire(&log.lock);
801036d5:	c7 04 24 40 37 11 80 	movl   $0x80113740,(%esp)
801036dc:	e8 7a 19 00 00       	call   8010505b <acquire>
  for (i = 0; i < log.lh.n; i++) {
...
80103753:	e8 6b 19 00 00       	call   801050c3 <release>
}
80103758:	c9                   	leave  
80103759:	c3                   	ret    
...
801037b4:	e8 a5 33 00 00       	call   80106b5e <uartinit>
  pinit();         // process table
801037b9:	e8 f0 08 00 00       	call   801040ae <pinit>
  tvinit();        // trap vectors
801037be:	e8 64 2f 00 00       	call   80106727 <tvinit>
  binit();         // buffer cache
...
801037f8:	83 ec 08             	sub    $0x8,%esp
  switchkvm();
801037fb:	e8 1f 45 00 00       	call   80107d1f <switchkvm>
  seginit();
80103800:	e8 cf 3f 00 00       	call   801077d4 <seginit>
  lapicinit();
...
8010382a:	c7 04 24 cd 87 10 80 	movl   $0x801087cd,(%esp)
80103831:	e8 92 cb ff ff       	call   801003c8 <cprintf>
  idtinit();       // load idt register
80103836:	e8 60 30 00 00       	call   8010689b <idtinit>
...
8010387e:	e8 19 1b 00 00       	call   8010539c <memmove>
...
801039bb:	00 
801039bc:	c7 44 24 04 e4 87 10 	movl   $0x801087e4,0x4(%esp)
801039c3:	80 
801039c4:	8b 45 f4             	mov    -0xc(%ebp),%eax
801039c7:	89 04 24             	mov    %eax,(%esp)
801039ca:	e8 75 19 00 00       	call   80105344 <memcmp>
...
80103af9:	00 
80103afa:	c7 44 24 04 e9 87 10 	movl   $0x801087e9,0x4(%esp)
80103b01:	80 
80103b02:	8b 45 f0             	mov    -0x10(%ebp),%eax
80103b05:	89 04 24             	mov    %eax,(%esp)
80103b08:	e8 37 18 00 00       	call   80105344 <memcmp>
...
80103b80:	c7 04 24 ee 87 10 80 	movl   $0x801087ee,(%esp)
...
80103bc9:	8b 04 85 28 88 10 80 	mov    -0x7fef77d8(,%eax,4),%eax
...
80103c48:	c7 04 24 08 88 10 80 	movl   $0x80108808,(%esp)
...
80103d7d:	c7 44 24 04 3c 88 10 	movl   $0x8010883c,0x4(%esp)
80103d84:	80 
80103d85:	89 04 24             	mov    %eax,(%esp)
80103d88:	e8 ad 12 00 00       	call   8010503a <initlock>
  (*f0)->type = FD_PIPE;
...
80103e34:	e8 22 12 00 00       	call   8010505b <acquire>
  if(writable){
...
80103e57:	e8 25 0d 00 00       	call   80104b81 <wakeup>
...
80103e76:	e8 06 0d 00 00       	call   80104b81 <wakeup>
  }
...
80103e9b:	e8 23 12 00 00       	call   801050c3 <release>
    kfree((char*)p);
...
80103eb3:	e8 0b 12 00 00       	call   801050c3 <release>
}
80103eb8:	c9                   	leave  
80103eb9:	c3                   	ret    
...
80103ec6:	e8 90 11 00 00       	call   8010505b <acquire>
  for(i = 0; i < n; i++){
...
80103ef8:	e8 c6 11 00 00       	call   801050c3 <release>
        return -1;
...
80103f12:	e8 6a 0c 00 00       	call   80104b81 <wakeup>
...
80103f2a:	e8 7b 0b 00 00       	call   80104aaa <sleep>
    while(p->nwrite == p->nread + PIPESIZE){  //DOC: pipewrite-full
...
80103f93:	e8 e9 0b 00 00       	call   80104b81 <wakeup>
  release(&p->lock);
80103f98:	8b 45 08             	mov    0x8(%ebp),%eax
80103f9b:	89 04 24             	mov    %eax,(%esp)
80103f9e:	e8 20 11 00 00       	call   801050c3 <release>
  return n;
...
80103fb5:	e8 a1 10 00 00       	call   8010505b <acquire>
...
80103fce:	e8 f0 10 00 00       	call   801050c3 <release>
      return -1;
...
80103ff0:	e8 b5 0a 00 00       	call   80104aaa <sleep>
  while(p->nread == p->nwrite && p->writeopen){  //DOC: pipe-empty
...
8010407f:	e8 fd 0a 00 00       	call   80104b81 <wakeup>
  release(&p->lock);
80104084:	8b 45 08             	mov    0x8(%ebp),%eax
80104087:	89 04 24             	mov    %eax,(%esp)
8010408a:	e8 34 10 00 00       	call   801050c3 <release>
  return i;
...
801040b4:	c7 44 24 04 44 88 10 	movl   $0x80108844,0x4(%esp)
801040bb:	80 
801040bc:	c7 04 24 e0 3d 11 80 	movl   $0x80113de0,(%esp)
801040c3:	e8 72 0f 00 00       	call   8010503a <initlock>
}
801040c8:	c9                   	leave  
801040c9:	c3                   	ret    
...
801040ff:	c7 04 24 4c 88 10 80 	movl   $0x8010884c,(%esp)
...
80104153:	c7 04 24 72 88 10 80 	movl   $0x80108872,(%esp)
...
80104164:	83 ec 18             	sub    $0x18,%esp
  ...
  struct proc *p;
  pushcli();
80104167:	e8 5c 10 00 00       	call   801051c8 <pushcli>
  c = mycpu();
...
8010417d:	89 45 f0             	mov    %eax,-0x10(%ebp)
  popcli();
80104180:	e8 8f 10 00 00       	call   80105214 <popcli>
  return p;
...
80104197:	e8 bf 0e 00 00       	call   8010505b <acquire>
...
801041d5:	e8 e9 0e 00 00       	call   801050c3 <release>
...
80104208:	e8 b6 0e 00 00       	call   801050c3 <release>
  return 0;
...
80104244:	ba e2 66 10 80       	mov    $0x801066e2,%edx
...
80104274:	e8 54 10 00 00       	call   801052cd <memset>
  p->context->eip = (uint)forkret;
80104279:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010427c:	8b 40 1c             	mov    0x1c(%eax),%eax
8010427f:	ba 6b 4a 10 80       	mov    $0x80104a6b,%edx
...
801042a2:	e8 b8 39 00 00       	call   80107c5f <setupkvm>
...
801042b7:	c7 04 24 82 88 10 80 	movl   $0x80108882,(%esp)
...
801042dd:	e8 e8 3b 00 00       	call   80107eca <inituvm>
  p->sz = PGSIZE;
...
80104304:	e8 c4 0f 00 00       	call   801052cd <memset>
...
80104394:	00 
80104395:	c7 44 24 04 9b 88 10 	movl   $0x8010889b,0x4(%esp)
8010439c:	80 
8010439d:	89 04 24             	mov    %eax,(%esp)
801043a0:	e8 48 11 00 00       	call   801054ed <safestrcpy>
  p->cwd = namei("/");
801043a5:	c7 04 24 a4 88 10 80 	movl   $0x801088a4,(%esp)
...
801043be:	e8 98 0c 00 00       	call   8010505b <acquire>
...
801043d4:	e8 ea 0c 00 00       	call   801050c3 <release>
}
801043d9:	c9                   	leave  
801043da:	c3                   	ret    
...
80104413:	e8 1d 3c 00 00       	call   80108035 <allocuvm>
...
8010444a:	e8 fc 3c 00 00       	call   8010814b <deallocuvm>
...
8010446d:	e8 c7 38 00 00       	call   80107d39 <switchuvm>
  return 0;
...
801044b4:	e8 35 3e 00 00       	call   801082ee <copyuvm>
...
801045a5:	e8 43 0f 00 00       	call   801054ed <safestrcpy>
...
801045ea:	e8 6c 0a 00 00       	call   8010505b <acquire>
...
80104600:	e8 be 0a 00 00       	call   801050c3 <release>
...
80104626:	75 0c                	jne    80104634 <exit+0x24>
    panic("init exiting");
80104628:	c7 04 24 a6 88 10 80 	movl   $0x801088a6,(%esp)
...
801046a7:	e8 af 09 00 00       	call   8010505b <acquire>
...
801046b5:	e8 86 04 00 00       	call   80104b40 <wakeup1>
...
801046ed:	e8 4e 04 00 00       	call   80104b40 <wakeup1>
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
...
80104705:	c7 40 0c 05 00 00 00 	movl   $0x5,0xc(%eax)
  sched();
8010470c:	e8 7a 02 00 00       	call   8010498b <sched>
  panic("zombie exit");
80104711:	c7 04 24 b3 88 10 80 	movl   $0x801088b3,(%esp)
...
80104732:	e8 24 09 00 00       	call   8010505b <acquire>
  for(;;){
...
80104796:	e8 76 3a 00 00       	call   80108211 <freevm>
        p->pid = 0;
...
801047d1:	e8 ed 08 00 00       	call   801050c3 <release>
        return pid;
...
80104806:	e8 b8 08 00 00       	call   801050c3 <release>
      return -1;
...
80104820:	e8 85 02 00 00       	call   80104aaa <sleep>
  }
...
80104885:	e8 d1 07 00 00       	call   8010505b <acquire>
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
...
801048b7:	72 da                	jb     80104893 <scheduler+0x43>
    ...
    release(&ptable.lock);
801048b9:	c7 04 24 e0 3d 11 80 	movl   $0x80113de0,(%esp)
801048c0:	e8 fe 07 00 00       	call   801050c3 <release>
    
    if(runnableTickets <= 0)
801048c5:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
801048c9:	7f 03                	jg     801048ce <scheduler+0x7e>
        continue;
801048cb:	90                   	nop
...
801048dd:	89 55 e0             	mov    %edx,-0x20(%ebp)
    acquire(&ptable.lock);
801048e0:	c7 04 24 e0 3d 11 80 	movl   $0x80113de0,(%esp)
801048e7:	e8 6f 07 00 00       	call   8010505b <acquire>
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++)
801048ec:	c7 45 f4 14 3e 11 80 	movl   $0x80113e14,-0xc(%ebp)
801048f3:	eb 78                	jmp    8010496d <scheduler+0x11d>
      counter = counter + p->tickets;
801048f5:	8b 45 f4             	mov    -0xc(%ebp),%eax
801048f8:	8b 40 7c             	mov    0x7c(%eax),%eax
801048fb:	01 45 ec             	add    %eax,-0x14(%ebp)
      if(counter > winner)
801048fe:	8b 45 ec             	mov    -0x14(%ebp),%eax
80104901:	3b 45 e0             	cmp    -0x20(%ebp),%eax
80104904:	7e 60                	jle    80104966 <scheduler+0x116>
        c->proc = p;
80104906:	8b 45 e8             	mov    -0x18(%ebp),%eax
80104909:	8b 55 f4             	mov    -0xc(%ebp),%edx
8010490c:	89 90 ac 00 00 00    	mov    %edx,0xac(%eax)
        switchuvm(p);
80104912:	8b 45 f4             	mov    -0xc(%ebp),%eax
80104915:	89 04 24             	mov    %eax,(%esp)
80104918:	e8 1c 34 00 00       	call   80107d39 <switchuvm>
        p->state = RUNNING;
8010491d:	8b 45 f4             	mov    -0xc(%ebp),%eax
80104920:	c7 40 0c 04 00 00 00 	movl   $0x4,0xc(%eax)
        p->ticks += 1;
80104927:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010492a:	8b 80 80 00 00 00    	mov    0x80(%eax),%eax
80104930:	8d 50 01             	lea    0x1(%eax),%edx
80104933:	8b 45 f4             	mov    -0xc(%ebp),%eax
80104936:	89 90 80 00 00 00    	mov    %edx,0x80(%eax)
        swtch(&(c->scheduler), p->context);
8010493c:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010493f:	8b 40 1c             	mov    0x1c(%eax),%eax
80104942:	8b 55 e8             	mov    -0x18(%ebp),%edx
80104945:	83 c2 04             	add    $0x4,%edx
80104948:	89 44 24 04          	mov    %eax,0x4(%esp)
8010494c:	89 14 24             	mov    %edx,(%esp)
8010494f:	e8 0a 0c 00 00       	call   8010555e <swtch>
        switchkvm();
80104954:	e8 c6 33 00 00       	call   80107d1f <switchkvm>
        c->proc = 0;
80104959:	8b 45 e8             	mov    -0x18(%ebp),%eax
8010495c:	c7 80 ac 00 00 00 00 	movl   $0x0,0xac(%eax)
80104963:	00 00 00 
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++)
80104966:	81 45 f4 84 00 00 00 	addl   $0x84,-0xc(%ebp)
8010496d:	81 7d f4 14 5f 11 80 	cmpl   $0x80115f14,-0xc(%ebp)
80104974:	0f 82 7b ff ff ff    	jb     801048f5 <scheduler+0xa5>
    release(&ptable.lock);
8010497a:	c7 04 24 e0 3d 11 80 	movl   $0x80113de0,(%esp)
80104981:	e8 3d 07 00 00       	call   801050c3 <release>
  }
80104986:	e9 e0 fe ff ff       	jmp    8010486b <scheduler+0x1b>
...
80104991:	e8 cb f7 ff ff       	call   80104161 <myproc>
80104996:	89 45 f4             	mov    %eax,-0xc(%ebp)

  if(!holding(&ptable.lock))
80104999:	c7 04 24 e0 3d 11 80 	movl   $0x80113de0,(%esp)
801049a0:	e8 e2 07 00 00       	call   80105187 <holding>
801049a5:	85 c0                	test   %eax,%eax
801049a7:	75 0c                	jne    801049b5 <sched+0x2a>
    panic("sched ptable.lock");
801049a9:	c7 04 24 bf 88 10 80 	movl   $0x801088bf,(%esp)
801049b0:	e8 ad bb ff ff       	call   80100562 <panic>
  if(mycpu()->ncli != 1)
801049b5:	e8 31 f7 ff ff       	call   801040eb <mycpu>
801049ba:	8b 80 a4 00 00 00    	mov    0xa4(%eax),%eax
801049c0:	83 f8 01             	cmp    $0x1,%eax
801049c3:	74 0c                	je     801049d1 <sched+0x46>
    panic("sched locks");
801049c5:	c7 04 24 d1 88 10 80 	movl   $0x801088d1,(%esp)
801049cc:	e8 91 bb ff ff       	call   80100562 <panic>
  if(p->state == RUNNING)
801049d1:	8b 45 f4             	mov    -0xc(%ebp),%eax
801049d4:	8b 40 0c             	mov    0xc(%eax),%eax
801049d7:	83 f8 04             	cmp    $0x4,%eax
801049da:	75 0c                	jne    801049e8 <sched+0x5d>
    panic("sched running");
801049dc:	c7 04 24 dd 88 10 80 	movl   $0x801088dd,(%esp)
801049e3:	e8 7a bb ff ff       	call   80100562 <panic>
  if(readeflags()&FL_IF)
801049e8:	e8 ab f6 ff ff       	call   80104098 <readeflags>
801049ed:	25 00 02 00 00       	and    $0x200,%eax
801049f2:	85 c0                	test   %eax,%eax
801049f4:	74 0c                	je     80104a02 <sched+0x77>
    panic("sched interruptible");
801049f6:	c7 04 24 eb 88 10 80 	movl   $0x801088eb,(%esp)
801049fd:	e8 60 bb ff ff       	call   80100562 <panic>
  intena = mycpu()->intena;
80104a02:	e8 e4 f6 ff ff       	call   801040eb <mycpu>
80104a07:	8b 80 a8 00 00 00    	mov    0xa8(%eax),%eax
80104a0d:	89 45 f0             	mov    %eax,-0x10(%ebp)
  swtch(&p->context, mycpu()->scheduler);
80104a10:	e8 d6 f6 ff ff       	call   801040eb <mycpu>
...
80104a25:	e8 34 0b 00 00       	call   8010555e <swtch>
  mycpu()->intena = intena;
80104a2a:	e8 bc f6 ff ff       	call   801040eb <mycpu>
80104a2f:	8b 55 f0             	mov    -0x10(%ebp),%edx
80104a32:	89 90 a8 00 00 00    	mov    %edx,0xa8(%eax)
}
80104a38:	c9                   	leave  
80104a39:	c3                   	ret    
...
80104a40:	c7 04 24 e0 3d 11 80 	movl   $0x80113de0,(%esp)
80104a47:	e8 0f 06 00 00       	call   8010505b <acquire>
  myproc()->state = RUNNABLE;
80104a4c:	e8 10 f7 ff ff       	call   80104161 <myproc>
80104a51:	c7 40 0c 03 00 00 00 	movl   $0x3,0xc(%eax)
  sched();
80104a58:	e8 2e ff ff ff       	call   8010498b <sched>
  release(&ptable.lock);
80104a5d:	c7 04 24 e0 3d 11 80 	movl   $0x80113de0,(%esp)
80104a64:	e8 5a 06 00 00       	call   801050c3 <release>
}
80104a69:	c9                   	leave  
80104a6a:	c3                   	ret    
...
80104a6e:	83 ec 18             	sub    $0x18,%esp
  ...
  release(&ptable.lock);
80104a71:	c7 04 24 e0 3d 11 80 	movl   $0x80113de0,(%esp)
80104a78:	e8 46 06 00 00       	call   801050c3 <release>

  if (first) {
80104a7d:	a1 08 b0 10 80       	mov    0x8010b008,%eax
80104a82:	85 c0                	test   %eax,%eax
80104a84:	74 22                	je     80104aa8 <forkret+0x3d>
    // Some initialization functions must be run in the context
    // of a regular process (e.g., they call sleep), and thus cannot
    // be run from main().
    first = 0;
80104a86:	c7 05 08 b0 10 80 00 	movl   $0x0,0x8010b008
80104a8d:	00 00 00 
    iinit(ROOTDEV);
80104a90:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
80104a97:	e8 54 cb ff ff       	call   801015f0 <iinit>
    initlog(ROOTDEV);
80104a9c:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
80104aa3:	e8 db e7 ff ff       	call   80103283 <initlog>
  }
...
80104aad:	83 ec 28             	sub    $0x28,%esp
  struct proc *p = myproc();
80104ab0:	e8 ac f6 ff ff       	call   80104161 <myproc>
80104ab5:	89 45 f4             	mov    %eax,-0xc(%ebp)
  
  if(p == 0)
80104ab8:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
80104abc:	75 0c                	jne    80104aca <sleep+0x20>
    panic("sleep");
80104abe:	c7 04 24 ff 88 10 80 	movl   $0x801088ff,(%esp)
80104ac5:	e8 98 ba ff ff       	call   80100562 <panic>

  if(lk == 0)
80104aca:	83 7d 0c 00          	cmpl   $0x0,0xc(%ebp)
80104ace:	75 0c                	jne    80104adc <sleep+0x32>
    panic("sleep without lk");
80104ad0:	c7 04 24 05 89 10 80 	movl   $0x80108905,(%esp)
80104ad7:	e8 86 ba ff ff       	call   80100562 <panic>
...
80104adc:	81 7d 0c e0 3d 11 80 	cmpl   $0x80113de0,0xc(%ebp)
80104ae3:	74 17                	je     80104afc <sleep+0x52>
    acquire(&ptable.lock);  //DOC: sleeplock1
80104ae5:	c7 04 24 e0 3d 11 80 	movl   $0x80113de0,(%esp)
80104aec:	e8 6a 05 00 00       	call   8010505b <acquire>
    release(lk);
80104af1:	8b 45 0c             	mov    0xc(%ebp),%eax
80104af4:	89 04 24             	mov    %eax,(%esp)
80104af7:	e8 c7 05 00 00       	call   801050c3 <release>
  }
  // Go to sleep.
  p->chan = chan;
80104afc:	8b 45 f4             	mov    -0xc(%ebp),%eax
80104aff:	8b 55 08             	mov    0x8(%ebp),%edx
80104b02:	89 50 20             	mov    %edx,0x20(%eax)
  p->state = SLEEPING;
80104b05:	8b 45 f4             	mov    -0xc(%ebp),%eax
80104b08:	c7 40 0c 02 00 00 00 	movl   $0x2,0xc(%eax)

  sched();
80104b0f:	e8 77 fe ff ff       	call   8010498b <sched>

  // Tidy up.
  p->chan = 0;
80104b14:	8b 45 f4             	mov    -0xc(%ebp),%eax
80104b17:	c7 40 20 00 00 00 00 	movl   $0x0,0x20(%eax)

  // Reacquire original lock.
  if(lk != &ptable.lock){  //DOC: sleeplock2
80104b1e:	81 7d 0c e0 3d 11 80 	cmpl   $0x80113de0,0xc(%ebp)
80104b25:	74 17                	je     80104b3e <sleep+0x94>
    release(&ptable.lock);
80104b27:	c7 04 24 e0 3d 11 80 	movl   $0x80113de0,(%esp)
80104b2e:	e8 90 05 00 00       	call   801050c3 <release>
    acquire(lk);
80104b33:	8b 45 0c             	mov    0xc(%ebp),%eax
80104b36:	89 04 24             	mov    %eax,(%esp)
80104b39:	e8 1d 05 00 00       	call   8010505b <acquire>
  }
}
80104b3e:	c9                   	leave  
80104b3f:	c3                   	ret    
...
80104b43:	83 ec 10             	sub    $0x10,%esp
  ...
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++)
80104b46:	c7 45 fc 14 3e 11 80 	movl   $0x80113e14,-0x4(%ebp)
80104b4d:	eb 27                	jmp    80104b76 <wakeup1+0x36>
    if(p->state == SLEEPING && p->chan == chan)
80104b4f:	8b 45 fc             	mov    -0x4(%ebp),%eax
80104b52:	8b 40 0c             	mov    0xc(%eax),%eax
80104b55:	83 f8 02             	cmp    $0x2,%eax
80104b58:	75 15                	jne    80104b6f <wakeup1+0x2f>
80104b5a:	8b 45 fc             	mov    -0x4(%ebp),%eax
80104b5d:	8b 40 20             	mov    0x20(%eax),%eax
80104b60:	3b 45 08             	cmp    0x8(%ebp),%eax
80104b63:	75 0a                	jne    80104b6f <wakeup1+0x2f>
      p->state = RUNNABLE;
80104b65:	8b 45 fc             	mov    -0x4(%ebp),%eax
80104b68:	c7 40 0c 03 00 00 00 	movl   $0x3,0xc(%eax)
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++)
80104b6f:	81 45 fc 84 00 00 00 	addl   $0x84,-0x4(%ebp)
80104b76:	81 7d fc 14 5f 11 80 	cmpl   $0x80115f14,-0x4(%ebp)
80104b7d:	72 d0                	jb     80104b4f <wakeup1+0xf>
}
80104b7f:	c9                   	leave  
80104b80:	c3                   	ret    
...
80104b84:	83 ec 18             	sub    $0x18,%esp
  acquire(&ptable.lock);
80104b87:	c7 04 24 e0 3d 11 80 	movl   $0x80113de0,(%esp)
80104b8e:	e8 c8 04 00 00       	call   8010505b <acquire>
  wakeup1(chan);
80104b93:	8b 45 08             	mov    0x8(%ebp),%eax
80104b96:	89 04 24             	mov    %eax,(%esp)
80104b99:	e8 a2 ff ff ff       	call   80104b40 <wakeup1>
  release(&ptable.lock);
80104b9e:	c7 04 24 e0 3d 11 80 	movl   $0x80113de0,(%esp)
80104ba5:	e8 19 05 00 00       	call   801050c3 <release>
}
80104baa:	c9                   	leave  
80104bab:	c3                   	ret    
...
80104baf:	83 ec 28             	sub    $0x28,%esp
  ...
  acquire(&ptable.lock);
80104bb2:	c7 04 24 e0 3d 11 80 	movl   $0x80113de0,(%esp)
80104bb9:	e8 9d 04 00 00       	call   8010505b <acquire>
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80104bbe:	c7 45 f4 14 3e 11 80 	movl   $0x80113e14,-0xc(%ebp)
80104bc5:	eb 44                	jmp    80104c0b <kill+0x5f>
    if(p->pid == pid){
80104bc7:	8b 45 f4             	mov    -0xc(%ebp),%eax
80104bca:	8b 40 10             	mov    0x10(%eax),%eax
80104bcd:	3b 45 08             	cmp    0x8(%ebp),%eax
80104bd0:	75 32                	jne    80104c04 <kill+0x58>
      p->killed = 1;
...
80104be5:	75 0a                	jne    80104bf1 <kill+0x45>
        p->state = RUNNABLE;
80104be7:	8b 45 f4             	mov    -0xc(%ebp),%eax
80104bea:	c7 40 0c 03 00 00 00 	movl   $0x3,0xc(%eax)
      release(&ptable.lock);
80104bf1:	c7 04 24 e0 3d 11 80 	movl   $0x80113de0,(%esp)
80104bf8:	e8 c6 04 00 00       	call   801050c3 <release>
      return 0;
80104bfd:	b8 00 00 00 00       	mov    $0x0,%eax
80104c02:	eb 21                	jmp    80104c25 <kill+0x79>
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80104c04:	81 45 f4 84 00 00 00 	addl   $0x84,-0xc(%ebp)
80104c0b:	81 7d f4 14 5f 11 80 	cmpl   $0x80115f14,-0xc(%ebp)
80104c12:	72 b3                	jb     80104bc7 <kill+0x1b>
    }
  }
  release(&ptable.lock);
80104c14:	c7 04 24 e0 3d 11 80 	movl   $0x80113de0,(%esp)
80104c1b:	e8 a3 04 00 00       	call   801050c3 <release>
  return -1;
...
80104c2a:	83 ec 58             	sub    $0x58,%esp
  int i;
  struct proc *p;
  char *state;
  uint pc[10];
  ...
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80104c2d:	c7 45 f0 14 3e 11 80 	movl   $0x80113e14,-0x10(%ebp)
80104c34:	e9 d9 00 00 00       	jmp    80104d12 <procdump+0xeb>
    if(p->state == UNUSED)
80104c39:	8b 45 f0             	mov    -0x10(%ebp),%eax
80104c3c:	8b 40 0c             	mov    0xc(%eax),%eax
80104c3f:	85 c0                	test   %eax,%eax
80104c41:	75 05                	jne    80104c48 <procdump+0x21>
      continue;
80104c43:	e9 c3 00 00 00       	jmp    80104d0b <procdump+0xe4>
    if(p->state >= 0 && p->state < NELEM(states) && states[p->state])
80104c48:	8b 45 f0             	mov    -0x10(%ebp),%eax
80104c4b:	8b 40 0c             	mov    0xc(%eax),%eax
80104c4e:	83 f8 05             	cmp    $0x5,%eax
80104c51:	77 23                	ja     80104c76 <procdump+0x4f>
80104c53:	8b 45 f0             	mov    -0x10(%ebp),%eax
80104c56:	8b 40 0c             	mov    0xc(%eax),%eax
80104c59:	8b 04 85 0c b0 10 80 	mov    -0x7fef4ff4(,%eax,4),%eax
80104c60:	85 c0                	test   %eax,%eax
80104c62:	74 12                	je     80104c76 <procdump+0x4f>
      state = states[p->state];
80104c64:	8b 45 f0             	mov    -0x10(%ebp),%eax
80104c67:	8b 40 0c             	mov    0xc(%eax),%eax
80104c6a:	8b 04 85 0c b0 10 80 	mov    -0x7fef4ff4(,%eax,4),%eax
80104c71:	89 45 ec             	mov    %eax,-0x14(%ebp)
80104c74:	eb 07                	jmp    80104c7d <procdump+0x56>
    else
      state = "???";
80104c76:	c7 45 ec 16 89 10 80 	movl   $0x80108916,-0x14(%ebp)
    cprintf("%d %s %s", p->pid, state, p->name);
80104c7d:	8b 45 f0             	mov    -0x10(%ebp),%eax
80104c80:	8d 50 6c             	lea    0x6c(%eax),%edx
80104c83:	8b 45 f0             	mov    -0x10(%ebp),%eax
80104c86:	8b 40 10             	mov    0x10(%eax),%eax
80104c89:	89 54 24 0c          	mov    %edx,0xc(%esp)
80104c8d:	8b 55 ec             	mov    -0x14(%ebp),%edx
80104c90:	89 54 24 08          	mov    %edx,0x8(%esp)
80104c94:	89 44 24 04          	mov    %eax,0x4(%esp)
80104c98:	c7 04 24 1a 89 10 80 	movl   $0x8010891a,(%esp)
80104c9f:	e8 24 b7 ff ff       	call   801003c8 <cprintf>
    if(p->state == SLEEPING){
80104ca4:	8b 45 f0             	mov    -0x10(%ebp),%eax
80104ca7:	8b 40 0c             	mov    0xc(%eax),%eax
80104caa:	83 f8 02             	cmp    $0x2,%eax
80104cad:	75 50                	jne    80104cff <procdump+0xd8>
      getcallerpcs((uint*)p->context->ebp+2, pc);
80104caf:	8b 45 f0             	mov    -0x10(%ebp),%eax
80104cb2:	8b 40 1c             	mov    0x1c(%eax),%eax
80104cb5:	8b 40 0c             	mov    0xc(%eax),%eax
80104cb8:	83 c0 08             	add    $0x8,%eax
80104cbb:	8d 55 c4             	lea    -0x3c(%ebp),%edx
80104cbe:	89 54 24 04          	mov    %edx,0x4(%esp)
80104cc2:	89 04 24             	mov    %eax,(%esp)
80104cc5:	e8 44 04 00 00       	call   8010510e <getcallerpcs>
      for(i=0; i<10 && pc[i] != 0; i++)
80104cca:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%ebp)
80104cd1:	eb 1b                	jmp    80104cee <procdump+0xc7>
        cprintf(" %p", pc[i]);
80104cd3:	8b 45 f4             	mov    -0xc(%ebp),%eax
80104cd6:	8b 44 85 c4          	mov    -0x3c(%ebp,%eax,4),%eax
80104cda:	89 44 24 04          	mov    %eax,0x4(%esp)
80104cde:	c7 04 24 23 89 10 80 	movl   $0x80108923,(%esp)
80104ce5:	e8 de b6 ff ff       	call   801003c8 <cprintf>
      for(i=0; i<10 && pc[i] != 0; i++)
80104cea:	83 45 f4 01          	addl   $0x1,-0xc(%ebp)
80104cee:	83 7d f4 09          	cmpl   $0x9,-0xc(%ebp)
80104cf2:	7f 0b                	jg     80104cff <procdump+0xd8>
80104cf4:	8b 45 f4             	mov    -0xc(%ebp),%eax
80104cf7:	8b 44 85 c4          	mov    -0x3c(%ebp,%eax,4),%eax
80104cfb:	85 c0                	test   %eax,%eax
80104cfd:	75 d4                	jne    80104cd3 <procdump+0xac>
    }
    cprintf("\n");
80104cff:	c7 04 24 27 89 10 80 	movl   $0x80108927,(%esp)
80104d06:	e8 bd b6 ff ff       	call   801003c8 <cprintf>
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80104d0b:	81 45 f0 84 00 00 00 	addl   $0x84,-0x10(%ebp)
80104d12:	81 7d f0 14 5f 11 80 	cmpl   $0x80115f14,-0x10(%ebp)
80104d19:	0f 82 1a ff ff ff    	jb     80104c39 <procdump+0x12>
  }
}
80104d1f:	c9                   	leave  
80104d20:	c3                   	ret    
...
80104d25:	83 ec 24             	sub    $0x24,%esp
  struct proc *p;
  int i/*,j*/ = 0;
80104d28:	c7 45 f0 00 00 00 00 	movl   $0x0,-0x10(%ebp)
  acquire(&ptable.lock);
80104d2f:	c7 04 24 e0 3d 11 80 	movl   $0x80113de0,(%esp)
80104d36:	e8 20 03 00 00       	call   8010505b <acquire>
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++)
80104d3b:	c7 45 f4 14 3e 11 80 	movl   $0x80113e14,-0xc(%ebp)
80104d42:	e9 71 01 00 00       	jmp    80104eb8 <fillpstat+0x197>
  {
    if(p->state == UNUSED)
80104d47:	8b 45 f4             	mov    -0xc(%ebp),%eax
80104d4a:	8b 40 0c             	mov    0xc(%eax),%eax
80104d4d:	85 c0                	test   %eax,%eax
80104d4f:	75 1d                	jne    80104d6e <fillpstat+0x4d>
      (*pstat)[i].inuse = 0;
...
80104d69:	e9 3f 01 00 00       	jmp    80104ead <fillpstat+0x18c>
    else
    {
      (*pstat)[i].inuse = 1;
80104d6e:	8b 4d 08             	mov    0x8(%ebp),%ecx
80104d71:	8b 55 f0             	mov    -0x10(%ebp),%edx
...
80104d80:	c7 00 01 00 00 00    	movl   $0x1,(%eax)
      (*pstat)[i].tickets = p->tickets;
80104d86:	8b 45 f4             	mov    -0xc(%ebp),%eax
80104d89:	8b 48 7c             	mov    0x7c(%eax),%ecx
80104d8c:	8b 5d 08             	mov    0x8(%ebp),%ebx
80104d8f:	8b 55 f0             	mov    -0x10(%ebp),%edx
80104d92:	89 d0                	mov    %edx,%eax
80104d94:	c1 e0 03             	shl    $0x3,%eax
80104d97:	01 d0                	add    %edx,%eax
80104d99:	c1 e0 02             	shl    $0x2,%eax
80104d9c:	01 d8                	add    %ebx,%eax
80104d9e:	83 c0 04             	add    $0x4,%eax
80104da1:	89 08                	mov    %ecx,(%eax)
      (*pstat)[i].pid = p->pid;
80104da3:	8b 45 f4             	mov    -0xc(%ebp),%eax
80104da6:	8b 48 10             	mov    0x10(%eax),%ecx
80104da9:	8b 5d 08             	mov    0x8(%ebp),%ebx
80104dac:	8b 55 f0             	mov    -0x10(%ebp),%edx
80104daf:	89 d0                	mov    %edx,%eax
80104db1:	c1 e0 03             	shl    $0x3,%eax
80104db4:	01 d0                	add    %edx,%eax
80104db6:	c1 e0 02             	shl    $0x2,%eax
80104db9:	01 d8                	add    %ebx,%eax
80104dbb:	83 c0 08             	add    $0x8,%eax
80104dbe:	89 08                	mov    %ecx,(%eax)
      (*pstat)[i].ticks = p->ticks;
80104dc0:	8b 45 f4             	mov    -0xc(%ebp),%eax
80104dc3:	8b 88 80 00 00 00    	mov    0x80(%eax),%ecx
80104dc9:	8b 5d 08             	mov    0x8(%ebp),%ebx
80104dcc:	8b 55 f0             	mov    -0x10(%ebp),%edx
80104dcf:	89 d0                	mov    %edx,%eax
80104dd1:	c1 e0 03             	shl    $0x3,%eax
80104dd4:	01 d0                	add    %edx,%eax
80104dd6:	c1 e0 02             	shl    $0x2,%eax
80104dd9:	01 d8                	add    %ebx,%eax
80104ddb:	83 c0 0c             	add    $0xc,%eax
80104dde:	89 08                	mov    %ecx,(%eax)
      /*
...
80104de3:	0f b6 48 6c          	movzbl 0x6c(%eax),%ecx
...
80104df7:	01 d8                	add    %ebx,%eax
80104df9:	83 c0 10             	add    $0x10,%eax
80104dfc:	88 08                	mov    %cl,(%eax)
      if(p->state == EMBRYO)
80104dfe:	8b 45 f4             	mov    -0xc(%ebp),%eax
80104e01:	8b 40 0c             	mov    0xc(%eax),%eax
80104e04:	83 f8 01             	cmp    $0x1,%eax
80104e07:	75 18                	jne    80104e21 <fillpstat+0x100>
        (*pstat)[i].state = 'E';
80104e09:	8b 4d 08             	mov    0x8(%ebp),%ecx
80104e0c:	8b 55 f0             	mov    -0x10(%ebp),%edx
80104e0f:	89 d0                	mov    %edx,%eax
80104e11:	c1 e0 03             	shl    $0x3,%eax
80104e14:	01 d0                	add    %edx,%eax
80104e16:	c1 e0 02             	shl    $0x2,%eax
80104e19:	01 c8                	add    %ecx,%eax
80104e1b:	83 c0 20             	add    $0x20,%eax
80104e1e:	c6 00 45             	movb   $0x45,(%eax)
      if(p->state == SLEEPING)
80104e21:	8b 45 f4             	mov    -0xc(%ebp),%eax
80104e24:	8b 40 0c             	mov    0xc(%eax),%eax
80104e27:	83 f8 02             	cmp    $0x2,%eax
80104e2a:	75 18                	jne    80104e44 <fillpstat+0x123>
        (*pstat)[i].state = 'S'; 
80104e2c:	8b 4d 08             	mov    0x8(%ebp),%ecx
80104e2f:	8b 55 f0             	mov    -0x10(%ebp),%edx
80104e32:	89 d0                	mov    %edx,%eax
80104e34:	c1 e0 03             	shl    $0x3,%eax
80104e37:	01 d0                	add    %edx,%eax
80104e39:	c1 e0 02             	shl    $0x2,%eax
80104e3c:	01 c8                	add    %ecx,%eax
80104e3e:	83 c0 20             	add    $0x20,%eax
80104e41:	c6 00 53             	movb   $0x53,(%eax)
      if(p->state == RUNNABLE)
80104e44:	8b 45 f4             	mov    -0xc(%ebp),%eax
80104e47:	8b 40 0c             	mov    0xc(%eax),%eax
80104e4a:	83 f8 03             	cmp    $0x3,%eax
80104e4d:	75 18                	jne    80104e67 <fillpstat+0x146>
        (*pstat)[i].state = 'A';
80104e4f:	8b 4d 08             	mov    0x8(%ebp),%ecx
80104e52:	8b 55 f0             	mov    -0x10(%ebp),%edx
80104e55:	89 d0                	mov    %edx,%eax
80104e57:	c1 e0 03             	shl    $0x3,%eax
80104e5a:	01 d0                	add    %edx,%eax
80104e5c:	c1 e0 02             	shl    $0x2,%eax
80104e5f:	01 c8                	add    %ecx,%eax
80104e61:	83 c0 20             	add    $0x20,%eax
80104e64:	c6 00 41             	movb   $0x41,(%eax)
      if(p->state == RUNNING)
80104e67:	8b 45 f4             	mov    -0xc(%ebp),%eax
80104e6a:	8b 40 0c             	mov    0xc(%eax),%eax
80104e6d:	83 f8 04             	cmp    $0x4,%eax
80104e70:	75 18                	jne    80104e8a <fillpstat+0x169>
        (*pstat)[i].state = 'R';
80104e72:	8b 4d 08             	mov    0x8(%ebp),%ecx
80104e75:	8b 55 f0             	mov    -0x10(%ebp),%edx
80104e78:	89 d0                	mov    %edx,%eax
80104e7a:	c1 e0 03             	shl    $0x3,%eax
80104e7d:	01 d0                	add    %edx,%eax
80104e7f:	c1 e0 02             	shl    $0x2,%eax
80104e82:	01 c8                	add    %ecx,%eax
80104e84:	83 c0 20             	add    $0x20,%eax
80104e87:	c6 00 52             	movb   $0x52,(%eax)
      if(p->state == ZOMBIE)
80104e8a:	8b 45 f4             	mov    -0xc(%ebp),%eax
80104e8d:	8b 40 0c             	mov    0xc(%eax),%eax
80104e90:	83 f8 05             	cmp    $0x5,%eax
80104e93:	75 18                	jne    80104ead <fillpstat+0x18c>
        (*pstat)[i].state = 'Z';
80104e95:	8b 4d 08             	mov    0x8(%ebp),%ecx
80104e98:	8b 55 f0             	mov    -0x10(%ebp),%edx
80104e9b:	89 d0                	mov    %edx,%eax
80104e9d:	c1 e0 03             	shl    $0x3,%eax
80104ea0:	01 d0                	add    %edx,%eax
80104ea2:	c1 e0 02             	shl    $0x2,%eax
80104ea5:	01 c8                	add    %ecx,%eax
80104ea7:	83 c0 20             	add    $0x20,%eax
80104eaa:	c6 00 5a             	movb   $0x5a,(%eax)
    }
    i++;  
80104ead:	83 45 f0 01          	addl   $0x1,-0x10(%ebp)
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++)
80104eb1:	81 45 f4 84 00 00 00 	addl   $0x84,-0xc(%ebp)
80104eb8:	81 7d f4 14 5f 11 80 	cmpl   $0x80115f14,-0xc(%ebp)
80104ebf:	0f 82 82 fe ff ff    	jb     80104d47 <fillpstat+0x26>
  }
  release(&ptable.lock);
80104ec5:	c7 04 24 e0 3d 11 80 	movl   $0x80113de0,(%esp)
80104ecc:	e8 f2 01 00 00       	call   801050c3 <release>
}
80104ed1:	83 c4 24             	add    $0x24,%esp
80104ed4:	5b                   	pop    %ebx
80104ed5:	5d                   	pop    %ebp
80104ed6:	c3                   	ret    

80104ed7 <initsleeplock>:
#include "spinlock.h"
#include "sleeplock.h"
...
80104ee0:	83 c0 04             	add    $0x4,%eax
80104ee3:	c7 44 24 04 53 89 10 	movl   $0x80108953,0x4(%esp)
80104eea:	80 
80104eeb:	89 04 24             	mov    %eax,(%esp)
80104eee:	e8 47 01 00 00       	call   8010503a <initlock>
  lk->name = name;
80104ef3:	8b 45 08             	mov    0x8(%ebp),%eax
80104ef6:	8b 55 0c             	mov    0xc(%ebp),%edx
80104ef9:	89 50 38             	mov    %edx,0x38(%eax)
  lk->locked = 0;
...
80104f7b:	e8 db 00 00 00       	call   8010505b <acquire>
  lk->locked = 0;
...
80104f99:	e8 e3 fb ff ff       	call   80104b81 <wakeup>
  release(&lk->lk);
80104f9e:	8b 45 08             	mov    0x8(%ebp),%eax
80104fa1:	83 c0 04             	add    $0x4,%eax
80104fa4:	89 04 24             	mov    %eax,(%esp)
80104fa7:	e8 17 01 00 00       	call   801050c3 <release>
}
80104fac:	c9                   	leave  
80104fad:	c3                   	ret    

80104fae <holdingsleep>:
...
80104fb2:	83 ec 24             	sub    $0x24,%esp
  int r;
  
  acquire(&lk->lk);
80104fb5:	8b 45 08             	mov    0x8(%ebp),%eax
80104fb8:	83 c0 04             	add    $0x4,%eax
80104fbb:	89 04 24             	mov    %eax,(%esp)
80104fbe:	e8 98 00 00 00       	call   8010505b <acquire>
  r = lk->locked && (lk->pid == myproc()->pid);
80104fc3:	8b 45 08             	mov    0x8(%ebp),%eax
80104fc6:	8b 00                	mov    (%eax),%eax
80104fc8:	85 c0                	test   %eax,%eax
80104fca:	74 19                	je     80104fe5 <holdingsleep+0x37>
80104fcc:	8b 45 08             	mov    0x8(%ebp),%eax
80104fcf:	8b 58 3c             	mov    0x3c(%eax),%ebx
80104fd2:	e8 8a f1 ff ff       	call   80104161 <myproc>
80104fd7:	8b 40 10             	mov    0x10(%eax),%eax
80104fda:	39 c3                	cmp    %eax,%ebx
80104fdc:	75 07                	jne    80104fe5 <holdingsleep+0x37>
80104fde:	b8 01 00 00 00       	mov    $0x1,%eax
80104fe3:	eb 05                	jmp    80104fea <holdingsleep+0x3c>
...
80104ff6:	e8 c8 00 00 00       	call   801050c3 <release>
  return r;
80104ffb:	8b 45 f4             	mov    -0xc(%ebp),%eax
}
80104ffe:	83 c4 24             	add    $0x24,%esp
80105001:	5b                   	pop    %ebx
80105002:	5d                   	pop    %ebp
80105003:	c3                   	ret    
...
8010502c:	8b 4d 08             	mov    0x8(%ebp),%ecx
8010502f:	f0 87 02             	lock xchg %eax,(%edx)
...
80105040:	8b 55 0c             	mov    0xc(%ebp),%edx
...
8010505f:	83 ec 14             	sub    $0x14,%esp
  pushcli(); // disable interrupts to avoid deadlock.
80105062:	e8 61 01 00 00       	call   801051c8 <pushcli>
  if(holding(lk))
80105067:	8b 45 08             	mov    0x8(%ebp),%eax
8010506a:	89 04 24             	mov    %eax,(%esp)
8010506d:	e8 15 01 00 00       	call   80105187 <holding>
80105072:	85 c0                	test   %eax,%eax
80105074:	74 0c                	je     80105082 <acquire+0x27>
    panic("acquire");
80105076:	c7 04 24 5e 89 10 80 	movl   $0x8010895e,(%esp)
...
80105086:	c7 44 24 04 01 00 00 	movl   $0x1,0x4(%esp)
8010508d:	00 
8010508e:	89 04 24             	mov    %eax,(%esp)
80105091:	e8 8a ff ff ff       	call   80105020 <xchg>
80105096:	85 c0                	test   %eax,%eax
80105098:	75 e9                	jne    80105083 <acquire+0x28>
    ;
  ...
  __sync_synchronize();
8010509a:	0f ae f0             	mfence 

  // Record info about lock acquisition for debugging.
  lk->cpu = mycpu();
8010509d:	8b 5d 08             	mov    0x8(%ebp),%ebx
801050a0:	e8 46 f0 ff ff       	call   801040eb <mycpu>
801050a5:	89 43 08             	mov    %eax,0x8(%ebx)
  getcallerpcs(&lk, lk->pcs);
801050a8:	8b 45 08             	mov    0x8(%ebp),%eax
801050ab:	83 c0 0c             	add    $0xc,%eax
801050ae:	89 44 24 04          	mov    %eax,0x4(%esp)
801050b2:	8d 45 08             	lea    0x8(%ebp),%eax
801050b5:	89 04 24             	mov    %eax,(%esp)
801050b8:	e8 51 00 00 00       	call   8010510e <getcallerpcs>
}
801050bd:	83 c4 14             	add    $0x14,%esp
801050c0:	5b                   	pop    %ebx
801050c1:	5d                   	pop    %ebp
801050c2:	c3                   	ret    
...
801050cf:	e8 b3 00 00 00       	call   80105187 <holding>
801050d4:	85 c0                	test   %eax,%eax
801050d6:	75 0c                	jne    801050e4 <release+0x21>
    panic("release");
801050d8:	c7 04 24 66 89 10 80 	movl   $0x80108966,(%esp)
801050df:	e8 7e b4 ff ff       	call   80100562 <panic>
...
801050f1:	c7 40 08 00 00 00 00 	movl   $0x0,0x8(%eax)
  // Tell the C compiler and the processor to not move loads or stores
...
80105101:	c7 00 00 00 00 00    	movl   $0x0,(%eax)

  popcli();
80105107:	e8 08 01 00 00       	call   80105214 <popcli>
}
8010510c:	c9                   	leave  
8010510d:	c3                   	ret    
...
8010512a:	74 38                	je     80105164 <getcallerpcs+0x56>
8010512c:	81 7d fc ff ff ff 7f 	cmpl   $0x7fffffff,-0x4(%ebp)
80105133:	76 2f                	jbe    80105164 <getcallerpcs+0x56>
80105135:	83 7d fc ff          	cmpl   $0xffffffff,-0x4(%ebp)
80105139:	74 29                	je     80105164 <getcallerpcs+0x56>
      break;
...
8010518b:	83 ec 14             	sub    $0x14,%esp
  int r;
  pushcli();
8010518e:	e8 35 00 00 00       	call   801051c8 <pushcli>
  r = lock->locked && lock->cpu == mycpu();
80105193:	8b 45 08             	mov    0x8(%ebp),%eax
80105196:	8b 00                	mov    (%eax),%eax
80105198:	85 c0                	test   %eax,%eax
8010519a:	74 16                	je     801051b2 <holding+0x2b>
8010519c:	8b 45 08             	mov    0x8(%ebp),%eax
8010519f:	8b 58 08             	mov    0x8(%eax),%ebx
801051a2:	e8 44 ef ff ff       	call   801040eb <mycpu>
801051a7:	39 c3                	cmp    %eax,%ebx
801051a9:	75 07                	jne    801051b2 <holding+0x2b>
801051ab:	b8 01 00 00 00       	mov    $0x1,%eax
801051b0:	eb 05                	jmp    801051b7 <holding+0x30>
801051b2:	b8 00 00 00 00       	mov    $0x0,%eax
801051b7:	89 45 f4             	mov    %eax,-0xc(%ebp)
  popcli();
801051ba:	e8 55 00 00 00       	call   80105214 <popcli>
  return r;
801051bf:	8b 45 f4             	mov    -0xc(%ebp),%eax
}
801051c2:	83 c4 14             	add    $0x14,%esp
801051c5:	5b                   	pop    %ebx
801051c6:	5d                   	pop    %ebp
801051c7:	c3                   	ret    
...
801051cb:	83 ec 18             	sub    $0x18,%esp
  ...
  eflags = readeflags();
801051ce:	e8 31 fe ff ff       	call   80105004 <readeflags>
801051d3:	89 45 f4             	mov    %eax,-0xc(%ebp)
  cli();
801051d6:	e8 39 fe ff ff       	call   80105014 <cli>
  if(mycpu()->ncli == 0)
801051db:	e8 0b ef ff ff       	call   801040eb <mycpu>
801051e0:	8b 80 a4 00 00 00    	mov    0xa4(%eax),%eax
801051e6:	85 c0                	test   %eax,%eax
801051e8:	75 14                	jne    801051fe <pushcli+0x36>
    mycpu()->intena = eflags & FL_IF;
801051ea:	e8 fc ee ff ff       	call   801040eb <mycpu>
801051ef:	8b 55 f4             	mov    -0xc(%ebp),%edx
801051f2:	81 e2 00 02 00 00    	and    $0x200,%edx
801051f8:	89 90 a8 00 00 00    	mov    %edx,0xa8(%eax)
  mycpu()->ncli += 1;
801051fe:	e8 e8 ee ff ff       	call   801040eb <mycpu>
80105203:	8b 90 a4 00 00 00    	mov    0xa4(%eax),%edx
80105209:	83 c2 01             	add    $0x1,%edx
8010520c:	89 90 a4 00 00 00    	mov    %edx,0xa4(%eax)
}
80105212:	c9                   	leave  
80105213:	c3                   	ret    
...
80105217:	83 ec 18             	sub    $0x18,%esp
  if(readeflags()&FL_IF)
8010521a:	e8 e5 fd ff ff       	call   80105004 <readeflags>
8010521f:	25 00 02 00 00       	and    $0x200,%eax
80105224:	85 c0                	test   %eax,%eax
80105226:	74 0c                	je     80105234 <popcli+0x20>
    panic("popcli - interruptible");
80105228:	c7 04 24 6e 89 10 80 	movl   $0x8010896e,(%esp)
8010522f:	e8 2e b3 ff ff       	call   80100562 <panic>
  if(--mycpu()->ncli < 0)
80105234:	e8 b2 ee ff ff       	call   801040eb <mycpu>
80105239:	8b 90 a4 00 00 00    	mov    0xa4(%eax),%edx
8010523f:	83 ea 01             	sub    $0x1,%edx
80105242:	89 90 a4 00 00 00    	mov    %edx,0xa4(%eax)
80105248:	8b 80 a4 00 00 00    	mov    0xa4(%eax),%eax
8010524e:	85 c0                	test   %eax,%eax
80105250:	79 0c                	jns    8010525e <popcli+0x4a>
    panic("popcli");
80105252:	c7 04 24 85 89 10 80 	movl   $0x80108985,(%esp)
80105259:	e8 04 b3 ff ff       	call   80100562 <panic>
  if(mycpu()->ncli == 0 && mycpu()->intena)
8010525e:	e8 88 ee ff ff       	call   801040eb <mycpu>
80105263:	8b 80 a4 00 00 00    	mov    0xa4(%eax),%eax
80105269:	85 c0                	test   %eax,%eax
8010526b:	75 14                	jne    80105281 <popcli+0x6d>
8010526d:	e8 79 ee ff ff       	call   801040eb <mycpu>
80105272:	8b 80 a8 00 00 00    	mov    0xa8(%eax),%eax
80105278:	85 c0                	test   %eax,%eax
8010527a:	74 05                	je     80105281 <popcli+0x6d>
    sti();
8010527c:	e8 99 fd ff ff       	call   8010501a <sti>
}
80105281:	c9                   	leave  
80105282:	c3                   	ret    
...
80105297:	fc                   	cld    
80105298:	f3 aa                	rep stos %al,%es:(%edi)
...
801052ad:	8b 4d 08             	mov    0x8(%ebp),%ecx
801052b0:	8b 55 10             	mov    0x10(%ebp),%edx
801052b3:	8b 45 0c             	mov    0xc(%ebp),%eax
801052b6:	89 cb                	mov    %ecx,%ebx
801052b8:	89 df                	mov    %ebx,%edi
801052ba:	89 d1                	mov    %edx,%ecx
801052bc:	fc                   	cld    
801052bd:	f3 ab                	rep stos %eax,%es:(%edi)
801052bf:	89 ca                	mov    %ecx,%edx
801052c1:	89 fb                	mov    %edi,%ebx
801052c3:	89 5d 08             	mov    %ebx,0x8(%ebp)
...
80105311:	89 54 24 08          	mov    %edx,0x8(%esp)
80105315:	89 44 24 04          	mov    %eax,0x4(%esp)
80105319:	8b 45 08             	mov    0x8(%ebp),%eax
8010531c:	89 04 24             	mov    %eax,(%esp)
8010531f:	e8 84 ff ff ff       	call   801052a8 <stosl>
80105324:	eb 19                	jmp    8010533f <memset+0x72>
  } else
    stosb(dst, c, n);
80105326:	8b 45 10             	mov    0x10(%ebp),%eax
80105329:	89 44 24 08          	mov    %eax,0x8(%esp)
...
8010533a:	e8 44 ff ff ff       	call   80105283 <stosb>
  return dst;
...
80105353:	89 45 f8             	mov    %eax,-0x8(%ebp)
  while(n-- > 0){
80105356:	eb 30                	jmp    80105388 <memcmp+0x44>
    if(*s1 != *s2)
...
80105366:	74 18                	je     80105380 <memcmp+0x3c>
      return *s1 - *s2;
80105368:	8b 45 fc             	mov    -0x4(%ebp),%eax
8010536b:	0f b6 00             	movzbl (%eax),%eax
8010536e:	0f b6 d0             	movzbl %al,%edx
80105371:	8b 45 f8             	mov    -0x8(%ebp),%eax
80105374:	0f b6 00             	movzbl (%eax),%eax
80105377:	0f b6 c0             	movzbl %al,%eax
8010537a:	29 c2                	sub    %eax,%edx
8010537c:	89 d0                	mov    %edx,%eax
8010537e:	eb 1a                	jmp    8010539a <memcmp+0x56>
    s1++, s2++;
80105380:	83 45 fc 01          	addl   $0x1,-0x4(%ebp)
80105384:	83 45 f8 01          	addl   $0x1,-0x8(%ebp)
  while(n-- > 0){
...
80105393:	75 c3                	jne    80105358 <memcmp+0x14>
  }
...
801053ab:	89 45 f8             	mov    %eax,-0x8(%ebp)
  if(s < d && s + n > d){
801053ae:	8b 45 fc             	mov    -0x4(%ebp),%eax
801053b1:	3b 45 f8             	cmp    -0x8(%ebp),%eax
801053b4:	73 3d                	jae    801053f3 <memmove+0x57>
801053b6:	8b 45 10             	mov    0x10(%ebp),%eax
801053b9:	8b 55 fc             	mov    -0x4(%ebp),%edx
801053bc:	01 d0                	add    %edx,%eax
801053be:	3b 45 f8             	cmp    -0x8(%ebp),%eax
801053c1:	76 30                	jbe    801053f3 <memmove+0x57>
    s += n;
801053c3:	8b 45 10             	mov    0x10(%ebp),%eax
801053c6:	01 45 fc             	add    %eax,-0x4(%ebp)
    d += n;
801053c9:	8b 45 10             	mov    0x10(%ebp),%eax
801053cc:	01 45 f8             	add    %eax,-0x8(%ebp)
    while(n-- > 0)
801053cf:	eb 13                	jmp    801053e4 <memmove+0x48>
      *--d = *--s;
801053d1:	83 6d f8 01          	subl   $0x1,-0x8(%ebp)
801053d5:	83 6d fc 01          	subl   $0x1,-0x4(%ebp)
801053d9:	8b 45 fc             	mov    -0x4(%ebp),%eax
801053dc:	0f b6 10             	movzbl (%eax),%edx
...
801053ef:	75 e0                	jne    801053d1 <memmove+0x35>
  if(s < d && s + n > d){
801053f1:	eb 26                	jmp    80105419 <memmove+0x7d>
  } else
    while(n-- > 0)
801053f3:	eb 17                	jmp    8010540c <memmove+0x70>
      *d++ = *s++;
801053f5:	8b 45 f8             	mov    -0x8(%ebp),%eax
801053f8:	8d 50 01             	lea    0x1(%eax),%edx
801053fb:	89 55 f8             	mov    %edx,-0x8(%ebp)
801053fe:	8b 55 fc             	mov    -0x4(%ebp),%edx
80105401:	8d 4a 01             	lea    0x1(%edx),%ecx
80105404:	89 4d fc             	mov    %ecx,-0x4(%ebp)
...
80105417:	75 dc                	jne    801053f5 <memmove+0x59>
...
80105427:	89 44 24 08          	mov    %eax,0x8(%esp)
...
80105438:	e8 5f ff ff ff       	call   8010539c <memmove>
}
8010543d:	c9                   	leave  
8010543e:	c3                   	ret    
...
80105440:	89 e5                	mov    %esp,%ebp
  while(n > 0 && *p && *p == *q)
80105442:	eb 0c                	jmp    80105450 <strncmp+0x11>
    n--, p++, q++;
80105444:	83 6d 10 01          	subl   $0x1,0x10(%ebp)
80105448:	83 45 08 01          	addl   $0x1,0x8(%ebp)
8010544c:	83 45 0c 01          	addl   $0x1,0xc(%ebp)
  while(n > 0 && *p && *p == *q)
80105450:	83 7d 10 00          	cmpl   $0x0,0x10(%ebp)
80105454:	74 1a                	je     80105470 <strncmp+0x31>
80105456:	8b 45 08             	mov    0x8(%ebp),%eax
80105459:	0f b6 00             	movzbl (%eax),%eax
8010545c:	84 c0                	test   %al,%al
8010545e:	74 10                	je     80105470 <strncmp+0x31>
...
8010549e:	89 45 fc             	mov    %eax,-0x4(%ebp)
  while(n-- > 0 && (*s++ = *t++) != 0)
801054a1:	90                   	nop
801054a2:	8b 45 10             	mov    0x10(%ebp),%eax
801054a5:	8d 50 ff             	lea    -0x1(%eax),%edx
801054a8:	89 55 10             	mov    %edx,0x10(%ebp)
801054ab:	85 c0                	test   %eax,%eax
801054ad:	7e 1e                	jle    801054cd <strncpy+0x38>
...
801054be:	89 4d 0c             	mov    %ecx,0xc(%ebp)
801054c1:	0f b6 12             	movzbl (%edx),%edx
801054c4:	88 10                	mov    %dl,(%eax)
801054c6:	0f b6 00             	movzbl (%eax),%eax
801054c9:	84 c0                	test   %al,%al
801054cb:	75 d5                	jne    801054a2 <strncpy+0xd>
    ;
  while(n-- > 0)
801054cd:	eb 0c                	jmp    801054db <strncpy+0x46>
    *s++ = 0;
...
801054e6:	7f e7                	jg     801054cf <strncpy+0x3a>
  return os;
...
801054f0:	83 ec 10             	sub    $0x10,%esp
  char *os;

  os = s;
801054f3:	8b 45 08             	mov    0x8(%ebp),%eax
801054f6:	89 45 fc             	mov    %eax,-0x4(%ebp)
  if(n <= 0)
801054f9:	83 7d 10 00          	cmpl   $0x0,0x10(%ebp)
801054fd:	7f 05                	jg     80105504 <safestrcpy+0x17>
    return os;
801054ff:	8b 45 fc             	mov    -0x4(%ebp),%eax
80105502:	eb 31                	jmp    80105535 <safestrcpy+0x48>
  while(--n > 0 && (*s++ = *t++) != 0)
80105504:	83 6d 10 01          	subl   $0x1,0x10(%ebp)
80105508:	83 7d 10 00          	cmpl   $0x0,0x10(%ebp)
8010550c:	7e 1e                	jle    8010552c <safestrcpy+0x3f>
8010550e:	8b 45 08             	mov    0x8(%ebp),%eax
80105511:	8d 50 01             	lea    0x1(%eax),%edx
80105514:	89 55 08             	mov    %edx,0x8(%ebp)
80105517:	8b 55 0c             	mov    0xc(%ebp),%edx
8010551a:	8d 4a 01             	lea    0x1(%edx),%ecx
8010551d:	89 4d 0c             	mov    %ecx,0xc(%ebp)
80105520:	0f b6 12             	movzbl (%edx),%edx
80105523:	88 10                	mov    %dl,(%eax)
80105525:	0f b6 00             	movzbl (%eax),%eax
80105528:	84 c0                	test   %al,%al
8010552a:	75 d8                	jne    80105504 <safestrcpy+0x17>
    ;
  *s = 0;
8010552c:	8b 45 08             	mov    0x8(%ebp),%eax
8010552f:	c6 00 00             	movb   $0x0,(%eax)
  return os;
80105532:	8b 45 fc             	mov    -0x4(%ebp),%eax
}
80105535:	c9                   	leave  
80105536:	c3                   	ret    
...
8010553a:	83 ec 10             	sub    $0x10,%esp
  ...
  for(n = 0; s[n]; n++)
8010553d:	c7 45 fc 00 00 00 00 	movl   $0x0,-0x4(%ebp)
80105544:	eb 04                	jmp    8010554a <strlen+0x13>
80105546:	83 45 fc 01          	addl   $0x1,-0x4(%ebp)
8010554a:	8b 55 fc             	mov    -0x4(%ebp),%edx
8010554d:	8b 45 08             	mov    0x8(%ebp),%eax
80105550:	01 d0                	add    %edx,%eax
80105552:	0f b6 00             	movzbl (%eax),%eax
80105555:	84 c0                	test   %al,%al
80105557:	75 ed                	jne    80105546 <strlen+0xf>
    ;
  return n;
...
swtch:
  movl 4(%esp), %eax
8010555e:	8b 44 24 04          	mov    0x4(%esp),%eax
  movl 8(%esp), %edx
80105562:	8b 54 24 08          	mov    0x8(%esp),%edx
...
80105569:	57                   	push   %edi
  ...
  # Switch stacks
  movl %esp, (%eax)
8010556a:	89 20                	mov    %esp,(%eax)
  movl %edx, %esp
8010556c:	89 d4                	mov    %edx,%esp
...
80105576:	83 ec 18             	sub    $0x18,%esp
  struct proc *curproc = myproc();
80105579:	e8 e3 eb ff ff       	call   80104161 <myproc>
8010557e:	89 45 f4             	mov    %eax,-0xc(%ebp)

  if(addr >= curproc->sz || addr+4 > curproc->sz)
80105581:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105584:	8b 00                	mov    (%eax),%eax
80105586:	3b 45 08             	cmp    0x8(%ebp),%eax
80105589:	76 0f                	jbe    8010559a <fetchint+0x27>
...
80105596:	39 c2                	cmp    %eax,%edx
80105598:	76 07                	jbe    801055a1 <fetchint+0x2e>
    return -1;
8010559a:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
8010559f:	eb 0f                	jmp    801055b0 <fetchint+0x3d>
  *ip = *(int*)(addr);
801055a1:	8b 45 08             	mov    0x8(%ebp),%eax
801055a4:	8b 10                	mov    (%eax),%edx
801055a6:	8b 45 0c             	mov    0xc(%ebp),%eax
801055a9:	89 10                	mov    %edx,(%eax)
  return 0;
...
80105601:	eb 11                	jmp    80105614 <fetchstr+0x62>
  for(s = *pp; s < ep; s++){
80105603:	83 45 f4 01          	addl   $0x1,-0xc(%ebp)
80105607:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010560a:	3b 45 ec             	cmp    -0x14(%ebp),%eax
8010560d:	72 dc                	jb     801055eb <fetchstr+0x39>
  }
  return -1;
...
8010561c:	e8 40 eb ff ff       	call   80104161 <myproc>
80105621:	8b 40 18             	mov    0x18(%eax),%eax
80105624:	8b 50 44             	mov    0x44(%eax),%edx
80105627:	8b 45 08             	mov    0x8(%ebp),%eax
8010562a:	c1 e0 02             	shl    $0x2,%eax
8010562d:	01 d0                	add    %edx,%eax
8010562f:	8d 50 04             	lea    0x4(%eax),%edx
80105632:	8b 45 0c             	mov    0xc(%ebp),%eax
80105635:	89 44 24 04          	mov    %eax,0x4(%esp)
80105639:	89 14 24             	mov    %edx,(%esp)
8010563c:	e8 32 ff ff ff       	call   80105573 <fetchint>
}
80105641:	c9                   	leave  
80105642:	c3                   	ret    
...
80105646:	83 ec 28             	sub    $0x28,%esp
  int i;
  struct proc *curproc = myproc();
80105649:	e8 13 eb ff ff       	call   80104161 <myproc>
8010564e:	89 45 f4             	mov    %eax,-0xc(%ebp)
...
8010565e:	e8 b3 ff ff ff       	call   80105616 <argint>
80105663:	85 c0                	test   %eax,%eax
80105665:	79 07                	jns    8010566e <argptr+0x2b>
    return -1;
80105667:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
8010566c:	eb 3d                	jmp    801056ab <argptr+0x68>
  if(size < 0 || (uint)i >= curproc->sz || (uint)i+size > curproc->sz)
8010566e:	83 7d 10 00          	cmpl   $0x0,0x10(%ebp)
80105672:	78 21                	js     80105695 <argptr+0x52>
80105674:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105677:	89 c2                	mov    %eax,%edx
80105679:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010567c:	8b 00                	mov    (%eax),%eax
8010567e:	39 c2                	cmp    %eax,%edx
80105680:	73 13                	jae    80105695 <argptr+0x52>
...
80105693:	76 07                	jbe    8010569c <argptr+0x59>
    return -1;
80105695:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
8010569a:	eb 0f                	jmp    801056ab <argptr+0x68>
  *pp = (char*)i;
...
801056c0:	e8 51 ff ff ff       	call   80105616 <argint>
801056c5:	85 c0                	test   %eax,%eax
801056c7:	79 07                	jns    801056d0 <argstr+0x23>
    return -1;
801056c9:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
801056ce:	eb 12                	jmp    801056e2 <argstr+0x35>
  return fetchstr(addr, pp);
801056d0:	8b 45 f4             	mov    -0xc(%ebp),%eax
801056d3:	8b 55 0c             	mov    0xc(%ebp),%edx
801056d6:	89 54 24 04          	mov    %edx,0x4(%esp)
801056da:	89 04 24             	mov    %eax,(%esp)
801056dd:	e8 d0 fe ff ff       	call   801055b2 <fetchstr>
}
801056e2:	c9                   	leave  
801056e3:	c3                   	ret    
...
801056e8:	83 ec 24             	sub    $0x24,%esp
  int num;
  struct proc *curproc = myproc();
801056eb:	e8 71 ea ff ff       	call   80104161 <myproc>
...
801056fc:	89 45 f0             	mov    %eax,-0x10(%ebp)
  if(num > 0 && num < NELEM(syscalls) && syscalls[num]) {
801056ff:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
80105703:	7e 2d                	jle    80105732 <syscall+0x4e>
80105705:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105708:	83 f8 18             	cmp    $0x18,%eax
8010570b:	77 25                	ja     80105732 <syscall+0x4e>
8010570d:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105710:	8b 04 85 40 b0 10 80 	mov    -0x7fef4fc0(,%eax,4),%eax
80105717:	85 c0                	test   %eax,%eax
80105719:	74 17                	je     80105732 <syscall+0x4e>
    curproc->tf->eax = syscalls[num]();
8010571b:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010571e:	8b 58 18             	mov    0x18(%eax),%ebx
80105721:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105724:	8b 04 85 40 b0 10 80 	mov    -0x7fef4fc0(,%eax,4),%eax
8010572b:	ff d0                	call   *%eax
8010572d:	89 43 1c             	mov    %eax,0x1c(%ebx)
80105730:	eb 34                	jmp    80105766 <syscall+0x82>
  } else {
...
80105741:	89 54 24 0c          	mov    %edx,0xc(%esp)
80105745:	89 4c 24 08          	mov    %ecx,0x8(%esp)
80105749:	89 44 24 04          	mov    %eax,0x4(%esp)
8010574d:	c7 04 24 8c 89 10 80 	movl   $0x8010898c,(%esp)
80105754:	e8 6f ac ff ff       	call   801003c8 <cprintf>
    curproc->tf->eax = -1;
80105759:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010575c:	8b 40 18             	mov    0x18(%eax),%eax
8010575f:	c7 40 1c ff ff ff ff 	movl   $0xffffffff,0x1c(%eax)
  }
}
80105766:	83 c4 24             	add    $0x24,%esp
80105769:	5b                   	pop    %ebx
8010576a:	5d                   	pop    %ebp
8010576b:	c3                   	ret    
...
8010577f:	e8 92 fe ff ff       	call   80105616 <argint>
80105784:	85 c0                	test   %eax,%eax
80105786:	79 07                	jns    8010578f <argfd+0x23>
    return -1;
80105788:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
8010578d:	eb 4f                	jmp    801057de <argfd+0x72>
  if(fd < 0 || fd >= NOFILE || (f=myproc()->ofile[fd]) == 0)
8010578f:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105792:	85 c0                	test   %eax,%eax
80105794:	78 20                	js     801057b6 <argfd+0x4a>
80105796:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105799:	83 f8 0f             	cmp    $0xf,%eax
8010579c:	7f 18                	jg     801057b6 <argfd+0x4a>
8010579e:	e8 be e9 ff ff       	call   80104161 <myproc>
801057a3:	8b 55 f0             	mov    -0x10(%ebp),%edx
801057a6:	83 c2 08             	add    $0x8,%edx
801057a9:	8b 44 90 08          	mov    0x8(%eax,%edx,4),%eax
801057ad:	89 45 f4             	mov    %eax,-0xc(%ebp)
801057b0:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
801057b4:	75 07                	jne    801057bd <argfd+0x51>
    return -1;
801057b6:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
801057bb:	eb 21                	jmp    801057de <argfd+0x72>
  if(pfd)
801057bd:	83 7d 0c 00          	cmpl   $0x0,0xc(%ebp)
801057c1:	74 08                	je     801057cb <argfd+0x5f>
    *pfd = fd;
...
801057cf:	74 08                	je     801057d9 <argfd+0x6d>
    *pf = f;
801057d1:	8b 45 10             	mov    0x10(%ebp),%eax
801057d4:	8b 55 f4             	mov    -0xc(%ebp),%edx
...
801057e3:	83 ec 18             	sub    $0x18,%esp
  int fd;
  struct proc *curproc = myproc();
801057e6:	e8 76 e9 ff ff       	call   80104161 <myproc>
801057eb:	89 45 f0             	mov    %eax,-0x10(%ebp)

  for(fd = 0; fd < NOFILE; fd++){
801057ee:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%ebp)
801057f5:	eb 2a                	jmp    80105821 <fdalloc+0x41>
...
80105806:	75 15                	jne    8010581d <fdalloc+0x3d>
      curproc->ofile[fd] = f;
...
8010581b:	eb 0f                	jmp    8010582c <fdalloc+0x4c>
  for(fd = 0; fd < NOFILE; fd++){
8010581d:	83 45 f4 01          	addl   $0x1,-0xc(%ebp)
80105821:	83 7d f4 0f          	cmpl   $0xf,-0xc(%ebp)
80105825:	7e d0                	jle    801057f7 <fdalloc+0x17>
    }
  }
  return -1;
...
8010584a:	e8 1d ff ff ff       	call   8010576c <argfd>
...
80105860:	e8 7b ff ff ff       	call   801057e0 <fdalloc>
...
8010587b:	e8 65 b7 ff ff       	call   80100fe5 <filedup>
  return fd;
...
801058a1:	e8 c6 fe ff ff       	call   8010576c <argfd>
...
801058b8:	e8 59 fd ff ff       	call   80105616 <argint>
...
801058d6:	e8 68 fd ff ff       	call   80105643 <argptr>
...
801058fa:	e8 53 b8 ff ff       	call   80101152 <fileread>
}
801058ff:	c9                   	leave  
80105900:	c3                   	ret    
...
8010591d:	e8 4a fe ff ff       	call   8010576c <argfd>
...
80105934:	e8 dd fc ff ff       	call   80105616 <argint>
...
80105952:	e8 ec fc ff ff       	call   80105643 <argptr>
...
80105976:	e8 93 b8 ff ff       	call   8010120e <filewrite>
}
8010597b:	c9                   	leave  
8010597c:	c3                   	ret    
...
80105998:	e8 cf fd ff ff       	call   8010576c <argfd>
8010599d:	85 c0                	test   %eax,%eax
8010599f:	79 07                	jns    801059a8 <sys_close+0x2b>
    return -1;
801059a1:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
801059a6:	eb 23                	jmp    801059cb <sys_close+0x4e>
  myproc()->ofile[fd] = 0;
801059a8:	e8 b4 e7 ff ff       	call   80104161 <myproc>
...
801059c1:	e8 67 b6 ff ff       	call   8010102d <fileclose>
  return 0;
...
801059d0:	83 ec 28             	sub    $0x28,%esp
  struct file *f;
  struct stat *st;
...
801059da:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
801059e1:	00 
801059e2:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
801059e9:	e8 7e fd ff ff       	call   8010576c <argfd>
801059ee:	85 c0                	test   %eax,%eax
801059f0:	78 1f                	js     80105a11 <sys_fstat+0x44>
801059f2:	c7 44 24 08 14 00 00 	movl   $0x14,0x8(%esp)
801059f9:	00 
801059fa:	8d 45 f0             	lea    -0x10(%ebp),%eax
801059fd:	89 44 24 04          	mov    %eax,0x4(%esp)
80105a01:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
80105a08:	e8 36 fc ff ff       	call   80105643 <argptr>
80105a0d:	85 c0                	test   %eax,%eax
80105a0f:	79 07                	jns    80105a18 <sys_fstat+0x4b>
    return -1;
80105a11:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80105a16:	eb 12                	jmp    80105a2a <sys_fstat+0x5d>
  return filestat(f, st);
80105a18:	8b 55 f0             	mov    -0x10(%ebp),%edx
80105a1b:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105a1e:	89 54 24 04          	mov    %edx,0x4(%esp)
80105a22:	89 04 24             	mov    %eax,(%esp)
80105a25:	e8 d9 b6 ff ff       	call   80101103 <filestat>
}
80105a2a:	c9                   	leave  
80105a2b:	c3                   	ret    
...
80105a2f:	83 ec 38             	sub    $0x38,%esp
  char name[DIRSIZ], *new, *old;
  struct inode *dp, *ip;

  if(argstr(0, &old) < 0 || argstr(1, &new) < 0)
80105a32:	8d 45 d8             	lea    -0x28(%ebp),%eax
80105a35:	89 44 24 04          	mov    %eax,0x4(%esp)
80105a39:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
80105a40:	e8 68 fc ff ff       	call   801056ad <argstr>
80105a45:	85 c0                	test   %eax,%eax
80105a47:	78 17                	js     80105a60 <sys_link+0x34>
80105a49:	8d 45 dc             	lea    -0x24(%ebp),%eax
80105a4c:	89 44 24 04          	mov    %eax,0x4(%esp)
80105a50:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
80105a57:	e8 51 fc ff ff       	call   801056ad <argstr>
80105a5c:	85 c0                	test   %eax,%eax
80105a5e:	79 0a                	jns    80105a6a <sys_link+0x3e>
    return -1;
80105a60:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80105a65:	e9 42 01 00 00       	jmp    80105bac <sys_link+0x180>

  begin_op();
80105a6a:	e8 18 da ff ff       	call   80103487 <begin_op>
  if((ip = namei(old)) == 0){
80105a6f:	8b 45 d8             	mov    -0x28(%ebp),%eax
80105a72:	89 04 24             	mov    %eax,(%esp)
80105a75:	e8 1d ca ff ff       	call   80102497 <namei>
80105a7a:	89 45 f4             	mov    %eax,-0xc(%ebp)
80105a7d:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
80105a81:	75 0f                	jne    80105a92 <sys_link+0x66>
    end_op();
80105a83:	e8 83 da ff ff       	call   8010350b <end_op>
    return -1;
80105a88:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80105a8d:	e9 1a 01 00 00       	jmp    80105bac <sys_link+0x180>
  }

  ilock(ip);
80105a92:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105a95:	89 04 24             	mov    %eax,(%esp)
80105a98:	e8 c0 be ff ff       	call   8010195d <ilock>
  if(ip->type == T_DIR){
80105a9d:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105aa0:	0f b7 40 50          	movzwl 0x50(%eax),%eax
80105aa4:	66 83 f8 01          	cmp    $0x1,%ax
80105aa8:	75 1a                	jne    80105ac4 <sys_link+0x98>
    iunlockput(ip);
80105aaa:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105aad:	89 04 24             	mov    %eax,(%esp)
80105ab0:	e8 aa c0 ff ff       	call   80101b5f <iunlockput>
    end_op();
80105ab5:	e8 51 da ff ff       	call   8010350b <end_op>
    return -1;
80105aba:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80105abf:	e9 e8 00 00 00       	jmp    80105bac <sys_link+0x180>
  }

  ip->nlink++;
80105ac4:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105ac7:	0f b7 40 56          	movzwl 0x56(%eax),%eax
80105acb:	8d 50 01             	lea    0x1(%eax),%edx
80105ace:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105ad1:	66 89 50 56          	mov    %dx,0x56(%eax)
  iupdate(ip);
80105ad5:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105ad8:	89 04 24             	mov    %eax,(%esp)
80105adb:	e8 b8 bc ff ff       	call   80101798 <iupdate>
  iunlock(ip);
80105ae0:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105ae3:	89 04 24             	mov    %eax,(%esp)
80105ae6:	e8 7f bf ff ff       	call   80101a6a <iunlock>

  if((dp = nameiparent(new, name)) == 0)
80105aeb:	8b 45 dc             	mov    -0x24(%ebp),%eax
80105aee:	8d 55 e2             	lea    -0x1e(%ebp),%edx
80105af1:	89 54 24 04          	mov    %edx,0x4(%esp)
80105af5:	89 04 24             	mov    %eax,(%esp)
80105af8:	e8 bc c9 ff ff       	call   801024b9 <nameiparent>
80105afd:	89 45 f0             	mov    %eax,-0x10(%ebp)
80105b00:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
80105b04:	75 02                	jne    80105b08 <sys_link+0xdc>
    goto bad;
80105b06:	eb 68                	jmp    80105b70 <sys_link+0x144>
  ilock(dp);
80105b08:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105b0b:	89 04 24             	mov    %eax,(%esp)
80105b0e:	e8 4a be ff ff       	call   8010195d <ilock>
  if(dp->dev != ip->dev || dirlink(dp, name, ip->inum) < 0){
80105b13:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105b16:	8b 10                	mov    (%eax),%edx
80105b18:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105b1b:	8b 00                	mov    (%eax),%eax
80105b1d:	39 c2                	cmp    %eax,%edx
80105b1f:	75 20                	jne    80105b41 <sys_link+0x115>
80105b21:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105b24:	8b 40 04             	mov    0x4(%eax),%eax
80105b27:	89 44 24 08          	mov    %eax,0x8(%esp)
80105b2b:	8d 45 e2             	lea    -0x1e(%ebp),%eax
80105b2e:	89 44 24 04          	mov    %eax,0x4(%esp)
80105b32:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105b35:	89 04 24             	mov    %eax,(%esp)
80105b38:	e8 9b c6 ff ff       	call   801021d8 <dirlink>
80105b3d:	85 c0                	test   %eax,%eax
80105b3f:	79 0d                	jns    80105b4e <sys_link+0x122>
    iunlockput(dp);
80105b41:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105b44:	89 04 24             	mov    %eax,(%esp)
80105b47:	e8 13 c0 ff ff       	call   80101b5f <iunlockput>
    goto bad;
80105b4c:	eb 22                	jmp    80105b70 <sys_link+0x144>
  }
  iunlockput(dp);
80105b4e:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105b51:	89 04 24             	mov    %eax,(%esp)
80105b54:	e8 06 c0 ff ff       	call   80101b5f <iunlockput>
  iput(ip);
80105b59:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105b5c:	89 04 24             	mov    %eax,(%esp)
80105b5f:	e8 4a bf ff ff       	call   80101aae <iput>

  end_op();
80105b64:	e8 a2 d9 ff ff       	call   8010350b <end_op>

  return 0;
80105b69:	b8 00 00 00 00       	mov    $0x0,%eax
80105b6e:	eb 3c                	jmp    80105bac <sys_link+0x180>

bad:
  ilock(ip);
80105b70:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105b73:	89 04 24             	mov    %eax,(%esp)
80105b76:	e8 e2 bd ff ff       	call   8010195d <ilock>
  ip->nlink--;
...
80105b88:	66 89 50 56          	mov    %dx,0x56(%eax)
  iupdate(ip);
80105b8c:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105b8f:	89 04 24             	mov    %eax,(%esp)
80105b92:	e8 01 bc ff ff       	call   80101798 <iupdate>
  iunlockput(ip);
80105b97:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105b9a:	89 04 24             	mov    %eax,(%esp)
80105b9d:	e8 bd bf ff ff       	call   80101b5f <iunlockput>
  end_op();
80105ba2:	e8 64 d9 ff ff       	call   8010350b <end_op>
  return -1;
...
80105bb4:	c7 45 f4 20 00 00 00 	movl   $0x20,-0xc(%ebp)
80105bbb:	eb 4b                	jmp    80105c08 <isdirempty+0x5a>
    if(readi(dp, (char*)&de, off, sizeof(de)) != sizeof(de))
80105bbd:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105bc0:	c7 44 24 0c 10 00 00 	movl   $0x10,0xc(%esp)
80105bc7:	00 
80105bc8:	89 44 24 08          	mov    %eax,0x8(%esp)
80105bcc:	8d 45 e4             	lea    -0x1c(%ebp),%eax
80105bcf:	89 44 24 04          	mov    %eax,0x4(%esp)
80105bd3:	8b 45 08             	mov    0x8(%ebp),%eax
80105bd6:	89 04 24             	mov    %eax,(%esp)
80105bd9:	e8 1c c2 ff ff       	call   80101dfa <readi>
80105bde:	83 f8 10             	cmp    $0x10,%eax
80105be1:	74 0c                	je     80105bef <isdirempty+0x41>
      panic("isdirempty: readi");
80105be3:	c7 04 24 a8 89 10 80 	movl   $0x801089a8,(%esp)
80105bea:	e8 73 a9 ff ff       	call   80100562 <panic>
    if(de.inum != 0)
80105bef:	0f b7 45 e4          	movzwl -0x1c(%ebp),%eax
80105bf3:	66 85 c0             	test   %ax,%ax
80105bf6:	74 07                	je     80105bff <isdirempty+0x51>
      return 0;
80105bf8:	b8 00 00 00 00       	mov    $0x0,%eax
80105bfd:	eb 1b                	jmp    80105c1a <isdirempty+0x6c>
  for(off=2*sizeof(de); off<dp->size; off+=sizeof(de)){
80105bff:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105c02:	83 c0 10             	add    $0x10,%eax
80105c05:	89 45 f4             	mov    %eax,-0xc(%ebp)
80105c08:	8b 55 f4             	mov    -0xc(%ebp),%edx
80105c0b:	8b 45 08             	mov    0x8(%ebp),%eax
80105c0e:	8b 40 58             	mov    0x58(%eax),%eax
80105c11:	39 c2                	cmp    %eax,%edx
80105c13:	72 a8                	jb     80105bbd <isdirempty+0xf>
  }
  return 1;
80105c15:	b8 01 00 00 00       	mov    $0x1,%eax
}
80105c1a:	c9                   	leave  
80105c1b:	c3                   	ret    
...
80105c1f:	83 ec 48             	sub    $0x48,%esp
  struct inode *ip, *dp;
  struct dirent de;
...
80105c30:	e8 78 fa ff ff       	call   801056ad <argstr>
80105c35:	85 c0                	test   %eax,%eax
80105c37:	79 0a                	jns    80105c43 <sys_unlink+0x27>
    return -1;
80105c39:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80105c3e:	e9 af 01 00 00       	jmp    80105df2 <sys_unlink+0x1d6>

  begin_op();
80105c43:	e8 3f d8 ff ff       	call   80103487 <begin_op>
  if((dp = nameiparent(path, name)) == 0){
80105c48:	8b 45 cc             	mov    -0x34(%ebp),%eax
80105c4b:	8d 55 d2             	lea    -0x2e(%ebp),%edx
80105c4e:	89 54 24 04          	mov    %edx,0x4(%esp)
80105c52:	89 04 24             	mov    %eax,(%esp)
80105c55:	e8 5f c8 ff ff       	call   801024b9 <nameiparent>
80105c5a:	89 45 f4             	mov    %eax,-0xc(%ebp)
80105c5d:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
80105c61:	75 0f                	jne    80105c72 <sys_unlink+0x56>
    end_op();
80105c63:	e8 a3 d8 ff ff       	call   8010350b <end_op>
    return -1;
80105c68:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80105c6d:	e9 80 01 00 00       	jmp    80105df2 <sys_unlink+0x1d6>
  }

  ilock(dp);
80105c72:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105c75:	89 04 24             	mov    %eax,(%esp)
80105c78:	e8 e0 bc ff ff       	call   8010195d <ilock>

  // Cannot unlink "." or "..".
  if(namecmp(name, ".") == 0 || namecmp(name, "..") == 0)
80105c7d:	c7 44 24 04 ba 89 10 	movl   $0x801089ba,0x4(%esp)
80105c84:	80 
80105c85:	8d 45 d2             	lea    -0x2e(%ebp),%eax
80105c88:	89 04 24             	mov    %eax,(%esp)
80105c8b:	e8 5d c4 ff ff       	call   801020ed <namecmp>
80105c90:	85 c0                	test   %eax,%eax
80105c92:	0f 84 45 01 00 00    	je     80105ddd <sys_unlink+0x1c1>
80105c98:	c7 44 24 04 bc 89 10 	movl   $0x801089bc,0x4(%esp)
80105c9f:	80 
80105ca0:	8d 45 d2             	lea    -0x2e(%ebp),%eax
80105ca3:	89 04 24             	mov    %eax,(%esp)
80105ca6:	e8 42 c4 ff ff       	call   801020ed <namecmp>
80105cab:	85 c0                	test   %eax,%eax
80105cad:	0f 84 2a 01 00 00    	je     80105ddd <sys_unlink+0x1c1>
    goto bad;
...
80105cc7:	e8 43 c4 ff ff       	call   8010210f <dirlookup>
80105ccc:	89 45 f0             	mov    %eax,-0x10(%ebp)
80105ccf:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
80105cd3:	75 05                	jne    80105cda <sys_unlink+0xbe>
    goto bad;
80105cd5:	e9 03 01 00 00       	jmp    80105ddd <sys_unlink+0x1c1>
  ilock(ip);
80105cda:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105cdd:	89 04 24             	mov    %eax,(%esp)
80105ce0:	e8 78 bc ff ff       	call   8010195d <ilock>

  if(ip->nlink < 1)
80105ce5:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105ce8:	0f b7 40 56          	movzwl 0x56(%eax),%eax
80105cec:	66 85 c0             	test   %ax,%ax
80105cef:	7f 0c                	jg     80105cfd <sys_unlink+0xe1>
    panic("unlink: nlink < 1");
80105cf1:	c7 04 24 bf 89 10 80 	movl   $0x801089bf,(%esp)
80105cf8:	e8 65 a8 ff ff       	call   80100562 <panic>
  if(ip->type == T_DIR && !isdirempty(ip)){
80105cfd:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105d00:	0f b7 40 50          	movzwl 0x50(%eax),%eax
80105d04:	66 83 f8 01          	cmp    $0x1,%ax
80105d08:	75 1f                	jne    80105d29 <sys_unlink+0x10d>
80105d0a:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105d0d:	89 04 24             	mov    %eax,(%esp)
80105d10:	e8 99 fe ff ff       	call   80105bae <isdirempty>
80105d15:	85 c0                	test   %eax,%eax
80105d17:	75 10                	jne    80105d29 <sys_unlink+0x10d>
    iunlockput(ip);
80105d19:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105d1c:	89 04 24             	mov    %eax,(%esp)
80105d1f:	e8 3b be ff ff       	call   80101b5f <iunlockput>
    goto bad;
80105d24:	e9 b4 00 00 00       	jmp    80105ddd <sys_unlink+0x1c1>
  }

  memset(&de, 0, sizeof(de));
80105d29:	c7 44 24 08 10 00 00 	movl   $0x10,0x8(%esp)
80105d30:	00 
80105d31:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
80105d38:	00 
80105d39:	8d 45 e0             	lea    -0x20(%ebp),%eax
80105d3c:	89 04 24             	mov    %eax,(%esp)
80105d3f:	e8 89 f5 ff ff       	call   801052cd <memset>
  if(writei(dp, (char*)&de, off, sizeof(de)) != sizeof(de))
80105d44:	8b 45 c8             	mov    -0x38(%ebp),%eax
80105d47:	c7 44 24 0c 10 00 00 	movl   $0x10,0xc(%esp)
80105d4e:	00 
80105d4f:	89 44 24 08          	mov    %eax,0x8(%esp)
80105d53:	8d 45 e0             	lea    -0x20(%ebp),%eax
80105d56:	89 44 24 04          	mov    %eax,0x4(%esp)
80105d5a:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105d5d:	89 04 24             	mov    %eax,(%esp)
80105d60:	e8 f9 c1 ff ff       	call   80101f5e <writei>
80105d65:	83 f8 10             	cmp    $0x10,%eax
80105d68:	74 0c                	je     80105d76 <sys_unlink+0x15a>
    panic("unlink: writei");
80105d6a:	c7 04 24 d1 89 10 80 	movl   $0x801089d1,(%esp)
80105d71:	e8 ec a7 ff ff       	call   80100562 <panic>
  if(ip->type == T_DIR){
80105d76:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105d79:	0f b7 40 50          	movzwl 0x50(%eax),%eax
80105d7d:	66 83 f8 01          	cmp    $0x1,%ax
80105d81:	75 1c                	jne    80105d9f <sys_unlink+0x183>
    dp->nlink--;
80105d83:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105d86:	0f b7 40 56          	movzwl 0x56(%eax),%eax
80105d8a:	8d 50 ff             	lea    -0x1(%eax),%edx
80105d8d:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105d90:	66 89 50 56          	mov    %dx,0x56(%eax)
    iupdate(dp);
80105d94:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105d97:	89 04 24             	mov    %eax,(%esp)
80105d9a:	e8 f9 b9 ff ff       	call   80101798 <iupdate>
  }
  iunlockput(dp);
80105d9f:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105da2:	89 04 24             	mov    %eax,(%esp)
80105da5:	e8 b5 bd ff ff       	call   80101b5f <iunlockput>
...
80105dcc:	e8 8e bd ff ff       	call   80101b5f <iunlockput>
  ...
  end_op();
80105dd1:	e8 35 d7 ff ff       	call   8010350b <end_op>

  return 0;
80105dd6:	b8 00 00 00 00       	mov    $0x0,%eax
80105ddb:	eb 15                	jmp    80105df2 <sys_unlink+0x1d6>

bad:
  iunlockput(dp);
80105ddd:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105de0:	89 04 24             	mov    %eax,(%esp)
80105de3:	e8 77 bd ff ff       	call   80101b5f <iunlockput>
  end_op();
80105de8:	e8 1e d7 ff ff       	call   8010350b <end_op>
  return -1;
...
80105df7:	83 ec 48             	sub    $0x48,%esp
80105dfa:	8b 4d 0c             	mov    0xc(%ebp),%ecx
80105dfd:	8b 55 10             	mov    0x10(%ebp),%edx
80105e00:	8b 45 14             	mov    0x14(%ebp),%eax
80105e03:	66 89 4d d4          	mov    %cx,-0x2c(%ebp)
80105e07:	66 89 55 d0          	mov    %dx,-0x30(%ebp)
80105e0b:	66 89 45 cc          	mov    %ax,-0x34(%ebp)
  uint off;
  struct inode *ip, *dp;
  char name[DIRSIZ];
...
80105e16:	8b 45 08             	mov    0x8(%ebp),%eax
80105e19:	89 04 24             	mov    %eax,(%esp)
80105e1c:	e8 98 c6 ff ff       	call   801024b9 <nameiparent>
80105e21:	89 45 f4             	mov    %eax,-0xc(%ebp)
80105e24:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
80105e28:	75 0a                	jne    80105e34 <create+0x40>
    return 0;
80105e2a:	b8 00 00 00 00       	mov    $0x0,%eax
80105e2f:	e9 7e 01 00 00       	jmp    80105fb2 <create+0x1be>
  ilock(dp);
80105e34:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105e37:	89 04 24             	mov    %eax,(%esp)
80105e3a:	e8 1e bb ff ff       	call   8010195d <ilock>

  if((ip = dirlookup(dp, name, &off)) != 0){
80105e3f:	8d 45 ec             	lea    -0x14(%ebp),%eax
...
80105e53:	e8 b7 c2 ff ff       	call   8010210f <dirlookup>
80105e58:	89 45 f0             	mov    %eax,-0x10(%ebp)
80105e5b:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
80105e5f:	74 47                	je     80105ea8 <create+0xb4>
    iunlockput(dp);
80105e61:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105e64:	89 04 24             	mov    %eax,(%esp)
80105e67:	e8 f3 bc ff ff       	call   80101b5f <iunlockput>
    ilock(ip);
80105e6c:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105e6f:	89 04 24             	mov    %eax,(%esp)
80105e72:	e8 e6 ba ff ff       	call   8010195d <ilock>
    if(type == T_FILE && ip->type == T_FILE)
80105e77:	66 83 7d d4 02       	cmpw   $0x2,-0x2c(%ebp)
80105e7c:	75 15                	jne    80105e93 <create+0x9f>
80105e7e:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105e81:	0f b7 40 50          	movzwl 0x50(%eax),%eax
80105e85:	66 83 f8 02          	cmp    $0x2,%ax
80105e89:	75 08                	jne    80105e93 <create+0x9f>
      return ip;
80105e8b:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105e8e:	e9 1f 01 00 00       	jmp    80105fb2 <create+0x1be>
    iunlockput(ip);
80105e93:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105e96:	89 04 24             	mov    %eax,(%esp)
80105e99:	e8 c1 bc ff ff       	call   80101b5f <iunlockput>
    return 0;
80105e9e:	b8 00 00 00 00       	mov    $0x0,%eax
80105ea3:	e9 0a 01 00 00       	jmp    80105fb2 <create+0x1be>
  }

  if((ip = ialloc(dp->dev, type)) == 0)
80105ea8:	0f bf 55 d4          	movswl -0x2c(%ebp),%edx
80105eac:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105eaf:	8b 00                	mov    (%eax),%eax
80105eb1:	89 54 24 04          	mov    %edx,0x4(%esp)
80105eb5:	89 04 24             	mov    %eax,(%esp)
80105eb8:	e8 06 b8 ff ff       	call   801016c3 <ialloc>
80105ebd:	89 45 f0             	mov    %eax,-0x10(%ebp)
80105ec0:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
80105ec4:	75 0c                	jne    80105ed2 <create+0xde>
    panic("create: ialloc");
80105ec6:	c7 04 24 e0 89 10 80 	movl   $0x801089e0,(%esp)
80105ecd:	e8 90 a6 ff ff       	call   80100562 <panic>

  ilock(ip);
80105ed2:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105ed5:	89 04 24             	mov    %eax,(%esp)
80105ed8:	e8 80 ba ff ff       	call   8010195d <ilock>
  ip->major = major;
80105edd:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105ee0:	0f b7 55 d0          	movzwl -0x30(%ebp),%edx
80105ee4:	66 89 50 52          	mov    %dx,0x52(%eax)
  ip->minor = minor;
80105ee8:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105eeb:	0f b7 55 cc          	movzwl -0x34(%ebp),%edx
80105eef:	66 89 50 54          	mov    %dx,0x54(%eax)
  ip->nlink = 1;
80105ef3:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105ef6:	66 c7 40 56 01 00    	movw   $0x1,0x56(%eax)
  iupdate(ip);
80105efc:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105eff:	89 04 24             	mov    %eax,(%esp)
80105f02:	e8 91 b8 ff ff       	call   80101798 <iupdate>

  if(type == T_DIR){  // Create . and .. entries.
80105f07:	66 83 7d d4 01       	cmpw   $0x1,-0x2c(%ebp)
80105f0c:	75 6a                	jne    80105f78 <create+0x184>
    dp->nlink++;  // for ".."
80105f0e:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105f11:	0f b7 40 56          	movzwl 0x56(%eax),%eax
80105f15:	8d 50 01             	lea    0x1(%eax),%edx
80105f18:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105f1b:	66 89 50 56          	mov    %dx,0x56(%eax)
    iupdate(dp);
80105f1f:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105f22:	89 04 24             	mov    %eax,(%esp)
80105f25:	e8 6e b8 ff ff       	call   80101798 <iupdate>
    // No ip->nlink++ for ".": avoid cyclic ref count.
    if(dirlink(ip, ".", ip->inum) < 0 || dirlink(ip, "..", dp->inum) < 0)
80105f2a:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105f2d:	8b 40 04             	mov    0x4(%eax),%eax
80105f30:	89 44 24 08          	mov    %eax,0x8(%esp)
80105f34:	c7 44 24 04 ba 89 10 	movl   $0x801089ba,0x4(%esp)
80105f3b:	80 
80105f3c:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105f3f:	89 04 24             	mov    %eax,(%esp)
80105f42:	e8 91 c2 ff ff       	call   801021d8 <dirlink>
80105f47:	85 c0                	test   %eax,%eax
80105f49:	78 21                	js     80105f6c <create+0x178>
80105f4b:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105f4e:	8b 40 04             	mov    0x4(%eax),%eax
80105f51:	89 44 24 08          	mov    %eax,0x8(%esp)
80105f55:	c7 44 24 04 bc 89 10 	movl   $0x801089bc,0x4(%esp)
80105f5c:	80 
80105f5d:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105f60:	89 04 24             	mov    %eax,(%esp)
80105f63:	e8 70 c2 ff ff       	call   801021d8 <dirlink>
80105f68:	85 c0                	test   %eax,%eax
80105f6a:	79 0c                	jns    80105f78 <create+0x184>
      panic("create dots");
80105f6c:	c7 04 24 ef 89 10 80 	movl   $0x801089ef,(%esp)
80105f73:	e8 ea a5 ff ff       	call   80100562 <panic>
  }
...
80105f82:	8d 45 de             	lea    -0x22(%ebp),%eax
80105f85:	89 44 24 04          	mov    %eax,0x4(%esp)
80105f89:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105f8c:	89 04 24             	mov    %eax,(%esp)
80105f8f:	e8 44 c2 ff ff       	call   801021d8 <dirlink>
80105f94:	85 c0                	test   %eax,%eax
80105f96:	79 0c                	jns    80105fa4 <create+0x1b0>
    panic("create: dirlink");
80105f98:	c7 04 24 fb 89 10 80 	movl   $0x801089fb,(%esp)
80105f9f:	e8 be a5 ff ff       	call   80100562 <panic>

  iunlockput(dp);
80105fa4:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105fa7:	89 04 24             	mov    %eax,(%esp)
80105faa:	e8 b0 bb ff ff       	call   80101b5f <iunlockput>
...
80105fba:	8d 45 e8             	lea    -0x18(%ebp),%eax
80105fbd:	89 44 24 04          	mov    %eax,0x4(%esp)
80105fc1:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
80105fc8:	e8 e0 f6 ff ff       	call   801056ad <argstr>
80105fcd:	85 c0                	test   %eax,%eax
80105fcf:	78 17                	js     80105fe8 <sys_open+0x34>
80105fd1:	8d 45 e4             	lea    -0x1c(%ebp),%eax
80105fd4:	89 44 24 04          	mov    %eax,0x4(%esp)
80105fd8:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
80105fdf:	e8 32 f6 ff ff       	call   80105616 <argint>
80105fe4:	85 c0                	test   %eax,%eax
80105fe6:	79 0a                	jns    80105ff2 <sys_open+0x3e>
    return -1;
80105fe8:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80105fed:	e9 5c 01 00 00       	jmp    8010614e <sys_open+0x19a>

  begin_op();
80105ff2:	e8 90 d4 ff ff       	call   80103487 <begin_op>

  if(omode & O_CREATE){
80105ff7:	8b 45 e4             	mov    -0x1c(%ebp),%eax
80105ffa:	25 00 02 00 00       	and    $0x200,%eax
80105fff:	85 c0                	test   %eax,%eax
80106001:	74 3b                	je     8010603e <sys_open+0x8a>
    ip = create(path, T_FILE, 0, 0);
80106003:	8b 45 e8             	mov    -0x18(%ebp),%eax
80106006:	c7 44 24 0c 00 00 00 	movl   $0x0,0xc(%esp)
8010600d:	00 
8010600e:	c7 44 24 08 00 00 00 	movl   $0x0,0x8(%esp)
80106015:	00 
80106016:	c7 44 24 04 02 00 00 	movl   $0x2,0x4(%esp)
8010601d:	00 
8010601e:	89 04 24             	mov    %eax,(%esp)
80106021:	e8 ce fd ff ff       	call   80105df4 <create>
80106026:	89 45 f4             	mov    %eax,-0xc(%ebp)
    if(ip == 0){
80106029:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
8010602d:	75 6b                	jne    8010609a <sys_open+0xe6>
      end_op();
8010602f:	e8 d7 d4 ff ff       	call   8010350b <end_op>
      return -1;
80106034:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80106039:	e9 10 01 00 00       	jmp    8010614e <sys_open+0x19a>
    }
  } else {
    if((ip = namei(path)) == 0){
8010603e:	8b 45 e8             	mov    -0x18(%ebp),%eax
80106041:	89 04 24             	mov    %eax,(%esp)
80106044:	e8 4e c4 ff ff       	call   80102497 <namei>
80106049:	89 45 f4             	mov    %eax,-0xc(%ebp)
8010604c:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
80106050:	75 0f                	jne    80106061 <sys_open+0xad>
      end_op();
80106052:	e8 b4 d4 ff ff       	call   8010350b <end_op>
      return -1;
80106057:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
8010605c:	e9 ed 00 00 00       	jmp    8010614e <sys_open+0x19a>
    }
    ilock(ip);
80106061:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106064:	89 04 24             	mov    %eax,(%esp)
80106067:	e8 f1 b8 ff ff       	call   8010195d <ilock>
    if(ip->type == T_DIR && omode != O_RDONLY){
8010606c:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010606f:	0f b7 40 50          	movzwl 0x50(%eax),%eax
80106073:	66 83 f8 01          	cmp    $0x1,%ax
80106077:	75 21                	jne    8010609a <sys_open+0xe6>
80106079:	8b 45 e4             	mov    -0x1c(%ebp),%eax
8010607c:	85 c0                	test   %eax,%eax
8010607e:	74 1a                	je     8010609a <sys_open+0xe6>
      iunlockput(ip);
80106080:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106083:	89 04 24             	mov    %eax,(%esp)
80106086:	e8 d4 ba ff ff       	call   80101b5f <iunlockput>
      end_op();
8010608b:	e8 7b d4 ff ff       	call   8010350b <end_op>
      return -1;
80106090:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80106095:	e9 b4 00 00 00       	jmp    8010614e <sys_open+0x19a>
    }
  }

  if((f = filealloc()) == 0 || (fd = fdalloc(f)) < 0){
8010609a:	e8 e6 ae ff ff       	call   80100f85 <filealloc>
8010609f:	89 45 f0             	mov    %eax,-0x10(%ebp)
801060a2:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
801060a6:	74 14                	je     801060bc <sys_open+0x108>
801060a8:	8b 45 f0             	mov    -0x10(%ebp),%eax
801060ab:	89 04 24             	mov    %eax,(%esp)
801060ae:	e8 2d f7 ff ff       	call   801057e0 <fdalloc>
801060b3:	89 45 ec             	mov    %eax,-0x14(%ebp)
801060b6:	83 7d ec 00          	cmpl   $0x0,-0x14(%ebp)
801060ba:	79 28                	jns    801060e4 <sys_open+0x130>
    if(f)
801060bc:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
801060c0:	74 0b                	je     801060cd <sys_open+0x119>
      fileclose(f);
801060c2:	8b 45 f0             	mov    -0x10(%ebp),%eax
801060c5:	89 04 24             	mov    %eax,(%esp)
801060c8:	e8 60 af ff ff       	call   8010102d <fileclose>
    iunlockput(ip);
801060cd:	8b 45 f4             	mov    -0xc(%ebp),%eax
801060d0:	89 04 24             	mov    %eax,(%esp)
801060d3:	e8 87 ba ff ff       	call   80101b5f <iunlockput>
    end_op();
801060d8:	e8 2e d4 ff ff       	call   8010350b <end_op>
    return -1;
801060dd:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
801060e2:	eb 6a                	jmp    8010614e <sys_open+0x19a>
  }
  iunlock(ip);
801060e4:	8b 45 f4             	mov    -0xc(%ebp),%eax
801060e7:	89 04 24             	mov    %eax,(%esp)
801060ea:	e8 7b b9 ff ff       	call   80101a6a <iunlock>
  end_op();
801060ef:	e8 17 d4 ff ff       	call   8010350b <end_op>

  f->type = FD_INODE;
801060f4:	8b 45 f0             	mov    -0x10(%ebp),%eax
801060f7:	c7 00 02 00 00 00    	movl   $0x2,(%eax)
  f->ip = ip;
801060fd:	8b 45 f0             	mov    -0x10(%ebp),%eax
80106100:	8b 55 f4             	mov    -0xc(%ebp),%edx
80106103:	89 50 10             	mov    %edx,0x10(%eax)
  f->off = 0;
80106106:	8b 45 f0             	mov    -0x10(%ebp),%eax
80106109:	c7 40 14 00 00 00 00 	movl   $0x0,0x14(%eax)
  f->readable = !(omode & O_WRONLY);
80106110:	8b 45 e4             	mov    -0x1c(%ebp),%eax
80106113:	83 e0 01             	and    $0x1,%eax
80106116:	85 c0                	test   %eax,%eax
80106118:	0f 94 c0             	sete   %al
8010611b:	89 c2                	mov    %eax,%edx
8010611d:	8b 45 f0             	mov    -0x10(%ebp),%eax
80106120:	88 50 08             	mov    %dl,0x8(%eax)
  f->writable = (omode & O_WRONLY) || (omode & O_RDWR);
80106123:	8b 45 e4             	mov    -0x1c(%ebp),%eax
80106126:	83 e0 01             	and    $0x1,%eax
80106129:	85 c0                	test   %eax,%eax
8010612b:	75 0a                	jne    80106137 <sys_open+0x183>
8010612d:	8b 45 e4             	mov    -0x1c(%ebp),%eax
80106130:	83 e0 02             	and    $0x2,%eax
80106133:	85 c0                	test   %eax,%eax
80106135:	74 07                	je     8010613e <sys_open+0x18a>
80106137:	b8 01 00 00 00       	mov    $0x1,%eax
8010613c:	eb 05                	jmp    80106143 <sys_open+0x18f>
8010613e:	b8 00 00 00 00       	mov    $0x0,%eax
80106143:	89 c2                	mov    %eax,%edx
80106145:	8b 45 f0             	mov    -0x10(%ebp),%eax
80106148:	88 50 09             	mov    %dl,0x9(%eax)
  return fd;
...
80106169:	e8 3f f5 ff ff       	call   801056ad <argstr>
8010616e:	85 c0                	test   %eax,%eax
80106170:	78 2c                	js     8010619e <sys_mkdir+0x4e>
...
80106184:	00 
80106185:	c7 44 24 04 01 00 00 	movl   $0x1,0x4(%esp)
8010618c:	00 
8010618d:	89 04 24             	mov    %eax,(%esp)
80106190:	e8 5f fc ff ff       	call   80105df4 <create>
80106195:	89 45 f4             	mov    %eax,-0xc(%ebp)
80106198:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
8010619c:	75 0c                	jne    801061aa <sys_mkdir+0x5a>
    end_op();
8010619e:	e8 68 d3 ff ff       	call   8010350b <end_op>
    return -1;
801061a3:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
801061a8:	eb 15                	jmp    801061bf <sys_mkdir+0x6f>
  }
  iunlockput(ip);
801061aa:	8b 45 f4             	mov    -0xc(%ebp),%eax
801061ad:	89 04 24             	mov    %eax,(%esp)
801061b0:	e8 aa b9 ff ff       	call   80101b5f <iunlockput>
  end_op();
801061b5:	e8 51 d3 ff ff       	call   8010350b <end_op>
  return 0;
...
801061c4:	83 ec 28             	sub    $0x28,%esp
  ...
  begin_op();
801061c7:	e8 bb d2 ff ff       	call   80103487 <begin_op>
  if((argstr(0, &path)) < 0 ||
801061cc:	8d 45 f0             	lea    -0x10(%ebp),%eax
801061cf:	89 44 24 04          	mov    %eax,0x4(%esp)
801061d3:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
801061da:	e8 ce f4 ff ff       	call   801056ad <argstr>
801061df:	85 c0                	test   %eax,%eax
801061e1:	78 5e                	js     80106241 <sys_mknod+0x80>
     argint(1, &major) < 0 ||
801061e3:	8d 45 ec             	lea    -0x14(%ebp),%eax
801061e6:	89 44 24 04          	mov    %eax,0x4(%esp)
801061ea:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
801061f1:	e8 20 f4 ff ff       	call   80105616 <argint>
  if((argstr(0, &path)) < 0 ||
801061f6:	85 c0                	test   %eax,%eax
801061f8:	78 47                	js     80106241 <sys_mknod+0x80>
     argint(2, &minor) < 0 ||
801061fa:	8d 45 e8             	lea    -0x18(%ebp),%eax
801061fd:	89 44 24 04          	mov    %eax,0x4(%esp)
80106201:	c7 04 24 02 00 00 00 	movl   $0x2,(%esp)
80106208:	e8 09 f4 ff ff       	call   80105616 <argint>
     argint(1, &major) < 0 ||
8010620d:	85 c0                	test   %eax,%eax
8010620f:	78 30                	js     80106241 <sys_mknod+0x80>
     (ip = create(path, T_DEV, major, minor)) == 0){
80106211:	8b 45 e8             	mov    -0x18(%ebp),%eax
80106214:	0f bf c8             	movswl %ax,%ecx
80106217:	8b 45 ec             	mov    -0x14(%ebp),%eax
8010621a:	0f bf d0             	movswl %ax,%edx
8010621d:	8b 45 f0             	mov    -0x10(%ebp),%eax
     argint(2, &minor) < 0 ||
80106220:	89 4c 24 0c          	mov    %ecx,0xc(%esp)
80106224:	89 54 24 08          	mov    %edx,0x8(%esp)
80106228:	c7 44 24 04 03 00 00 	movl   $0x3,0x4(%esp)
8010622f:	00 
80106230:	89 04 24             	mov    %eax,(%esp)
80106233:	e8 bc fb ff ff       	call   80105df4 <create>
80106238:	89 45 f4             	mov    %eax,-0xc(%ebp)
8010623b:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
8010623f:	75 0c                	jne    8010624d <sys_mknod+0x8c>
    end_op();
80106241:	e8 c5 d2 ff ff       	call   8010350b <end_op>
    return -1;
80106246:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
8010624b:	eb 15                	jmp    80106262 <sys_mknod+0xa1>
  }
  iunlockput(ip);
...
80106267:	83 ec 28             	sub    $0x28,%esp
  ...
  struct inode *ip;
  struct proc *curproc = myproc();
8010626a:	e8 f2 de ff ff       	call   80104161 <myproc>
8010626f:	89 45 f4             	mov    %eax,-0xc(%ebp)
  
  begin_op();
80106272:	e8 10 d2 ff ff       	call   80103487 <begin_op>
  if(argstr(0, &path) < 0 || (ip = namei(path)) == 0){
80106277:	8d 45 ec             	lea    -0x14(%ebp),%eax
8010627a:	89 44 24 04          	mov    %eax,0x4(%esp)
8010627e:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
80106285:	e8 23 f4 ff ff       	call   801056ad <argstr>
8010628a:	85 c0                	test   %eax,%eax
8010628c:	78 14                	js     801062a2 <sys_chdir+0x3e>
8010628e:	8b 45 ec             	mov    -0x14(%ebp),%eax
80106291:	89 04 24             	mov    %eax,(%esp)
80106294:	e8 fe c1 ff ff       	call   80102497 <namei>
80106299:	89 45 f0             	mov    %eax,-0x10(%ebp)
8010629c:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
801062a0:	75 0c                	jne    801062ae <sys_chdir+0x4a>
    end_op();
801062a2:	e8 64 d2 ff ff       	call   8010350b <end_op>
    return -1;
801062a7:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
801062ac:	eb 5b                	jmp    80106309 <sys_chdir+0xa5>
  }
  ilock(ip);
801062ae:	8b 45 f0             	mov    -0x10(%ebp),%eax
801062b1:	89 04 24             	mov    %eax,(%esp)
801062b4:	e8 a4 b6 ff ff       	call   8010195d <ilock>
  if(ip->type != T_DIR){
801062b9:	8b 45 f0             	mov    -0x10(%ebp),%eax
801062bc:	0f b7 40 50          	movzwl 0x50(%eax),%eax
801062c0:	66 83 f8 01          	cmp    $0x1,%ax
801062c4:	74 17                	je     801062dd <sys_chdir+0x79>
    iunlockput(ip);
801062c6:	8b 45 f0             	mov    -0x10(%ebp),%eax
801062c9:	89 04 24             	mov    %eax,(%esp)
801062cc:	e8 8e b8 ff ff       	call   80101b5f <iunlockput>
    end_op();
801062d1:	e8 35 d2 ff ff       	call   8010350b <end_op>
    return -1;
801062d6:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
801062db:	eb 2c                	jmp    80106309 <sys_chdir+0xa5>
  }
  iunlock(ip);
801062dd:	8b 45 f0             	mov    -0x10(%ebp),%eax
801062e0:	89 04 24             	mov    %eax,(%esp)
801062e3:	e8 82 b7 ff ff       	call   80101a6a <iunlock>
  iput(curproc->cwd);
801062e8:	8b 45 f4             	mov    -0xc(%ebp),%eax
801062eb:	8b 40 68             	mov    0x68(%eax),%eax
801062ee:	89 04 24             	mov    %eax,(%esp)
801062f1:	e8 b8 b7 ff ff       	call   80101aae <iput>
  end_op();
801062f6:	e8 10 d2 ff ff       	call   8010350b <end_op>
  curproc->cwd = ip;
801062fb:	8b 45 f4             	mov    -0xc(%ebp),%eax
801062fe:	8b 55 f0             	mov    -0x10(%ebp),%edx
80106301:	89 50 68             	mov    %edx,0x68(%eax)
  return 0;
...
8010630e:	81 ec a8 00 00 00    	sub    $0xa8,%esp
...
80106322:	e8 86 f3 ff ff       	call   801056ad <argstr>
80106327:	85 c0                	test   %eax,%eax
80106329:	78 1a                	js     80106345 <sys_exec+0x3a>
8010632b:	8d 85 6c ff ff ff    	lea    -0x94(%ebp),%eax
80106331:	89 44 24 04          	mov    %eax,0x4(%esp)
80106335:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
8010633c:	e8 d5 f2 ff ff       	call   80105616 <argint>
80106341:	85 c0                	test   %eax,%eax
80106343:	79 0a                	jns    8010634f <sys_exec+0x44>
    return -1;
80106345:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
8010634a:	e9 c8 00 00 00       	jmp    80106417 <sys_exec+0x10c>
  }
  memset(argv, 0, sizeof(argv));
8010634f:	c7 44 24 08 80 00 00 	movl   $0x80,0x8(%esp)
80106356:	00 
80106357:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
8010635e:	00 
8010635f:	8d 85 70 ff ff ff    	lea    -0x90(%ebp),%eax
80106365:	89 04 24             	mov    %eax,(%esp)
80106368:	e8 60 ef ff ff       	call   801052cd <memset>
  for(i=0;; i++){
8010636d:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%ebp)
    if(i >= NELEM(argv))
80106374:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106377:	83 f8 1f             	cmp    $0x1f,%eax
8010637a:	76 0a                	jbe    80106386 <sys_exec+0x7b>
      return -1;
8010637c:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80106381:	e9 91 00 00 00       	jmp    80106417 <sys_exec+0x10c>
    if(fetchint(uargv+4*i, (int*)&uarg) < 0)
80106386:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106389:	c1 e0 02             	shl    $0x2,%eax
8010638c:	89 c2                	mov    %eax,%edx
8010638e:	8b 85 6c ff ff ff    	mov    -0x94(%ebp),%eax
80106394:	01 c2                	add    %eax,%edx
80106396:	8d 85 68 ff ff ff    	lea    -0x98(%ebp),%eax
8010639c:	89 44 24 04          	mov    %eax,0x4(%esp)
801063a0:	89 14 24             	mov    %edx,(%esp)
801063a3:	e8 cb f1 ff ff       	call   80105573 <fetchint>
801063a8:	85 c0                	test   %eax,%eax
801063aa:	79 07                	jns    801063b3 <sys_exec+0xa8>
      return -1;
801063ac:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
801063b1:	eb 64                	jmp    80106417 <sys_exec+0x10c>
    if(uarg == 0){
801063b3:	8b 85 68 ff ff ff    	mov    -0x98(%ebp),%eax
801063b9:	85 c0                	test   %eax,%eax
801063bb:	75 26                	jne    801063e3 <sys_exec+0xd8>
      argv[i] = 0;
801063bd:	8b 45 f4             	mov    -0xc(%ebp),%eax
801063c0:	c7 84 85 70 ff ff ff 	movl   $0x0,-0x90(%ebp,%eax,4)
801063c7:	00 00 00 00 
      break;
801063cb:	90                   	nop
    }
...
801063cf:	8d 95 70 ff ff ff    	lea    -0x90(%ebp),%edx
801063d5:	89 54 24 04          	mov    %edx,0x4(%esp)
801063d9:	89 04 24             	mov    %eax,(%esp)
801063dc:	e8 3d a7 ff ff       	call   80100b1e <exec>
801063e1:	eb 34                	jmp    80106417 <sys_exec+0x10c>
    if(fetchstr(uarg, &argv[i]) < 0)
801063e3:	8d 85 70 ff ff ff    	lea    -0x90(%ebp),%eax
801063e9:	8b 55 f4             	mov    -0xc(%ebp),%edx
801063ec:	c1 e2 02             	shl    $0x2,%edx
801063ef:	01 c2                	add    %eax,%edx
801063f1:	8b 85 68 ff ff ff    	mov    -0x98(%ebp),%eax
801063f7:	89 54 24 04          	mov    %edx,0x4(%esp)
801063fb:	89 04 24             	mov    %eax,(%esp)
801063fe:	e8 af f1 ff ff       	call   801055b2 <fetchstr>
80106403:	85 c0                	test   %eax,%eax
80106405:	79 07                	jns    8010640e <sys_exec+0x103>
      return -1;
80106407:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
8010640c:	eb 09                	jmp    80106417 <sys_exec+0x10c>
  for(i=0;; i++){
8010640e:	83 45 f4 01          	addl   $0x1,-0xc(%ebp)
  }
80106412:	e9 5d ff ff ff       	jmp    80106374 <sys_exec+0x69>
}
80106417:	c9                   	leave  
80106418:	c3                   	ret    
...
8010641c:	83 ec 38             	sub    $0x38,%esp
  int *fd;
  struct file *rf, *wf;
  int fd0, fd1;

  if(argptr(0, (void*)&fd, 2*sizeof(fd[0])) < 0)
8010641f:	c7 44 24 08 08 00 00 	movl   $0x8,0x8(%esp)
80106426:	00 
80106427:	8d 45 ec             	lea    -0x14(%ebp),%eax
8010642a:	89 44 24 04          	mov    %eax,0x4(%esp)
8010642e:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
80106435:	e8 09 f2 ff ff       	call   80105643 <argptr>
8010643a:	85 c0                	test   %eax,%eax
8010643c:	79 0a                	jns    80106448 <sys_pipe+0x2f>
    return -1;
8010643e:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80106443:	e9 9a 00 00 00       	jmp    801064e2 <sys_pipe+0xc9>
...
80106455:	e8 8b d8 ff ff       	call   80103ce5 <pipealloc>
8010645a:	85 c0                	test   %eax,%eax
8010645c:	79 07                	jns    80106465 <sys_pipe+0x4c>
    return -1;
8010645e:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80106463:	eb 7d                	jmp    801064e2 <sys_pipe+0xc9>
  fd0 = -1;
80106465:	c7 45 f4 ff ff ff ff 	movl   $0xffffffff,-0xc(%ebp)
  if((fd0 = fdalloc(rf)) < 0 || (fd1 = fdalloc(wf)) < 0){
8010646c:	8b 45 e8             	mov    -0x18(%ebp),%eax
8010646f:	89 04 24             	mov    %eax,(%esp)
80106472:	e8 69 f3 ff ff       	call   801057e0 <fdalloc>
80106477:	89 45 f4             	mov    %eax,-0xc(%ebp)
8010647a:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
8010647e:	78 14                	js     80106494 <sys_pipe+0x7b>
80106480:	8b 45 e4             	mov    -0x1c(%ebp),%eax
80106483:	89 04 24             	mov    %eax,(%esp)
80106486:	e8 55 f3 ff ff       	call   801057e0 <fdalloc>
8010648b:	89 45 f0             	mov    %eax,-0x10(%ebp)
8010648e:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
80106492:	79 36                	jns    801064ca <sys_pipe+0xb1>
    if(fd0 >= 0)
80106494:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
80106498:	78 13                	js     801064ad <sys_pipe+0x94>
      myproc()->ofile[fd0] = 0;
8010649a:	e8 c2 dc ff ff       	call   80104161 <myproc>
8010649f:	8b 55 f4             	mov    -0xc(%ebp),%edx
801064a2:	83 c2 08             	add    $0x8,%edx
801064a5:	c7 44 90 08 00 00 00 	movl   $0x0,0x8(%eax,%edx,4)
801064ac:	00 
    fileclose(rf);
801064ad:	8b 45 e8             	mov    -0x18(%ebp),%eax
801064b0:	89 04 24             	mov    %eax,(%esp)
801064b3:	e8 75 ab ff ff       	call   8010102d <fileclose>
    fileclose(wf);
...
801064c8:	eb 18                	jmp    801064e2 <sys_pipe+0xc9>
  }
  fd[0] = fd0;
...
801064e7:	83 ec 08             	sub    $0x8,%esp
  return fork();
801064ea:	e8 8a df ff ff       	call   80104479 <fork>
}
801064ef:	c9                   	leave  
801064f0:	c3                   	ret    
...
801064f4:	83 ec 08             	sub    $0x8,%esp
  exit();
801064f7:	e8 14 e1 ff ff       	call   80104610 <exit>
...
80106506:	83 ec 08             	sub    $0x8,%esp
  return wait();
80106509:	e8 0f e2 ff ff       	call   8010471d <wait>
}
8010650e:	c9                   	leave  
8010650f:	c3                   	ret    
...
8010652b:	79 07                	jns    80106534 <sys_kill+0x24>
    return -1;
8010652d:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80106532:	eb 0b                	jmp    8010653f <sys_kill+0x2f>
  return kill(pid);
80106534:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106537:	89 04 24             	mov    %eax,(%esp)
8010653a:	e8 6d e6 ff ff       	call   80104bac <kill>
}
8010653f:	c9                   	leave  
80106540:	c3                   	ret    
...
8010654c:	8b 40 10             	mov    0x10(%eax),%eax
}
8010654f:	c9                   	leave  
80106550:	c3                   	ret    
...
8010656c:	79 07                	jns    80106575 <sys_sbrk+0x24>
    return -1;
8010656e:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80106573:	eb 23                	jmp    80106598 <sys_sbrk+0x47>
  addr = myproc()->sz;
80106575:	e8 e7 db ff ff       	call   80104161 <myproc>
...
80106585:	e8 51 de ff ff       	call   801043db <growproc>
8010658a:	85 c0                	test   %eax,%eax
8010658c:	79 07                	jns    80106595 <sys_sbrk+0x44>
    return -1;
8010658e:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80106593:	eb 03                	jmp    80106598 <sys_sbrk+0x47>
  return addr;
...
801065ae:	e8 63 f0 ff ff       	call   80105616 <argint>
801065b3:	85 c0                	test   %eax,%eax
801065b5:	79 07                	jns    801065be <sys_sleep+0x24>
    return -1;
801065b7:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
801065bc:	eb 6b                	jmp    80106629 <sys_sleep+0x8f>
  acquire(&tickslock);
801065be:	c7 04 24 20 5f 11 80 	movl   $0x80115f20,(%esp)
801065c5:	e8 91 ea ff ff       	call   8010505b <acquire>
  ticks0 = ticks;
801065ca:	a1 60 67 11 80       	mov    0x80116760,%eax
801065cf:	89 45 f4             	mov    %eax,-0xc(%ebp)
  while(ticks - ticks0 < n){
801065d2:	eb 33                	jmp    80106607 <sys_sleep+0x6d>
    if(myproc()->killed){
801065d4:	e8 88 db ff ff       	call   80104161 <myproc>
801065d9:	8b 40 24             	mov    0x24(%eax),%eax
801065dc:	85 c0                	test   %eax,%eax
801065de:	74 13                	je     801065f3 <sys_sleep+0x59>
      release(&tickslock);
801065e0:	c7 04 24 20 5f 11 80 	movl   $0x80115f20,(%esp)
801065e7:	e8 d7 ea ff ff       	call   801050c3 <release>
      return -1;
801065ec:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
801065f1:	eb 36                	jmp    80106629 <sys_sleep+0x8f>
    }
    sleep(&ticks, &tickslock);
801065f3:	c7 44 24 04 20 5f 11 	movl   $0x80115f20,0x4(%esp)
801065fa:	80 
801065fb:	c7 04 24 60 67 11 80 	movl   $0x80116760,(%esp)
80106602:	e8 a3 e4 ff ff       	call   80104aaa <sleep>
  while(ticks - ticks0 < n){
80106607:	a1 60 67 11 80       	mov    0x80116760,%eax
8010660c:	2b 45 f4             	sub    -0xc(%ebp),%eax
8010660f:	89 c2                	mov    %eax,%edx
80106611:	8b 45 f0             	mov    -0x10(%ebp),%eax
80106614:	39 c2                	cmp    %eax,%edx
80106616:	72 bc                	jb     801065d4 <sys_sleep+0x3a>
  }
  release(&tickslock);
80106618:	c7 04 24 20 5f 11 80 	movl   $0x80115f20,(%esp)
8010661f:	e8 9f ea ff ff       	call   801050c3 <release>
  return 0;
...
8010662e:	83 ec 28             	sub    $0x28,%esp
  ...
  acquire(&tickslock);
80106631:	c7 04 24 20 5f 11 80 	movl   $0x80115f20,(%esp)
80106638:	e8 1e ea ff ff       	call   8010505b <acquire>
  xticks = ticks;
8010663d:	a1 60 67 11 80       	mov    0x80116760,%eax
80106642:	89 45 f4             	mov    %eax,-0xc(%ebp)
  release(&tickslock);
80106645:	c7 04 24 20 5f 11 80 	movl   $0x80115f20,(%esp)
8010664c:	e8 72 ea ff ff       	call   801050c3 <release>
  return xticks;
...
8010665c:	c7 44 24 08 04 00 00 	movl   $0x4,0x8(%esp)
80106663:	00 
80106664:	8d 45 f4             	lea    -0xc(%ebp),%eax
80106667:	89 44 24 04          	mov    %eax,0x4(%esp)
8010666b:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
80106672:	e8 cc ef ff ff       	call   80105643 <argptr>

  fillpstat((pstatTable *) ptr);
80106677:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010667a:	89 04 24             	mov    %eax,(%esp)
8010667d:	e8 9f e6 ff ff       	call   80104d21 <fillpstat>
...
8010668c:	83 ec 28             	sub    $0x28,%esp
  int n = 0;
8010668f:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%ebp)
  argint(0, &n);
80106696:	8d 45 f4             	lea    -0xc(%ebp),%eax
80106699:	89 44 24 04          	mov    %eax,0x4(%esp)
8010669d:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
801066a4:	e8 6d ef ff ff       	call   80105616 <argint>
  if(n < 10)
801066a9:	8b 45 f4             	mov    -0xc(%ebp),%eax
801066ac:	83 f8 09             	cmp    $0x9,%eax
801066af:	7f 07                	jg     801066b8 <sys_settickets+0x2f>
  {
    return -1;
801066b1:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
801066b6:	eb 10                	jmp    801066c8 <sys_settickets+0x3f>
  }
  myproc()->tickets = n;
801066b8:	e8 a4 da ff ff       	call   80104161 <myproc>
801066bd:	8b 55 f4             	mov    -0xc(%ebp),%edx
801066c0:	89 50 7c             	mov    %edx,0x7c(%eax)
  return 0;
...
801066cb:	06                   	push   %es
  pushl %fs
801066cc:	0f a0                	push   %fs
  pushl %gs
801066ce:	0f a8                	push   %gs
  pushal
801066d0:	60                   	pusha  
  
  # Set up data segments.
  movw $(SEG_KDATA<<3), %ax
801066d1:	66 b8 10 00          	mov    $0x10,%ax
  movw %ax, %ds
801066d5:	8e d8                	mov    %eax,%ds
  movw %ax, %es
801066d7:	8e c0                	mov    %eax,%es

  # Call trap(tf), where tf=%esp
  pushl %esp
801066d9:	54                   	push   %esp
  call trap
801066da:	e8 d8 01 00 00       	call   801068b7 <trap>
  addl $4, %esp
801066df:	83 c4 04             	add    $0x4,%esp
...
801066e2:	61                   	popa   
  popl %gs
801066e3:	0f a9                	pop    %gs
  popl %fs
801066e5:	0f a1                	pop    %fs
  popl %es
801066e7:	07                   	pop    %es
  popl %ds
801066e8:	1f                   	pop    %ds
...
801066f6:	83 e8 01             	sub    $0x1,%eax
801066f9:	66 89 45 fa          	mov    %ax,-0x6(%ebp)
  pd[1] = (uint)p;
801066fd:	8b 45 08             	mov    0x8(%ebp),%eax
80106700:	66 89 45 fc          	mov    %ax,-0x4(%ebp)
  pd[2] = (uint)p >> 16;
80106704:	8b 45 08             	mov    0x8(%ebp),%eax
80106707:	c1 e8 10             	shr    $0x10,%eax
8010670a:	66 89 45 fe          	mov    %ax,-0x2(%ebp)
  asm volatile("lidt (%0)" : : "r" (pd));
8010670e:	8d 45 fa             	lea    -0x6(%ebp),%eax
80106711:	0f 01 18             	lidtl  (%eax)
}
80106714:	c9                   	leave  
80106715:	c3                   	ret    
...
8010671c:	0f 20 d0             	mov    %cr2,%eax
8010671f:	89 45 fc             	mov    %eax,-0x4(%ebp)
  return val;
80106722:	8b 45 fc             	mov    -0x4(%ebp),%eax
}
80106725:	c9                   	leave  
80106726:	c3                   	ret    
...
8010672a:	83 ec 28             	sub    $0x28,%esp
  ...
  for(i = 0; i < 256; i++)
8010672d:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%ebp)
80106734:	e9 c3 00 00 00       	jmp    801067fc <tvinit+0xd5>
    SETGATE(idt[i], 0, SEG_KCODE<<3, vectors[i], 0);
80106739:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010673c:	8b 04 85 a4 b0 10 80 	mov    -0x7fef4f5c(,%eax,4),%eax
80106743:	89 c2                	mov    %eax,%edx
80106745:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106748:	66 89 14 c5 60 5f 11 	mov    %dx,-0x7feea0a0(,%eax,8)
8010674f:	80 
80106750:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106753:	66 c7 04 c5 62 5f 11 	movw   $0x8,-0x7feea09e(,%eax,8)
8010675a:	80 08 00 
8010675d:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106760:	0f b6 14 c5 64 5f 11 	movzbl -0x7feea09c(,%eax,8),%edx
80106767:	80 
80106768:	83 e2 e0             	and    $0xffffffe0,%edx
8010676b:	88 14 c5 64 5f 11 80 	mov    %dl,-0x7feea09c(,%eax,8)
80106772:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106775:	0f b6 14 c5 64 5f 11 	movzbl -0x7feea09c(,%eax,8),%edx
8010677c:	80 
8010677d:	83 e2 1f             	and    $0x1f,%edx
80106780:	88 14 c5 64 5f 11 80 	mov    %dl,-0x7feea09c(,%eax,8)
80106787:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010678a:	0f b6 14 c5 65 5f 11 	movzbl -0x7feea09b(,%eax,8),%edx
80106791:	80 
80106792:	83 e2 f0             	and    $0xfffffff0,%edx
80106795:	83 ca 0e             	or     $0xe,%edx
80106798:	88 14 c5 65 5f 11 80 	mov    %dl,-0x7feea09b(,%eax,8)
8010679f:	8b 45 f4             	mov    -0xc(%ebp),%eax
801067a2:	0f b6 14 c5 65 5f 11 	movzbl -0x7feea09b(,%eax,8),%edx
801067a9:	80 
801067aa:	83 e2 ef             	and    $0xffffffef,%edx
801067ad:	88 14 c5 65 5f 11 80 	mov    %dl,-0x7feea09b(,%eax,8)
801067b4:	8b 45 f4             	mov    -0xc(%ebp),%eax
801067b7:	0f b6 14 c5 65 5f 11 	movzbl -0x7feea09b(,%eax,8),%edx
801067be:	80 
801067bf:	83 e2 9f             	and    $0xffffff9f,%edx
801067c2:	88 14 c5 65 5f 11 80 	mov    %dl,-0x7feea09b(,%eax,8)
801067c9:	8b 45 f4             	mov    -0xc(%ebp),%eax
801067cc:	0f b6 14 c5 65 5f 11 	movzbl -0x7feea09b(,%eax,8),%edx
801067d3:	80 
801067d4:	83 ca 80             	or     $0xffffff80,%edx
801067d7:	88 14 c5 65 5f 11 80 	mov    %dl,-0x7feea09b(,%eax,8)
801067de:	8b 45 f4             	mov    -0xc(%ebp),%eax
801067e1:	8b 04 85 a4 b0 10 80 	mov    -0x7fef4f5c(,%eax,4),%eax
801067e8:	c1 e8 10             	shr    $0x10,%eax
801067eb:	89 c2                	mov    %eax,%edx
801067ed:	8b 45 f4             	mov    -0xc(%ebp),%eax
801067f0:	66 89 14 c5 66 5f 11 	mov    %dx,-0x7feea09a(,%eax,8)
801067f7:	80 
  for(i = 0; i < 256; i++)
801067f8:	83 45 f4 01          	addl   $0x1,-0xc(%ebp)
801067fc:	81 7d f4 ff 00 00 00 	cmpl   $0xff,-0xc(%ebp)
80106803:	0f 8e 30 ff ff ff    	jle    80106739 <tvinit+0x12>
  SETGATE(idt[T_SYSCALL], 1, SEG_KCODE<<3, vectors[T_SYSCALL], DPL_USER);
80106809:	a1 a4 b1 10 80       	mov    0x8010b1a4,%eax
8010680e:	66 a3 60 61 11 80    	mov    %ax,0x80116160
80106814:	66 c7 05 62 61 11 80 	movw   $0x8,0x80116162
8010681b:	08 00 
8010681d:	0f b6 05 64 61 11 80 	movzbl 0x80116164,%eax
80106824:	83 e0 e0             	and    $0xffffffe0,%eax
80106827:	a2 64 61 11 80       	mov    %al,0x80116164
8010682c:	0f b6 05 64 61 11 80 	movzbl 0x80116164,%eax
80106833:	83 e0 1f             	and    $0x1f,%eax
80106836:	a2 64 61 11 80       	mov    %al,0x80116164
8010683b:	0f b6 05 65 61 11 80 	movzbl 0x80116165,%eax
80106842:	83 c8 0f             	or     $0xf,%eax
80106845:	a2 65 61 11 80       	mov    %al,0x80116165
8010684a:	0f b6 05 65 61 11 80 	movzbl 0x80116165,%eax
80106851:	83 e0 ef             	and    $0xffffffef,%eax
80106854:	a2 65 61 11 80       	mov    %al,0x80116165
80106859:	0f b6 05 65 61 11 80 	movzbl 0x80116165,%eax
80106860:	83 c8 60             	or     $0x60,%eax
80106863:	a2 65 61 11 80       	mov    %al,0x80116165
80106868:	0f b6 05 65 61 11 80 	movzbl 0x80116165,%eax
8010686f:	83 c8 80             	or     $0xffffff80,%eax
80106872:	a2 65 61 11 80       	mov    %al,0x80116165
80106877:	a1 a4 b1 10 80       	mov    0x8010b1a4,%eax
8010687c:	c1 e8 10             	shr    $0x10,%eax
8010687f:	66 a3 66 61 11 80    	mov    %ax,0x80116166

  initlock(&tickslock, "time");
80106885:	c7 44 24 04 0c 8a 10 	movl   $0x80108a0c,0x4(%esp)
8010688c:	80 
8010688d:	c7 04 24 20 5f 11 80 	movl   $0x80115f20,(%esp)
80106894:	e8 a1 e7 ff ff       	call   8010503a <initlock>
}
80106899:	c9                   	leave  
8010689a:	c3                   	ret    
...
8010689e:	83 ec 08             	sub    $0x8,%esp
  lidt(idt, sizeof(idt));
801068a1:	c7 44 24 04 00 08 00 	movl   $0x800,0x4(%esp)
801068a8:	00 
801068a9:	c7 04 24 60 5f 11 80 	movl   $0x80115f60,(%esp)
801068b0:	e8 38 fe ff ff       	call   801066ed <lidt>
}
801068b5:	c9                   	leave  
801068b6:	c3                   	ret    
...
801068ba:	57                   	push   %edi
801068bb:	56                   	push   %esi
801068bc:	53                   	push   %ebx
801068bd:	83 ec 3c             	sub    $0x3c,%esp
  if(tf->trapno == T_SYSCALL){
801068c0:	8b 45 08             	mov    0x8(%ebp),%eax
801068c3:	8b 40 30             	mov    0x30(%eax),%eax
801068c6:	83 f8 40             	cmp    $0x40,%eax
801068c9:	75 3c                	jne    80106907 <trap+0x50>
    if(myproc()->killed)
801068cb:	e8 91 d8 ff ff       	call   80104161 <myproc>
801068d0:	8b 40 24             	mov    0x24(%eax),%eax
801068d3:	85 c0                	test   %eax,%eax
801068d5:	74 05                	je     801068dc <trap+0x25>
      exit();
801068d7:	e8 34 dd ff ff       	call   80104610 <exit>
    myproc()->tf = tf;
801068dc:	e8 80 d8 ff ff       	call   80104161 <myproc>
801068e1:	8b 55 08             	mov    0x8(%ebp),%edx
801068e4:	89 50 18             	mov    %edx,0x18(%eax)
    syscall();
801068e7:	e8 f8 ed ff ff       	call   801056e4 <syscall>
    if(myproc()->killed)
801068ec:	e8 70 d8 ff ff       	call   80104161 <myproc>
801068f1:	8b 40 24             	mov    0x24(%eax),%eax
801068f4:	85 c0                	test   %eax,%eax
801068f6:	74 0a                	je     80106902 <trap+0x4b>
      exit();
801068f8:	e8 13 dd ff ff       	call   80104610 <exit>
    return;
801068fd:	e9 19 02 00 00       	jmp    80106b1b <trap+0x264>
80106902:	e9 14 02 00 00       	jmp    80106b1b <trap+0x264>
  }

  switch(tf->trapno){
80106907:	8b 45 08             	mov    0x8(%ebp),%eax
8010690a:	8b 40 30             	mov    0x30(%eax),%eax
8010690d:	83 e8 20             	sub    $0x20,%eax
80106910:	83 f8 1f             	cmp    $0x1f,%eax
80106913:	0f 87 b1 00 00 00    	ja     801069ca <trap+0x113>
80106919:	8b 04 85 b4 8a 10 80 	mov    -0x7fef754c(,%eax,4),%eax
80106920:	ff e0                	jmp    *%eax
  case T_IRQ0 + IRQ_TIMER:
    if(cpuid() == 0){
80106922:	e8 a3 d7 ff ff       	call   801040ca <cpuid>
80106927:	85 c0                	test   %eax,%eax
80106929:	75 31                	jne    8010695c <trap+0xa5>
      acquire(&tickslock);
8010692b:	c7 04 24 20 5f 11 80 	movl   $0x80115f20,(%esp)
80106932:	e8 24 e7 ff ff       	call   8010505b <acquire>
      ticks++;
80106937:	a1 60 67 11 80       	mov    0x80116760,%eax
8010693c:	83 c0 01             	add    $0x1,%eax
8010693f:	a3 60 67 11 80       	mov    %eax,0x80116760
      wakeup(&ticks);
80106944:	c7 04 24 60 67 11 80 	movl   $0x80116760,(%esp)
8010694b:	e8 31 e2 ff ff       	call   80104b81 <wakeup>
      release(&tickslock);
80106950:	c7 04 24 20 5f 11 80 	movl   $0x80115f20,(%esp)
80106957:	e8 67 e7 ff ff       	call   801050c3 <release>
    }
    lapiceoi();
8010695c:	e8 f0 c5 ff ff       	call   80102f51 <lapiceoi>
    break;
80106961:	e9 37 01 00 00       	jmp    80106a9d <trap+0x1e6>
  case T_IRQ0 + IRQ_IDE:
    ideintr();
80106966:	e8 5d be ff ff       	call   801027c8 <ideintr>
    lapiceoi();
8010696b:	e8 e1 c5 ff ff       	call   80102f51 <lapiceoi>
    break;
80106970:	e9 28 01 00 00       	jmp    80106a9d <trap+0x1e6>
  case T_IRQ0 + IRQ_IDE+1:
    // Bochs generates spurious IDE1 interrupts.
    break;
  case T_IRQ0 + IRQ_KBD:
    kbdintr();
80106975:	e8 ec c3 ff ff       	call   80102d66 <kbdintr>
    lapiceoi();
8010697a:	e8 d2 c5 ff ff       	call   80102f51 <lapiceoi>
    break;
8010697f:	e9 19 01 00 00       	jmp    80106a9d <trap+0x1e6>
  case T_IRQ0 + IRQ_COM1:
    uartintr();
80106984:	e8 7b 03 00 00       	call   80106d04 <uartintr>
    lapiceoi();
80106989:	e8 c3 c5 ff ff       	call   80102f51 <lapiceoi>
    break;
8010698e:	e9 0a 01 00 00       	jmp    80106a9d <trap+0x1e6>
  case T_IRQ0 + 7:
  case T_IRQ0 + IRQ_SPURIOUS:
    cprintf("cpu%d: spurious interrupt at %x:%x\n",
80106993:	8b 45 08             	mov    0x8(%ebp),%eax
80106996:	8b 70 38             	mov    0x38(%eax),%esi
            cpuid(), tf->cs, tf->eip);
80106999:	8b 45 08             	mov    0x8(%ebp),%eax
8010699c:	0f b7 40 3c          	movzwl 0x3c(%eax),%eax
    cprintf("cpu%d: spurious interrupt at %x:%x\n",
801069a0:	0f b7 d8             	movzwl %ax,%ebx
801069a3:	e8 22 d7 ff ff       	call   801040ca <cpuid>
801069a8:	89 74 24 0c          	mov    %esi,0xc(%esp)
801069ac:	89 5c 24 08          	mov    %ebx,0x8(%esp)
801069b0:	89 44 24 04          	mov    %eax,0x4(%esp)
801069b4:	c7 04 24 14 8a 10 80 	movl   $0x80108a14,(%esp)
801069bb:	e8 08 9a ff ff       	call   801003c8 <cprintf>
    lapiceoi();
801069c0:	e8 8c c5 ff ff       	call   80102f51 <lapiceoi>
    break;
801069c5:	e9 d3 00 00 00       	jmp    80106a9d <trap+0x1e6>

  //PAGEBREAK: 13
  default:
    if(myproc() == 0 || (tf->cs&3) == 0){
801069ca:	e8 92 d7 ff ff       	call   80104161 <myproc>
801069cf:	85 c0                	test   %eax,%eax
801069d1:	74 11                	je     801069e4 <trap+0x12d>
...
801069e2:	75 40                	jne    80106a24 <trap+0x16d>
      // In kernel, it must be our mistake.
      cprintf("unexpected trap %d from cpu %d eip %x (cr2=0x%x)\n",
801069e4:	e8 2d fd ff ff       	call   80106716 <rcr2>
801069e9:	89 c3                	mov    %eax,%ebx
801069eb:	8b 45 08             	mov    0x8(%ebp),%eax
801069ee:	8b 70 38             	mov    0x38(%eax),%esi
801069f1:	e8 d4 d6 ff ff       	call   801040ca <cpuid>
801069f6:	8b 55 08             	mov    0x8(%ebp),%edx
801069f9:	8b 52 30             	mov    0x30(%edx),%edx
801069fc:	89 5c 24 10          	mov    %ebx,0x10(%esp)
80106a00:	89 74 24 0c          	mov    %esi,0xc(%esp)
80106a04:	89 44 24 08          	mov    %eax,0x8(%esp)
80106a08:	89 54 24 04          	mov    %edx,0x4(%esp)
80106a0c:	c7 04 24 38 8a 10 80 	movl   $0x80108a38,(%esp)
80106a13:	e8 b0 99 ff ff       	call   801003c8 <cprintf>
              tf->trapno, cpuid(), tf->eip, rcr2());
      panic("trap");
80106a18:	c7 04 24 6a 8a 10 80 	movl   $0x80108a6a,(%esp)
80106a1f:	e8 3e 9b ff ff       	call   80100562 <panic>
    }
    // In user space, assume process misbehaved.
    cprintf("pid %d %s: trap %d err %d on cpu %d "
80106a24:	e8 ed fc ff ff       	call   80106716 <rcr2>
80106a29:	89 c6                	mov    %eax,%esi
80106a2b:	8b 45 08             	mov    0x8(%ebp),%eax
80106a2e:	8b 40 38             	mov    0x38(%eax),%eax
80106a31:	89 45 e4             	mov    %eax,-0x1c(%ebp)
80106a34:	e8 91 d6 ff ff       	call   801040ca <cpuid>
80106a39:	89 c3                	mov    %eax,%ebx
80106a3b:	8b 45 08             	mov    0x8(%ebp),%eax
80106a3e:	8b 78 34             	mov    0x34(%eax),%edi
80106a41:	89 7d e0             	mov    %edi,-0x20(%ebp)
80106a44:	8b 45 08             	mov    0x8(%ebp),%eax
80106a47:	8b 78 30             	mov    0x30(%eax),%edi
            "eip 0x%x addr 0x%x--kill proc\n",
            myproc()->pid, myproc()->name, tf->trapno,
80106a4a:	e8 12 d7 ff ff       	call   80104161 <myproc>
80106a4f:	8d 50 6c             	lea    0x6c(%eax),%edx
80106a52:	89 55 dc             	mov    %edx,-0x24(%ebp)
80106a55:	e8 07 d7 ff ff       	call   80104161 <myproc>
    cprintf("pid %d %s: trap %d err %d on cpu %d "
80106a5a:	8b 40 10             	mov    0x10(%eax),%eax
80106a5d:	89 74 24 1c          	mov    %esi,0x1c(%esp)
80106a61:	8b 4d e4             	mov    -0x1c(%ebp),%ecx
80106a64:	89 4c 24 18          	mov    %ecx,0x18(%esp)
80106a68:	89 5c 24 14          	mov    %ebx,0x14(%esp)
80106a6c:	8b 4d e0             	mov    -0x20(%ebp),%ecx
80106a6f:	89 4c 24 10          	mov    %ecx,0x10(%esp)
80106a73:	89 7c 24 0c          	mov    %edi,0xc(%esp)
80106a77:	8b 55 dc             	mov    -0x24(%ebp),%edx
80106a7a:	89 54 24 08          	mov    %edx,0x8(%esp)
80106a7e:	89 44 24 04          	mov    %eax,0x4(%esp)
80106a82:	c7 04 24 70 8a 10 80 	movl   $0x80108a70,(%esp)
80106a89:	e8 3a 99 ff ff       	call   801003c8 <cprintf>
            tf->err, cpuid(), tf->eip, rcr2());
    myproc()->killed = 1;
80106a8e:	e8 ce d6 ff ff       	call   80104161 <myproc>
80106a93:	c7 40 24 01 00 00 00 	movl   $0x1,0x24(%eax)
80106a9a:	eb 01                	jmp    80106a9d <trap+0x1e6>
    break;
80106a9c:	90                   	nop
  }
...
80106a9d:	e8 bf d6 ff ff       	call   80104161 <myproc>
80106aa2:	85 c0                	test   %eax,%eax
80106aa4:	74 23                	je     80106ac9 <trap+0x212>
80106aa6:	e8 b6 d6 ff ff       	call   80104161 <myproc>
80106aab:	8b 40 24             	mov    0x24(%eax),%eax
80106aae:	85 c0                	test   %eax,%eax
80106ab0:	74 17                	je     80106ac9 <trap+0x212>
80106ab2:	8b 45 08             	mov    0x8(%ebp),%eax
80106ab5:	0f b7 40 3c          	movzwl 0x3c(%eax),%eax
80106ab9:	0f b7 c0             	movzwl %ax,%eax
80106abc:	83 e0 03             	and    $0x3,%eax
80106abf:	83 f8 03             	cmp    $0x3,%eax
80106ac2:	75 05                	jne    80106ac9 <trap+0x212>
    exit();
80106ac4:	e8 47 db ff ff       	call   80104610 <exit>

  // Force process to give up CPU on clock tick.
  // If interrupts were on while locks held, would need to check nlock.
  if(myproc() && myproc()->state == RUNNING &&
80106ac9:	e8 93 d6 ff ff       	call   80104161 <myproc>
80106ace:	85 c0                	test   %eax,%eax
80106ad0:	74 1d                	je     80106aef <trap+0x238>
80106ad2:	e8 8a d6 ff ff       	call   80104161 <myproc>
80106ad7:	8b 40 0c             	mov    0xc(%eax),%eax
80106ada:	83 f8 04             	cmp    $0x4,%eax
80106add:	75 10                	jne    80106aef <trap+0x238>
     tf->trapno == T_IRQ0+IRQ_TIMER)
80106adf:	8b 45 08             	mov    0x8(%ebp),%eax
80106ae2:	8b 40 30             	mov    0x30(%eax),%eax
  if(myproc() && myproc()->state == RUNNING &&
80106ae5:	83 f8 20             	cmp    $0x20,%eax
80106ae8:	75 05                	jne    80106aef <trap+0x238>
    yield();
80106aea:	e8 4b df ff ff       	call   80104a3a <yield>

  // Check if the process has been killed since we yielded
  if(myproc() && myproc()->killed && (tf->cs&3) == DPL_USER)
80106aef:	e8 6d d6 ff ff       	call   80104161 <myproc>
80106af4:	85 c0                	test   %eax,%eax
80106af6:	74 23                	je     80106b1b <trap+0x264>
80106af8:	e8 64 d6 ff ff       	call   80104161 <myproc>
80106afd:	8b 40 24             	mov    0x24(%eax),%eax
80106b00:	85 c0                	test   %eax,%eax
80106b02:	74 17                	je     80106b1b <trap+0x264>
80106b04:	8b 45 08             	mov    0x8(%ebp),%eax
80106b07:	0f b7 40 3c          	movzwl 0x3c(%eax),%eax
80106b0b:	0f b7 c0             	movzwl %ax,%eax
80106b0e:	83 e0 03             	and    $0x3,%eax
80106b11:	83 f8 03             	cmp    $0x3,%eax
80106b14:	75 05                	jne    80106b1b <trap+0x264>
    exit();
80106b16:	e8 f5 da ff ff       	call   80104610 <exit>
}
80106b1b:	83 c4 3c             	add    $0x3c,%esp
80106b1e:	5b                   	pop    %ebx
80106b1f:	5e                   	pop    %esi
80106b20:	5f                   	pop    %edi
80106b21:	5d                   	pop    %ebp
...
80106b26:	83 ec 14             	sub    $0x14,%esp
80106b29:	8b 45 08             	mov    0x8(%ebp),%eax
80106b2c:	66 89 45 ec          	mov    %ax,-0x14(%ebp)
  asm volatile("in %1,%0" : "=a" (data) : "d" (port));
80106b30:	0f b7 45 ec          	movzwl -0x14(%ebp),%eax
80106b34:	89 c2                	mov    %eax,%edx
80106b36:	ec                   	in     (%dx),%al
80106b37:	88 45 ff             	mov    %al,-0x1(%ebp)
  return data;
80106b3a:	0f b6 45 ff          	movzbl -0x1(%ebp),%eax
}
80106b3e:	c9                   	leave  
80106b3f:	c3                   	ret    
...
80106b4c:	66 89 55 fc          	mov    %dx,-0x4(%ebp)
...
80106b61:	83 ec 28             	sub    $0x28,%esp
  char *p;
...
80106b6b:	00 
80106b6c:	c7 04 24 fa 03 00 00 	movl   $0x3fa,(%esp)
80106b73:	e8 c8 ff ff ff       	call   80106b40 <outb>

  // 9600 baud, 8 data bits, 1 stop bit, parity off.
  outb(COM1+3, 0x80);    // Unlock divisor
80106b78:	c7 44 24 04 80 00 00 	movl   $0x80,0x4(%esp)
80106b7f:	00 
80106b80:	c7 04 24 fb 03 00 00 	movl   $0x3fb,(%esp)
80106b87:	e8 b4 ff ff ff       	call   80106b40 <outb>
  outb(COM1+0, 115200/9600);
80106b8c:	c7 44 24 04 0c 00 00 	movl   $0xc,0x4(%esp)
80106b93:	00 
80106b94:	c7 04 24 f8 03 00 00 	movl   $0x3f8,(%esp)
80106b9b:	e8 a0 ff ff ff       	call   80106b40 <outb>
  outb(COM1+1, 0);
80106ba0:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
80106ba7:	00 
80106ba8:	c7 04 24 f9 03 00 00 	movl   $0x3f9,(%esp)
80106baf:	e8 8c ff ff ff       	call   80106b40 <outb>
  outb(COM1+3, 0x03);    // Lock divisor, 8 data bits.
80106bb4:	c7 44 24 04 03 00 00 	movl   $0x3,0x4(%esp)
80106bbb:	00 
80106bbc:	c7 04 24 fb 03 00 00 	movl   $0x3fb,(%esp)
80106bc3:	e8 78 ff ff ff       	call   80106b40 <outb>
  outb(COM1+4, 0);
80106bc8:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
80106bcf:	00 
80106bd0:	c7 04 24 fc 03 00 00 	movl   $0x3fc,(%esp)
80106bd7:	e8 64 ff ff ff       	call   80106b40 <outb>
  outb(COM1+1, 0x01);    // Enable receive interrupts.
80106bdc:	c7 44 24 04 01 00 00 	movl   $0x1,0x4(%esp)
80106be3:	00 
80106be4:	c7 04 24 f9 03 00 00 	movl   $0x3f9,(%esp)
80106beb:	e8 50 ff ff ff       	call   80106b40 <outb>

  // If status is 0xFF, no serial port.
  if(inb(COM1+5) == 0xFF)
80106bf0:	c7 04 24 fd 03 00 00 	movl   $0x3fd,(%esp)
80106bf7:	e8 27 ff ff ff       	call   80106b23 <inb>
80106bfc:	3c ff                	cmp    $0xff,%al
80106bfe:	75 02                	jne    80106c02 <uartinit+0xa4>
    return;
80106c00:	eb 5e                	jmp    80106c60 <uartinit+0x102>
  uart = 1;
80106c02:	c7 05 64 b6 10 80 01 	movl   $0x1,0x8010b664
80106c09:	00 00 00 

  // Acknowledge pre-existing interrupt conditions;
  // enable interrupts.
  inb(COM1+2);
80106c0c:	c7 04 24 fa 03 00 00 	movl   $0x3fa,(%esp)
80106c13:	e8 0b ff ff ff       	call   80106b23 <inb>
  inb(COM1+0);
80106c18:	c7 04 24 f8 03 00 00 	movl   $0x3f8,(%esp)
80106c1f:	e8 ff fe ff ff       	call   80106b23 <inb>
  ioapicenable(IRQ_COM1, 0);
80106c24:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
80106c2b:	00 
80106c2c:	c7 04 24 04 00 00 00 	movl   $0x4,(%esp)
80106c33:	e8 07 be ff ff       	call   80102a3f <ioapicenable>

  // Announce that we're here.
  for(p="xv6...\n"; *p; p++)
80106c38:	c7 45 f4 34 8b 10 80 	movl   $0x80108b34,-0xc(%ebp)
80106c3f:	eb 15                	jmp    80106c56 <uartinit+0xf8>
    uartputc(*p);
80106c41:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106c44:	0f b6 00             	movzbl (%eax),%eax
80106c47:	0f be c0             	movsbl %al,%eax
80106c4a:	89 04 24             	mov    %eax,(%esp)
80106c4d:	e8 10 00 00 00       	call   80106c62 <uartputc>
  for(p="xv6...\n"; *p; p++)
80106c52:	83 45 f4 01          	addl   $0x1,-0xc(%ebp)
80106c56:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106c59:	0f b6 00             	movzbl (%eax),%eax
80106c5c:	84 c0                	test   %al,%al
80106c5e:	75 e1                	jne    80106c41 <uartinit+0xe3>
}
80106c60:	c9                   	leave  
80106c61:	c3                   	ret    
...
80106c65:	83 ec 28             	sub    $0x28,%esp
  ...
  if(!uart)
80106c68:	a1 64 b6 10 80       	mov    0x8010b664,%eax
80106c6d:	85 c0                	test   %eax,%eax
80106c6f:	75 02                	jne    80106c73 <uartputc+0x11>
    return;
80106c71:	eb 4b                	jmp    80106cbe <uartputc+0x5c>
  for(i = 0; i < 128 && !(inb(COM1+5) & 0x20); i++)
80106c73:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%ebp)
80106c7a:	eb 10                	jmp    80106c8c <uartputc+0x2a>
    microdelay(10);
80106c7c:	c7 04 24 0a 00 00 00 	movl   $0xa,(%esp)
80106c83:	e8 ee c2 ff ff       	call   80102f76 <microdelay>
  for(i = 0; i < 128 && !(inb(COM1+5) & 0x20); i++)
80106c88:	83 45 f4 01          	addl   $0x1,-0xc(%ebp)
80106c8c:	83 7d f4 7f          	cmpl   $0x7f,-0xc(%ebp)
80106c90:	7f 16                	jg     80106ca8 <uartputc+0x46>
80106c92:	c7 04 24 fd 03 00 00 	movl   $0x3fd,(%esp)
80106c99:	e8 85 fe ff ff       	call   80106b23 <inb>
80106c9e:	0f b6 c0             	movzbl %al,%eax
80106ca1:	83 e0 20             	and    $0x20,%eax
80106ca4:	85 c0                	test   %eax,%eax
80106ca6:	74 d4                	je     80106c7c <uartputc+0x1a>
  outb(COM1+0, c);
...
80106cb9:	e8 82 fe ff ff       	call   80106b40 <outb>
}
80106cbe:	c9                   	leave  
80106cbf:	c3                   	ret    
...
80106cc3:	83 ec 04             	sub    $0x4,%esp
  if(!uart)
80106cc6:	a1 64 b6 10 80       	mov    0x8010b664,%eax
80106ccb:	85 c0                	test   %eax,%eax
80106ccd:	75 07                	jne    80106cd6 <uartgetc+0x16>
    return -1;
80106ccf:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80106cd4:	eb 2c                	jmp    80106d02 <uartgetc+0x42>
  if(!(inb(COM1+5) & 0x01))
80106cd6:	c7 04 24 fd 03 00 00 	movl   $0x3fd,(%esp)
80106cdd:	e8 41 fe ff ff       	call   80106b23 <inb>
80106ce2:	0f b6 c0             	movzbl %al,%eax
80106ce5:	83 e0 01             	and    $0x1,%eax
80106ce8:	85 c0                	test   %eax,%eax
80106cea:	75 07                	jne    80106cf3 <uartgetc+0x33>
    return -1;
80106cec:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80106cf1:	eb 0f                	jmp    80106d02 <uartgetc+0x42>
  return inb(COM1+0);
80106cf3:	c7 04 24 f8 03 00 00 	movl   $0x3f8,(%esp)
80106cfa:	e8 24 fe ff ff       	call   80106b23 <inb>
...
80106d07:	83 ec 18             	sub    $0x18,%esp
  consoleintr(uartgetc);
80106d0a:	c7 04 24 c0 6c 10 80 	movl   $0x80106cc0,(%esp)
80106d11:	e8 d3 9a ff ff       	call   801007e9 <consoleintr>
}
80106d16:	c9                   	leave  
80106d17:	c3                   	ret    
...
80106d1a:	6a 00                	push   $0x0
  jmp alltraps
80106d1c:	e9 a9 f9 ff ff       	jmp    801066ca <alltraps>
...
80106d23:	6a 01                	push   $0x1
  jmp alltraps
80106d25:	e9 a0 f9 ff ff       	jmp    801066ca <alltraps>
...
80106d2c:	6a 02                	push   $0x2
  jmp alltraps
80106d2e:	e9 97 f9 ff ff       	jmp    801066ca <alltraps>
...
80106d35:	6a 03                	push   $0x3
  jmp alltraps
80106d37:	e9 8e f9 ff ff       	jmp    801066ca <alltraps>
...
80106d3e:	6a 04                	push   $0x4
  jmp alltraps
80106d40:	e9 85 f9 ff ff       	jmp    801066ca <alltraps>
...
80106d47:	6a 05                	push   $0x5
  jmp alltraps
80106d49:	e9 7c f9 ff ff       	jmp    801066ca <alltraps>
...
80106d50:	6a 06                	push   $0x6
  jmp alltraps
80106d52:	e9 73 f9 ff ff       	jmp    801066ca <alltraps>
...
80106d59:	6a 07                	push   $0x7
  jmp alltraps
80106d5b:	e9 6a f9 ff ff       	jmp    801066ca <alltraps>
...
80106d60:	6a 08                	push   $0x8
  jmp alltraps
80106d62:	e9 63 f9 ff ff       	jmp    801066ca <alltraps>
...
80106d69:	6a 09                	push   $0x9
  jmp alltraps
80106d6b:	e9 5a f9 ff ff       	jmp    801066ca <alltraps>
...
80106d70:	6a 0a                	push   $0xa
  jmp alltraps
80106d72:	e9 53 f9 ff ff       	jmp    801066ca <alltraps>
...
80106d77:	6a 0b                	push   $0xb
  jmp alltraps
80106d79:	e9 4c f9 ff ff       	jmp    801066ca <alltraps>
...
80106d7e:	6a 0c                	push   $0xc
  jmp alltraps
80106d80:	e9 45 f9 ff ff       	jmp    801066ca <alltraps>
...
80106d85:	6a 0d                	push   $0xd
  jmp alltraps
80106d87:	e9 3e f9 ff ff       	jmp    801066ca <alltraps>
...
80106d8c:	6a 0e                	push   $0xe
  jmp alltraps
80106d8e:	e9 37 f9 ff ff       	jmp    801066ca <alltraps>
...
80106d95:	6a 0f                	push   $0xf
  jmp alltraps
80106d97:	e9 2e f9 ff ff       	jmp    801066ca <alltraps>
...
80106d9e:	6a 10                	push   $0x10
  jmp alltraps
80106da0:	e9 25 f9 ff ff       	jmp    801066ca <alltraps>
...
80106da5:	6a 11                	push   $0x11
  jmp alltraps
80106da7:	e9 1e f9 ff ff       	jmp    801066ca <alltraps>
...
80106dae:	6a 12                	push   $0x12
  jmp alltraps
80106db0:	e9 15 f9 ff ff       	jmp    801066ca <alltraps>
...
80106db7:	6a 13                	push   $0x13
  jmp alltraps
80106db9:	e9 0c f9 ff ff       	jmp    801066ca <alltraps>
...
80106dc0:	6a 14                	push   $0x14
  jmp alltraps
80106dc2:	e9 03 f9 ff ff       	jmp    801066ca <alltraps>
...
80106dc9:	6a 15                	push   $0x15
  jmp alltraps
80106dcb:	e9 fa f8 ff ff       	jmp    801066ca <alltraps>
...
80106dd2:	6a 16                	push   $0x16
  jmp alltraps
80106dd4:	e9 f1 f8 ff ff       	jmp    801066ca <alltraps>
...
80106ddb:	6a 17                	push   $0x17
  jmp alltraps
80106ddd:	e9 e8 f8 ff ff       	jmp    801066ca <alltraps>
...
80106de4:	6a 18                	push   $0x18
  jmp alltraps
80106de6:	e9 df f8 ff ff       	jmp    801066ca <alltraps>
...
80106ded:	6a 19                	push   $0x19
  jmp alltraps
80106def:	e9 d6 f8 ff ff       	jmp    801066ca <alltraps>
...
80106df6:	6a 1a                	push   $0x1a
  jmp alltraps
80106df8:	e9 cd f8 ff ff       	jmp    801066ca <alltraps>
...
80106dff:	6a 1b                	push   $0x1b
  jmp alltraps
80106e01:	e9 c4 f8 ff ff       	jmp    801066ca <alltraps>
...
80106e08:	6a 1c                	push   $0x1c
  jmp alltraps
80106e0a:	e9 bb f8 ff ff       	jmp    801066ca <alltraps>
...
80106e11:	6a 1d                	push   $0x1d
  jmp alltraps
80106e13:	e9 b2 f8 ff ff       	jmp    801066ca <alltraps>
...
80106e1a:	6a 1e                	push   $0x1e
  jmp alltraps
80106e1c:	e9 a9 f8 ff ff       	jmp    801066ca <alltraps>
...
80106e23:	6a 1f                	push   $0x1f
  jmp alltraps
80106e25:	e9 a0 f8 ff ff       	jmp    801066ca <alltraps>
...
80106e2c:	6a 20                	push   $0x20
  jmp alltraps
80106e2e:	e9 97 f8 ff ff       	jmp    801066ca <alltraps>
...
80106e35:	6a 21                	push   $0x21
  jmp alltraps
80106e37:	e9 8e f8 ff ff       	jmp    801066ca <alltraps>
...
80106e3e:	6a 22                	push   $0x22
  jmp alltraps
80106e40:	e9 85 f8 ff ff       	jmp    801066ca <alltraps>
...
80106e47:	6a 23                	push   $0x23
  jmp alltraps
80106e49:	e9 7c f8 ff ff       	jmp    801066ca <alltraps>
...
80106e50:	6a 24                	push   $0x24
  jmp alltraps
80106e52:	e9 73 f8 ff ff       	jmp    801066ca <alltraps>
...
80106e59:	6a 25                	push   $0x25
  jmp alltraps
80106e5b:	e9 6a f8 ff ff       	jmp    801066ca <alltraps>
...
80106e62:	6a 26                	push   $0x26
  jmp alltraps
80106e64:	e9 61 f8 ff ff       	jmp    801066ca <alltraps>
...
80106e6b:	6a 27                	push   $0x27
  jmp alltraps
80106e6d:	e9 58 f8 ff ff       	jmp    801066ca <alltraps>
...
80106e74:	6a 28                	push   $0x28
  jmp alltraps
80106e76:	e9 4f f8 ff ff       	jmp    801066ca <alltraps>
...
80106e7d:	6a 29                	push   $0x29
  jmp alltraps
80106e7f:	e9 46 f8 ff ff       	jmp    801066ca <alltraps>
...
80106e86:	6a 2a                	push   $0x2a
  jmp alltraps
80106e88:	e9 3d f8 ff ff       	jmp    801066ca <alltraps>
...
80106e8f:	6a 2b                	push   $0x2b
  jmp alltraps
80106e91:	e9 34 f8 ff ff       	jmp    801066ca <alltraps>
...
80106e98:	6a 2c                	push   $0x2c
  jmp alltraps
80106e9a:	e9 2b f8 ff ff       	jmp    801066ca <alltraps>
...
80106ea1:	6a 2d                	push   $0x2d
  jmp alltraps
80106ea3:	e9 22 f8 ff ff       	jmp    801066ca <alltraps>
...
80106eaa:	6a 2e                	push   $0x2e
  jmp alltraps
80106eac:	e9 19 f8 ff ff       	jmp    801066ca <alltraps>
...
80106eb3:	6a 2f                	push   $0x2f
  jmp alltraps
80106eb5:	e9 10 f8 ff ff       	jmp    801066ca <alltraps>
...
80106ebc:	6a 30                	push   $0x30
  jmp alltraps
80106ebe:	e9 07 f8 ff ff       	jmp    801066ca <alltraps>
...
80106ec5:	6a 31                	push   $0x31
  jmp alltraps
80106ec7:	e9 fe f7 ff ff       	jmp    801066ca <alltraps>
...
80106ece:	6a 32                	push   $0x32
  jmp alltraps
80106ed0:	e9 f5 f7 ff ff       	jmp    801066ca <alltraps>
...
80106ed7:	6a 33                	push   $0x33
  jmp alltraps
80106ed9:	e9 ec f7 ff ff       	jmp    801066ca <alltraps>
...
80106ee0:	6a 34                	push   $0x34
  jmp alltraps
80106ee2:	e9 e3 f7 ff ff       	jmp    801066ca <alltraps>
...
80106ee9:	6a 35                	push   $0x35
  jmp alltraps
80106eeb:	e9 da f7 ff ff       	jmp    801066ca <alltraps>
...
80106ef2:	6a 36                	push   $0x36
  jmp alltraps
80106ef4:	e9 d1 f7 ff ff       	jmp    801066ca <alltraps>
...
80106efb:	6a 37                	push   $0x37
  jmp alltraps
80106efd:	e9 c8 f7 ff ff       	jmp    801066ca <alltraps>
...
80106f04:	6a 38                	push   $0x38
  jmp alltraps
80106f06:	e9 bf f7 ff ff       	jmp    801066ca <alltraps>
...
80106f0d:	6a 39                	push   $0x39
  jmp alltraps
80106f0f:	e9 b6 f7 ff ff       	jmp    801066ca <alltraps>
...
80106f16:	6a 3a                	push   $0x3a
  jmp alltraps
80106f18:	e9 ad f7 ff ff       	jmp    801066ca <alltraps>
...
80106f1f:	6a 3b                	push   $0x3b
  jmp alltraps
80106f21:	e9 a4 f7 ff ff       	jmp    801066ca <alltraps>
...
80106f28:	6a 3c                	push   $0x3c
  jmp alltraps
80106f2a:	e9 9b f7 ff ff       	jmp    801066ca <alltraps>
...
80106f31:	6a 3d                	push   $0x3d
  jmp alltraps
80106f33:	e9 92 f7 ff ff       	jmp    801066ca <alltraps>
...
80106f3a:	6a 3e                	push   $0x3e
  jmp alltraps
80106f3c:	e9 89 f7 ff ff       	jmp    801066ca <alltraps>
...
80106f43:	6a 3f                	push   $0x3f
  jmp alltraps
80106f45:	e9 80 f7 ff ff       	jmp    801066ca <alltraps>
...
80106f4c:	6a 40                	push   $0x40
  jmp alltraps
80106f4e:	e9 77 f7 ff ff       	jmp    801066ca <alltraps>
...
80106f55:	6a 41                	push   $0x41
  jmp alltraps
80106f57:	e9 6e f7 ff ff       	jmp    801066ca <alltraps>
...
80106f5e:	6a 42                	push   $0x42
  jmp alltraps
80106f60:	e9 65 f7 ff ff       	jmp    801066ca <alltraps>
...
80106f67:	6a 43                	push   $0x43
  jmp alltraps
80106f69:	e9 5c f7 ff ff       	jmp    801066ca <alltraps>
...
80106f70:	6a 44                	push   $0x44
  jmp alltraps
80106f72:	e9 53 f7 ff ff       	jmp    801066ca <alltraps>
...
80106f79:	6a 45                	push   $0x45
  jmp alltraps
80106f7b:	e9 4a f7 ff ff       	jmp    801066ca <alltraps>
...
80106f82:	6a 46                	push   $0x46
  jmp alltraps
80106f84:	e9 41 f7 ff ff       	jmp    801066ca <alltraps>
...
80106f8b:	6a 47                	push   $0x47
  jmp alltraps
80106f8d:	e9 38 f7 ff ff       	jmp    801066ca <alltraps>
...
80106f94:	6a 48                	push   $0x48
  jmp alltraps
80106f96:	e9 2f f7 ff ff       	jmp    801066ca <alltraps>
...
80106f9d:	6a 49                	push   $0x49
  jmp alltraps
80106f9f:	e9 26 f7 ff ff       	jmp    801066ca <alltraps>
...
80106fa6:	6a 4a                	push   $0x4a
  jmp alltraps
80106fa8:	e9 1d f7 ff ff       	jmp    801066ca <alltraps>
...
80106faf:	6a 4b                	push   $0x4b
  jmp alltraps
80106fb1:	e9 14 f7 ff ff       	jmp    801066ca <alltraps>
...
80106fb8:	6a 4c                	push   $0x4c
  jmp alltraps
80106fba:	e9 0b f7 ff ff       	jmp    801066ca <alltraps>
...
80106fc1:	6a 4d                	push   $0x4d
  jmp alltraps
80106fc3:	e9 02 f7 ff ff       	jmp    801066ca <alltraps>
...
80106fca:	6a 4e                	push   $0x4e
  jmp alltraps
80106fcc:	e9 f9 f6 ff ff       	jmp    801066ca <alltraps>
...
80106fd3:	6a 4f                	push   $0x4f
  jmp alltraps
80106fd5:	e9 f0 f6 ff ff       	jmp    801066ca <alltraps>
...
80106fdc:	6a 50                	push   $0x50
  jmp alltraps
80106fde:	e9 e7 f6 ff ff       	jmp    801066ca <alltraps>
...
80106fe5:	6a 51                	push   $0x51
  jmp alltraps
80106fe7:	e9 de f6 ff ff       	jmp    801066ca <alltraps>
...
80106fee:	6a 52                	push   $0x52
  jmp alltraps
80106ff0:	e9 d5 f6 ff ff       	jmp    801066ca <alltraps>
...
80106ff7:	6a 53                	push   $0x53
  jmp alltraps
80106ff9:	e9 cc f6 ff ff       	jmp    801066ca <alltraps>
...
80107000:	6a 54                	push   $0x54
  jmp alltraps
80107002:	e9 c3 f6 ff ff       	jmp    801066ca <alltraps>
...
80107009:	6a 55                	push   $0x55
  jmp alltraps
8010700b:	e9 ba f6 ff ff       	jmp    801066ca <alltraps>
...
80107012:	6a 56                	push   $0x56
  jmp alltraps
80107014:	e9 b1 f6 ff ff       	jmp    801066ca <alltraps>
...
8010701b:	6a 57                	push   $0x57
  jmp alltraps
8010701d:	e9 a8 f6 ff ff       	jmp    801066ca <alltraps>
...
80107024:	6a 58                	push   $0x58
  jmp alltraps
80107026:	e9 9f f6 ff ff       	jmp    801066ca <alltraps>
...
8010702d:	6a 59                	push   $0x59
  jmp alltraps
8010702f:	e9 96 f6 ff ff       	jmp    801066ca <alltraps>
...
80107036:	6a 5a                	push   $0x5a
  jmp alltraps
80107038:	e9 8d f6 ff ff       	jmp    801066ca <alltraps>
...
8010703f:	6a 5b                	push   $0x5b
  jmp alltraps
80107041:	e9 84 f6 ff ff       	jmp    801066ca <alltraps>
...
80107048:	6a 5c                	push   $0x5c
  jmp alltraps
8010704a:	e9 7b f6 ff ff       	jmp    801066ca <alltraps>
...
80107051:	6a 5d                	push   $0x5d
  jmp alltraps
80107053:	e9 72 f6 ff ff       	jmp    801066ca <alltraps>
...
8010705a:	6a 5e                	push   $0x5e
  jmp alltraps
8010705c:	e9 69 f6 ff ff       	jmp    801066ca <alltraps>
...
80107063:	6a 5f                	push   $0x5f
  jmp alltraps
80107065:	e9 60 f6 ff ff       	jmp    801066ca <alltraps>
...
8010706c:	6a 60                	push   $0x60
  jmp alltraps
8010706e:	e9 57 f6 ff ff       	jmp    801066ca <alltraps>
...
80107075:	6a 61                	push   $0x61
  jmp alltraps
80107077:	e9 4e f6 ff ff       	jmp    801066ca <alltraps>
...
8010707e:	6a 62                	push   $0x62
  jmp alltraps
80107080:	e9 45 f6 ff ff       	jmp    801066ca <alltraps>
...
80107087:	6a 63                	push   $0x63
  jmp alltraps
80107089:	e9 3c f6 ff ff       	jmp    801066ca <alltraps>
...
80107090:	6a 64                	push   $0x64
  jmp alltraps
80107092:	e9 33 f6 ff ff       	jmp    801066ca <alltraps>
...
80107099:	6a 65                	push   $0x65
  jmp alltraps
8010709b:	e9 2a f6 ff ff       	jmp    801066ca <alltraps>
...
801070a2:	6a 66                	push   $0x66
  jmp alltraps
801070a4:	e9 21 f6 ff ff       	jmp    801066ca <alltraps>
...
801070ab:	6a 67                	push   $0x67
  jmp alltraps
801070ad:	e9 18 f6 ff ff       	jmp    801066ca <alltraps>
...
801070b4:	6a 68                	push   $0x68
  jmp alltraps
801070b6:	e9 0f f6 ff ff       	jmp    801066ca <alltraps>
...
801070bd:	6a 69                	push   $0x69
  jmp alltraps
801070bf:	e9 06 f6 ff ff       	jmp    801066ca <alltraps>
...
801070c6:	6a 6a                	push   $0x6a
  jmp alltraps
801070c8:	e9 fd f5 ff ff       	jmp    801066ca <alltraps>
...
801070cf:	6a 6b                	push   $0x6b
  jmp alltraps
801070d1:	e9 f4 f5 ff ff       	jmp    801066ca <alltraps>
...
801070d8:	6a 6c                	push   $0x6c
  jmp alltraps
801070da:	e9 eb f5 ff ff       	jmp    801066ca <alltraps>
...
801070e1:	6a 6d                	push   $0x6d
  jmp alltraps
801070e3:	e9 e2 f5 ff ff       	jmp    801066ca <alltraps>
...
801070ea:	6a 6e                	push   $0x6e
  jmp alltraps
801070ec:	e9 d9 f5 ff ff       	jmp    801066ca <alltraps>
...
801070f3:	6a 6f                	push   $0x6f
  jmp alltraps
801070f5:	e9 d0 f5 ff ff       	jmp    801066ca <alltraps>
...
801070fc:	6a 70                	push   $0x70
  jmp alltraps
801070fe:	e9 c7 f5 ff ff       	jmp    801066ca <alltraps>
...
80107105:	6a 71                	push   $0x71
  jmp alltraps
80107107:	e9 be f5 ff ff       	jmp    801066ca <alltraps>
...
8010710e:	6a 72                	push   $0x72
  jmp alltraps
80107110:	e9 b5 f5 ff ff       	jmp    801066ca <alltraps>
...
80107117:	6a 73                	push   $0x73
  jmp alltraps
80107119:	e9 ac f5 ff ff       	jmp    801066ca <alltraps>
...
80107120:	6a 74                	push   $0x74
  jmp alltraps
80107122:	e9 a3 f5 ff ff       	jmp    801066ca <alltraps>
...
80107129:	6a 75                	push   $0x75
  jmp alltraps
8010712b:	e9 9a f5 ff ff       	jmp    801066ca <alltraps>
...
80107132:	6a 76                	push   $0x76
  jmp alltraps
80107134:	e9 91 f5 ff ff       	jmp    801066ca <alltraps>
...
8010713b:	6a 77                	push   $0x77
  jmp alltraps
8010713d:	e9 88 f5 ff ff       	jmp    801066ca <alltraps>
...
80107144:	6a 78                	push   $0x78
  jmp alltraps
80107146:	e9 7f f5 ff ff       	jmp    801066ca <alltraps>
...
8010714d:	6a 79                	push   $0x79
  jmp alltraps
8010714f:	e9 76 f5 ff ff       	jmp    801066ca <alltraps>
...
80107156:	6a 7a                	push   $0x7a
  jmp alltraps
80107158:	e9 6d f5 ff ff       	jmp    801066ca <alltraps>
...
8010715f:	6a 7b                	push   $0x7b
  jmp alltraps
80107161:	e9 64 f5 ff ff       	jmp    801066ca <alltraps>
...
80107168:	6a 7c                	push   $0x7c
  jmp alltraps
8010716a:	e9 5b f5 ff ff       	jmp    801066ca <alltraps>
...
80107171:	6a 7d                	push   $0x7d
  jmp alltraps
80107173:	e9 52 f5 ff ff       	jmp    801066ca <alltraps>
...
8010717a:	6a 7e                	push   $0x7e
  jmp alltraps
8010717c:	e9 49 f5 ff ff       	jmp    801066ca <alltraps>
...
80107183:	6a 7f                	push   $0x7f
  jmp alltraps
80107185:	e9 40 f5 ff ff       	jmp    801066ca <alltraps>
...
8010718c:	68 80 00 00 00       	push   $0x80
  jmp alltraps
80107191:	e9 34 f5 ff ff       	jmp    801066ca <alltraps>
...
80107198:	68 81 00 00 00       	push   $0x81
  jmp alltraps
8010719d:	e9 28 f5 ff ff       	jmp    801066ca <alltraps>
...
801071a4:	68 82 00 00 00       	push   $0x82
  jmp alltraps
801071a9:	e9 1c f5 ff ff       	jmp    801066ca <alltraps>
...
801071b0:	68 83 00 00 00       	push   $0x83
  jmp alltraps
801071b5:	e9 10 f5 ff ff       	jmp    801066ca <alltraps>
...
801071bc:	68 84 00 00 00       	push   $0x84
  jmp alltraps
801071c1:	e9 04 f5 ff ff       	jmp    801066ca <alltraps>
...
801071c8:	68 85 00 00 00       	push   $0x85
  jmp alltraps
801071cd:	e9 f8 f4 ff ff       	jmp    801066ca <alltraps>
...
801071d4:	68 86 00 00 00       	push   $0x86
  jmp alltraps
801071d9:	e9 ec f4 ff ff       	jmp    801066ca <alltraps>
...
801071e0:	68 87 00 00 00       	push   $0x87
  jmp alltraps
801071e5:	e9 e0 f4 ff ff       	jmp    801066ca <alltraps>
...
801071ec:	68 88 00 00 00       	push   $0x88
  jmp alltraps
801071f1:	e9 d4 f4 ff ff       	jmp    801066ca <alltraps>
...
801071f8:	68 89 00 00 00       	push   $0x89
  jmp alltraps
801071fd:	e9 c8 f4 ff ff       	jmp    801066ca <alltraps>
...
80107204:	68 8a 00 00 00       	push   $0x8a
  jmp alltraps
80107209:	e9 bc f4 ff ff       	jmp    801066ca <alltraps>
...
80107210:	68 8b 00 00 00       	push   $0x8b
  jmp alltraps
80107215:	e9 b0 f4 ff ff       	jmp    801066ca <alltraps>
...
8010721c:	68 8c 00 00 00       	push   $0x8c
  jmp alltraps
80107221:	e9 a4 f4 ff ff       	jmp    801066ca <alltraps>
...
80107228:	68 8d 00 00 00       	push   $0x8d
  jmp alltraps
8010722d:	e9 98 f4 ff ff       	jmp    801066ca <alltraps>
...
80107234:	68 8e 00 00 00       	push   $0x8e
  jmp alltraps
80107239:	e9 8c f4 ff ff       	jmp    801066ca <alltraps>
...
80107240:	68 8f 00 00 00       	push   $0x8f
  jmp alltraps
80107245:	e9 80 f4 ff ff       	jmp    801066ca <alltraps>
...
8010724c:	68 90 00 00 00       	push   $0x90
  jmp alltraps
80107251:	e9 74 f4 ff ff       	jmp    801066ca <alltraps>
...
80107258:	68 91 00 00 00       	push   $0x91
  jmp alltraps
8010725d:	e9 68 f4 ff ff       	jmp    801066ca <alltraps>
...
80107264:	68 92 00 00 00       	push   $0x92
  jmp alltraps
80107269:	e9 5c f4 ff ff       	jmp    801066ca <alltraps>
...
80107270:	68 93 00 00 00       	push   $0x93
  jmp alltraps
80107275:	e9 50 f4 ff ff       	jmp    801066ca <alltraps>
...
8010727c:	68 94 00 00 00       	push   $0x94
  jmp alltraps
80107281:	e9 44 f4 ff ff       	jmp    801066ca <alltraps>
...
80107288:	68 95 00 00 00       	push   $0x95
  jmp alltraps
8010728d:	e9 38 f4 ff ff       	jmp    801066ca <alltraps>
...
80107294:	68 96 00 00 00       	push   $0x96
  jmp alltraps
80107299:	e9 2c f4 ff ff       	jmp    801066ca <alltraps>
...
801072a0:	68 97 00 00 00       	push   $0x97
  jmp alltraps
801072a5:	e9 20 f4 ff ff       	jmp    801066ca <alltraps>
...
801072ac:	68 98 00 00 00       	push   $0x98
  jmp alltraps
801072b1:	e9 14 f4 ff ff       	jmp    801066ca <alltraps>
...
801072b8:	68 99 00 00 00       	push   $0x99
  jmp alltraps
801072bd:	e9 08 f4 ff ff       	jmp    801066ca <alltraps>
...
801072c4:	68 9a 00 00 00       	push   $0x9a
  jmp alltraps
801072c9:	e9 fc f3 ff ff       	jmp    801066ca <alltraps>
...
801072d0:	68 9b 00 00 00       	push   $0x9b
  jmp alltraps
801072d5:	e9 f0 f3 ff ff       	jmp    801066ca <alltraps>
...
801072dc:	68 9c 00 00 00       	push   $0x9c
  jmp alltraps
801072e1:	e9 e4 f3 ff ff       	jmp    801066ca <alltraps>
...
801072e8:	68 9d 00 00 00       	push   $0x9d
  jmp alltraps
801072ed:	e9 d8 f3 ff ff       	jmp    801066ca <alltraps>
...
801072f4:	68 9e 00 00 00       	push   $0x9e
  jmp alltraps
801072f9:	e9 cc f3 ff ff       	jmp    801066ca <alltraps>
...
80107300:	68 9f 00 00 00       	push   $0x9f
  jmp alltraps
80107305:	e9 c0 f3 ff ff       	jmp    801066ca <alltraps>
...
8010730c:	68 a0 00 00 00       	push   $0xa0
  jmp alltraps
80107311:	e9 b4 f3 ff ff       	jmp    801066ca <alltraps>
...
80107318:	68 a1 00 00 00       	push   $0xa1
  jmp alltraps
8010731d:	e9 a8 f3 ff ff       	jmp    801066ca <alltraps>
...
80107324:	68 a2 00 00 00       	push   $0xa2
  jmp alltraps
80107329:	e9 9c f3 ff ff       	jmp    801066ca <alltraps>
...
80107330:	68 a3 00 00 00       	push   $0xa3
  jmp alltraps
80107335:	e9 90 f3 ff ff       	jmp    801066ca <alltraps>
...
8010733c:	68 a4 00 00 00       	push   $0xa4
  jmp alltraps
80107341:	e9 84 f3 ff ff       	jmp    801066ca <alltraps>
...
80107348:	68 a5 00 00 00       	push   $0xa5
  jmp alltraps
8010734d:	e9 78 f3 ff ff       	jmp    801066ca <alltraps>
...
80107354:	68 a6 00 00 00       	push   $0xa6
  jmp alltraps
80107359:	e9 6c f3 ff ff       	jmp    801066ca <alltraps>
...
80107360:	68 a7 00 00 00       	push   $0xa7
  jmp alltraps
80107365:	e9 60 f3 ff ff       	jmp    801066ca <alltraps>
...
8010736c:	68 a8 00 00 00       	push   $0xa8
  jmp alltraps
80107371:	e9 54 f3 ff ff       	jmp    801066ca <alltraps>
...
80107378:	68 a9 00 00 00       	push   $0xa9
  jmp alltraps
8010737d:	e9 48 f3 ff ff       	jmp    801066ca <alltraps>
...
80107384:	68 aa 00 00 00       	push   $0xaa
  jmp alltraps
80107389:	e9 3c f3 ff ff       	jmp    801066ca <alltraps>
...
80107390:	68 ab 00 00 00       	push   $0xab
  jmp alltraps
80107395:	e9 30 f3 ff ff       	jmp    801066ca <alltraps>
...
8010739c:	68 ac 00 00 00       	push   $0xac
  jmp alltraps
801073a1:	e9 24 f3 ff ff       	jmp    801066ca <alltraps>
...
801073a8:	68 ad 00 00 00       	push   $0xad
  jmp alltraps
801073ad:	e9 18 f3 ff ff       	jmp    801066ca <alltraps>
...
801073b4:	68 ae 00 00 00       	push   $0xae
  jmp alltraps
801073b9:	e9 0c f3 ff ff       	jmp    801066ca <alltraps>
...
801073c0:	68 af 00 00 00       	push   $0xaf
  jmp alltraps
801073c5:	e9 00 f3 ff ff       	jmp    801066ca <alltraps>
...
801073cc:	68 b0 00 00 00       	push   $0xb0
  jmp alltraps
801073d1:	e9 f4 f2 ff ff       	jmp    801066ca <alltraps>
...
801073d8:	68 b1 00 00 00       	push   $0xb1
  jmp alltraps
801073dd:	e9 e8 f2 ff ff       	jmp    801066ca <alltraps>
...
801073e4:	68 b2 00 00 00       	push   $0xb2
  jmp alltraps
801073e9:	e9 dc f2 ff ff       	jmp    801066ca <alltraps>
...
801073f0:	68 b3 00 00 00       	push   $0xb3
  jmp alltraps
801073f5:	e9 d0 f2 ff ff       	jmp    801066ca <alltraps>
...
801073fc:	68 b4 00 00 00       	push   $0xb4
  jmp alltraps
80107401:	e9 c4 f2 ff ff       	jmp    801066ca <alltraps>
...
80107408:	68 b5 00 00 00       	push   $0xb5
  jmp alltraps
8010740d:	e9 b8 f2 ff ff       	jmp    801066ca <alltraps>
...
80107414:	68 b6 00 00 00       	push   $0xb6
  jmp alltraps
80107419:	e9 ac f2 ff ff       	jmp    801066ca <alltraps>
...
80107420:	68 b7 00 00 00       	push   $0xb7
  jmp alltraps
80107425:	e9 a0 f2 ff ff       	jmp    801066ca <alltraps>
...
8010742c:	68 b8 00 00 00       	push   $0xb8
  jmp alltraps
80107431:	e9 94 f2 ff ff       	jmp    801066ca <alltraps>
...
80107438:	68 b9 00 00 00       	push   $0xb9
  jmp alltraps
8010743d:	e9 88 f2 ff ff       	jmp    801066ca <alltraps>
...
80107444:	68 ba 00 00 00       	push   $0xba
  jmp alltraps
80107449:	e9 7c f2 ff ff       	jmp    801066ca <alltraps>
...
80107450:	68 bb 00 00 00       	push   $0xbb
  jmp alltraps
80107455:	e9 70 f2 ff ff       	jmp    801066ca <alltraps>
...
8010745c:	68 bc 00 00 00       	push   $0xbc
  jmp alltraps
80107461:	e9 64 f2 ff ff       	jmp    801066ca <alltraps>
...
80107468:	68 bd 00 00 00       	push   $0xbd
  jmp alltraps
8010746d:	e9 58 f2 ff ff       	jmp    801066ca <alltraps>
...
80107474:	68 be 00 00 00       	push   $0xbe
  jmp alltraps
80107479:	e9 4c f2 ff ff       	jmp    801066ca <alltraps>
...
80107480:	68 bf 00 00 00       	push   $0xbf
  jmp alltraps
80107485:	e9 40 f2 ff ff       	jmp    801066ca <alltraps>
...
8010748c:	68 c0 00 00 00       	push   $0xc0
  jmp alltraps
80107491:	e9 34 f2 ff ff       	jmp    801066ca <alltraps>
...
80107498:	68 c1 00 00 00       	push   $0xc1
  jmp alltraps
8010749d:	e9 28 f2 ff ff       	jmp    801066ca <alltraps>
...
801074a4:	68 c2 00 00 00       	push   $0xc2
  jmp alltraps
801074a9:	e9 1c f2 ff ff       	jmp    801066ca <alltraps>
...
801074b0:	68 c3 00 00 00       	push   $0xc3
  jmp alltraps
801074b5:	e9 10 f2 ff ff       	jmp    801066ca <alltraps>
...
801074bc:	68 c4 00 00 00       	push   $0xc4
  jmp alltraps
801074c1:	e9 04 f2 ff ff       	jmp    801066ca <alltraps>
...
801074c8:	68 c5 00 00 00       	push   $0xc5
  jmp alltraps
801074cd:	e9 f8 f1 ff ff       	jmp    801066ca <alltraps>
...
801074d4:	68 c6 00 00 00       	push   $0xc6
  jmp alltraps
801074d9:	e9 ec f1 ff ff       	jmp    801066ca <alltraps>
...
801074e0:	68 c7 00 00 00       	push   $0xc7
  jmp alltraps
801074e5:	e9 e0 f1 ff ff       	jmp    801066ca <alltraps>
...
801074ec:	68 c8 00 00 00       	push   $0xc8
  jmp alltraps
801074f1:	e9 d4 f1 ff ff       	jmp    801066ca <alltraps>
...
801074f8:	68 c9 00 00 00       	push   $0xc9
  jmp alltraps
801074fd:	e9 c8 f1 ff ff       	jmp    801066ca <alltraps>
...
80107504:	68 ca 00 00 00       	push   $0xca
  jmp alltraps
80107509:	e9 bc f1 ff ff       	jmp    801066ca <alltraps>
...
80107510:	68 cb 00 00 00       	push   $0xcb
  jmp alltraps
80107515:	e9 b0 f1 ff ff       	jmp    801066ca <alltraps>
...
8010751c:	68 cc 00 00 00       	push   $0xcc
  jmp alltraps
80107521:	e9 a4 f1 ff ff       	jmp    801066ca <alltraps>
...
80107528:	68 cd 00 00 00       	push   $0xcd
  jmp alltraps
8010752d:	e9 98 f1 ff ff       	jmp    801066ca <alltraps>
...
80107534:	68 ce 00 00 00       	push   $0xce
  jmp alltraps
80107539:	e9 8c f1 ff ff       	jmp    801066ca <alltraps>
...
80107540:	68 cf 00 00 00       	push   $0xcf
  jmp alltraps
80107545:	e9 80 f1 ff ff       	jmp    801066ca <alltraps>
...
8010754c:	68 d0 00 00 00       	push   $0xd0
  jmp alltraps
80107551:	e9 74 f1 ff ff       	jmp    801066ca <alltraps>
...
80107558:	68 d1 00 00 00       	push   $0xd1
  jmp alltraps
8010755d:	e9 68 f1 ff ff       	jmp    801066ca <alltraps>
...
80107564:	68 d2 00 00 00       	push   $0xd2
  jmp alltraps
80107569:	e9 5c f1 ff ff       	jmp    801066ca <alltraps>
...
80107570:	68 d3 00 00 00       	push   $0xd3
  jmp alltraps
80107575:	e9 50 f1 ff ff       	jmp    801066ca <alltraps>
...
8010757c:	68 d4 00 00 00       	push   $0xd4
  jmp alltraps
80107581:	e9 44 f1 ff ff       	jmp    801066ca <alltraps>
...
80107588:	68 d5 00 00 00       	push   $0xd5
  jmp alltraps
8010758d:	e9 38 f1 ff ff       	jmp    801066ca <alltraps>
...
80107594:	68 d6 00 00 00       	push   $0xd6
  jmp alltraps
80107599:	e9 2c f1 ff ff       	jmp    801066ca <alltraps>
...
801075a0:	68 d7 00 00 00       	push   $0xd7
  jmp alltraps
801075a5:	e9 20 f1 ff ff       	jmp    801066ca <alltraps>
...
801075ac:	68 d8 00 00 00       	push   $0xd8
  jmp alltraps
801075b1:	e9 14 f1 ff ff       	jmp    801066ca <alltraps>
...
801075b8:	68 d9 00 00 00       	push   $0xd9
  jmp alltraps
801075bd:	e9 08 f1 ff ff       	jmp    801066ca <alltraps>
...
801075c4:	68 da 00 00 00       	push   $0xda
  jmp alltraps
801075c9:	e9 fc f0 ff ff       	jmp    801066ca <alltraps>
...
801075d0:	68 db 00 00 00       	push   $0xdb
  jmp alltraps
801075d5:	e9 f0 f0 ff ff       	jmp    801066ca <alltraps>
...
801075dc:	68 dc 00 00 00       	push   $0xdc
  jmp alltraps
801075e1:	e9 e4 f0 ff ff       	jmp    801066ca <alltraps>
...
801075e8:	68 dd 00 00 00       	push   $0xdd
  jmp alltraps
801075ed:	e9 d8 f0 ff ff       	jmp    801066ca <alltraps>
...
801075f4:	68 de 00 00 00       	push   $0xde
  jmp alltraps
801075f9:	e9 cc f0 ff ff       	jmp    801066ca <alltraps>
...
80107600:	68 df 00 00 00       	push   $0xdf
  jmp alltraps
80107605:	e9 c0 f0 ff ff       	jmp    801066ca <alltraps>
...
8010760c:	68 e0 00 00 00       	push   $0xe0
  jmp alltraps
80107611:	e9 b4 f0 ff ff       	jmp    801066ca <alltraps>
...
80107618:	68 e1 00 00 00       	push   $0xe1
  jmp alltraps
8010761d:	e9 a8 f0 ff ff       	jmp    801066ca <alltraps>
...
80107624:	68 e2 00 00 00       	push   $0xe2
  jmp alltraps
80107629:	e9 9c f0 ff ff       	jmp    801066ca <alltraps>
...
80107630:	68 e3 00 00 00       	push   $0xe3
  jmp alltraps
80107635:	e9 90 f0 ff ff       	jmp    801066ca <alltraps>
...
8010763c:	68 e4 00 00 00       	push   $0xe4
  jmp alltraps
80107641:	e9 84 f0 ff ff       	jmp    801066ca <alltraps>
...
80107648:	68 e5 00 00 00       	push   $0xe5
  jmp alltraps
8010764d:	e9 78 f0 ff ff       	jmp    801066ca <alltraps>
...
80107654:	68 e6 00 00 00       	push   $0xe6
  jmp alltraps
80107659:	e9 6c f0 ff ff       	jmp    801066ca <alltraps>
...
80107660:	68 e7 00 00 00       	push   $0xe7
  jmp alltraps
80107665:	e9 60 f0 ff ff       	jmp    801066ca <alltraps>
...
8010766c:	68 e8 00 00 00       	push   $0xe8
  jmp alltraps
80107671:	e9 54 f0 ff ff       	jmp    801066ca <alltraps>
...
80107678:	68 e9 00 00 00       	push   $0xe9
  jmp alltraps
8010767d:	e9 48 f0 ff ff       	jmp    801066ca <alltraps>
...
80107684:	68 ea 00 00 00       	push   $0xea
  jmp alltraps
80107689:	e9 3c f0 ff ff       	jmp    801066ca <alltraps>
...
80107690:	68 eb 00 00 00       	push   $0xeb
  jmp alltraps
80107695:	e9 30 f0 ff ff       	jmp    801066ca <alltraps>
...
8010769c:	68 ec 00 00 00       	push   $0xec
  jmp alltraps
801076a1:	e9 24 f0 ff ff       	jmp    801066ca <alltraps>
...
801076a8:	68 ed 00 00 00       	push   $0xed
  jmp alltraps
801076ad:	e9 18 f0 ff ff       	jmp    801066ca <alltraps>
...
801076b4:	68 ee 00 00 00       	push   $0xee
  jmp alltraps
801076b9:	e9 0c f0 ff ff       	jmp    801066ca <alltraps>
...
801076c0:	68 ef 00 00 00       	push   $0xef
  jmp alltraps
801076c5:	e9 00 f0 ff ff       	jmp    801066ca <alltraps>
...
801076cc:	68 f0 00 00 00       	push   $0xf0
  jmp alltraps
801076d1:	e9 f4 ef ff ff       	jmp    801066ca <alltraps>
...
801076d8:	68 f1 00 00 00       	push   $0xf1
  jmp alltraps
801076dd:	e9 e8 ef ff ff       	jmp    801066ca <alltraps>
...
801076e4:	68 f2 00 00 00       	push   $0xf2
  jmp alltraps
801076e9:	e9 dc ef ff ff       	jmp    801066ca <alltraps>
...
801076f0:	68 f3 00 00 00       	push   $0xf3
  jmp alltraps
801076f5:	e9 d0 ef ff ff       	jmp    801066ca <alltraps>
...
801076fc:	68 f4 00 00 00       	push   $0xf4
  jmp alltraps
80107701:	e9 c4 ef ff ff       	jmp    801066ca <alltraps>
...
80107708:	68 f5 00 00 00       	push   $0xf5
  jmp alltraps
8010770d:	e9 b8 ef ff ff       	jmp    801066ca <alltraps>
...
80107714:	68 f6 00 00 00       	push   $0xf6
  jmp alltraps
80107719:	e9 ac ef ff ff       	jmp    801066ca <alltraps>
...
80107720:	68 f7 00 00 00       	push   $0xf7
  jmp alltraps
80107725:	e9 a0 ef ff ff       	jmp    801066ca <alltraps>
...
8010772c:	68 f8 00 00 00       	push   $0xf8
  jmp alltraps
80107731:	e9 94 ef ff ff       	jmp    801066ca <alltraps>
...
80107738:	68 f9 00 00 00       	push   $0xf9
  jmp alltraps
8010773d:	e9 88 ef ff ff       	jmp    801066ca <alltraps>
...
80107744:	68 fa 00 00 00       	push   $0xfa
  jmp alltraps
80107749:	e9 7c ef ff ff       	jmp    801066ca <alltraps>
...
80107750:	68 fb 00 00 00       	push   $0xfb
  jmp alltraps
80107755:	e9 70 ef ff ff       	jmp    801066ca <alltraps>
...
8010775c:	68 fc 00 00 00       	push   $0xfc
  jmp alltraps
80107761:	e9 64 ef ff ff       	jmp    801066ca <alltraps>
...
80107768:	68 fd 00 00 00       	push   $0xfd
  jmp alltraps
8010776d:	e9 58 ef ff ff       	jmp    801066ca <alltraps>
...
80107774:	68 fe 00 00 00       	push   $0xfe
  jmp alltraps
80107779:	e9 4c ef ff ff       	jmp    801066ca <alltraps>
...
80107780:	68 ff 00 00 00       	push   $0xff
  jmp alltraps
80107785:	e9 40 ef ff ff       	jmp    801066ca <alltraps>

8010778a <lgdt>:
{
8010778a:	55                   	push   %ebp
8010778b:	89 e5                	mov    %esp,%ebp
8010778d:	83 ec 10             	sub    $0x10,%esp
  pd[0] = size-1;
80107790:	8b 45 0c             	mov    0xc(%ebp),%eax
80107793:	83 e8 01             	sub    $0x1,%eax
80107796:	66 89 45 fa          	mov    %ax,-0x6(%ebp)
  pd[1] = (uint)p;
8010779a:	8b 45 08             	mov    0x8(%ebp),%eax
8010779d:	66 89 45 fc          	mov    %ax,-0x4(%ebp)
  pd[2] = (uint)p >> 16;
801077a1:	8b 45 08             	mov    0x8(%ebp),%eax
801077a4:	c1 e8 10             	shr    $0x10,%eax
801077a7:	66 89 45 fe          	mov    %ax,-0x2(%ebp)
  asm volatile("lgdt (%0)" : : "r" (pd));
801077ab:	8d 45 fa             	lea    -0x6(%ebp),%eax
801077ae:	0f 01 10             	lgdtl  (%eax)
}
801077b1:	c9                   	leave  
801077b2:	c3                   	ret    
...
801077bc:	66 89 45 fc          	mov    %ax,-0x4(%ebp)
  asm volatile("ltr %0" : : "r" (sel));
801077c0:	0f b7 45 fc          	movzwl -0x4(%ebp),%eax
801077c4:	0f 00 d8             	ltr    %ax
}
801077c7:	c9                   	leave  
801077c8:	c3                   	ret    
...
801077d7:	83 ec 28             	sub    $0x28,%esp
  ...
  c = &cpus[cpuid()];
801077da:	e8 eb c8 ff ff       	call   801040ca <cpuid>
801077df:	69 c0 b0 00 00 00    	imul   $0xb0,%eax,%eax
801077e5:	05 40 38 11 80       	add    $0x80113840,%eax
801077ea:	89 45 f4             	mov    %eax,-0xc(%ebp)
  c->gdt[SEG_KCODE] = SEG(STA_X|STA_R, 0, 0xffffffff, 0);
801077ed:	8b 45 f4             	mov    -0xc(%ebp),%eax
801077f0:	66 c7 40 78 ff ff    	movw   $0xffff,0x78(%eax)
801077f6:	8b 45 f4             	mov    -0xc(%ebp),%eax
801077f9:	66 c7 40 7a 00 00    	movw   $0x0,0x7a(%eax)
801077ff:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107802:	c6 40 7c 00          	movb   $0x0,0x7c(%eax)
80107806:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107809:	0f b6 50 7d          	movzbl 0x7d(%eax),%edx
8010780d:	83 e2 f0             	and    $0xfffffff0,%edx
80107810:	83 ca 0a             	or     $0xa,%edx
80107813:	88 50 7d             	mov    %dl,0x7d(%eax)
80107816:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107819:	0f b6 50 7d          	movzbl 0x7d(%eax),%edx
8010781d:	83 ca 10             	or     $0x10,%edx
80107820:	88 50 7d             	mov    %dl,0x7d(%eax)
80107823:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107826:	0f b6 50 7d          	movzbl 0x7d(%eax),%edx
...
80107837:	83 ca 80             	or     $0xffffff80,%edx
...
80107881:	c6 40 7f 00          	movb   $0x0,0x7f(%eax)
  c->gdt[SEG_KDATA] = SEG(STA_W, 0, 0xffffffff, 0);
80107885:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107888:	66 c7 80 80 00 00 00 	movw   $0xffff,0x80(%eax)
8010788f:	ff ff 
80107891:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107894:	66 c7 80 82 00 00 00 	movw   $0x0,0x82(%eax)
8010789b:	00 00 
8010789d:	8b 45 f4             	mov    -0xc(%ebp),%eax
801078a0:	c6 80 84 00 00 00 00 	movb   $0x0,0x84(%eax)
801078a7:	8b 45 f4             	mov    -0xc(%ebp),%eax
801078aa:	0f b6 90 85 00 00 00 	movzbl 0x85(%eax),%edx
801078b1:	83 e2 f0             	and    $0xfffffff0,%edx
801078b4:	83 ca 02             	or     $0x2,%edx
...
801078da:	83 e2 9f             	and    $0xffffff9f,%edx
...
80107913:	83 e2 ef             	and    $0xffffffef,%edx
...
80107926:	83 e2 df             	and    $0xffffffdf,%edx
...
80107958:	c6 80 87 00 00 00 00 	movb   $0x0,0x87(%eax)
  c->gdt[SEG_UCODE] = SEG(STA_X|STA_R, 0, 0xffffffff, DPL_USER);
8010795f:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107962:	66 c7 80 88 00 00 00 	movw   $0xffff,0x88(%eax)
80107969:	ff ff 
8010796b:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010796e:	66 c7 80 8a 00 00 00 	movw   $0x0,0x8a(%eax)
80107975:	00 00 
80107977:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010797a:	c6 80 8c 00 00 00 00 	movb   $0x0,0x8c(%eax)
80107981:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107984:	0f b6 90 8d 00 00 00 	movzbl 0x8d(%eax),%edx
8010798b:	83 e2 f0             	and    $0xfffffff0,%edx
8010798e:	83 ca 0a             	or     $0xa,%edx
...
801079b4:	83 ca 60             	or     $0x60,%edx
801079b7:	88 90 8d 00 00 00    	mov    %dl,0x8d(%eax)
801079bd:	8b 45 f4             	mov    -0xc(%ebp),%eax
801079c0:	0f b6 90 8d 00 00 00 	movzbl 0x8d(%eax),%edx
801079c7:	83 ca 80             	or     $0xffffff80,%edx
801079ca:	88 90 8d 00 00 00    	mov    %dl,0x8d(%eax)
...
80107a1f:	0f b6 90 8e 00 00 00 	movzbl 0x8e(%eax),%edx
80107a26:	83 ca 80             	or     $0xffffff80,%edx
80107a29:	88 90 8e 00 00 00    	mov    %dl,0x8e(%eax)
80107a2f:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107a32:	c6 80 8f 00 00 00 00 	movb   $0x0,0x8f(%eax)
...
80107b19:	c7 44 24 04 30 00 00 	movl   $0x30,0x4(%esp)
80107b20:	00 
80107b21:	89 04 24             	mov    %eax,(%esp)
80107b24:	e8 61 fc ff ff       	call   8010778a <lgdt>
}
80107b29:	c9                   	leave  
80107b2a:	c3                   	ret    
...
80107b2e:	83 ec 28             	sub    $0x28,%esp
  pde_t *pde;
  pte_t *pgtab;

  pde = &pgdir[PDX(va)];
80107b31:	8b 45 0c             	mov    0xc(%ebp),%eax
80107b34:	c1 e8 16             	shr    $0x16,%eax
80107b37:	8d 14 85 00 00 00 00 	lea    0x0(,%eax,4),%edx
80107b3e:	8b 45 08             	mov    0x8(%ebp),%eax
80107b41:	01 d0                	add    %edx,%eax
80107b43:	89 45 f0             	mov    %eax,-0x10(%ebp)
  if(*pde & PTE_P){
80107b46:	8b 45 f0             	mov    -0x10(%ebp),%eax
80107b49:	8b 00                	mov    (%eax),%eax
80107b4b:	83 e0 01             	and    $0x1,%eax
80107b4e:	85 c0                	test   %eax,%eax
80107b50:	74 14                	je     80107b66 <walkpgdir+0x3b>
...
80107b64:	eb 48                	jmp    80107bae <walkpgdir+0x83>
  } else {
    if(!alloc || (pgtab = (pte_t*)kalloc()) == 0)
80107b66:	83 7d 10 00          	cmpl   $0x0,0x10(%ebp)
80107b6a:	74 0e                	je     80107b7a <walkpgdir+0x4f>
80107b6c:	e8 38 b0 ff ff       	call   80102ba9 <kalloc>
80107b71:	89 45 f4             	mov    %eax,-0xc(%ebp)
80107b74:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
80107b78:	75 07                	jne    80107b81 <walkpgdir+0x56>
      return 0;
80107b7a:	b8 00 00 00 00       	mov    $0x0,%eax
80107b7f:	eb 44                	jmp    80107bc5 <walkpgdir+0x9a>
    // Make sure all those PTE_P bits are zero.
    memset(pgtab, 0, PGSIZE);
80107b81:	c7 44 24 08 00 10 00 	movl   $0x1000,0x8(%esp)
80107b88:	00 
80107b89:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
80107b90:	00 
80107b91:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107b94:	89 04 24             	mov    %eax,(%esp)
80107b97:	e8 31 d7 ff ff       	call   801052cd <memset>
    // The permissions here are overly generous, but they can
    // be further restricted by the permissions in the page table
    // entries, if necessary.
    *pde = V2P(pgtab) | PTE_P | PTE_W | PTE_U;
80107b9c:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107b9f:	05 00 00 00 80       	add    $0x80000000,%eax
80107ba4:	83 c8 07             	or     $0x7,%eax
80107ba7:	89 c2                	mov    %eax,%edx
80107ba9:	8b 45 f0             	mov    -0x10(%ebp),%eax
80107bac:	89 10                	mov    %edx,(%eax)
  }
  return &pgtab[PTX(va)];
80107bae:	8b 45 0c             	mov    0xc(%ebp),%eax
80107bb1:	c1 e8 0c             	shr    $0xc,%eax
80107bb4:	25 ff 03 00 00       	and    $0x3ff,%eax
80107bb9:	8d 14 85 00 00 00 00 	lea    0x0(,%eax,4),%edx
80107bc0:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107bc3:	01 d0                	add    %edx,%eax
}
80107bc5:	c9                   	leave  
80107bc6:	c3                   	ret    
...
80107bdb:	8b 45 10             	mov    0x10(%ebp),%eax
...
80107beb:	c7 44 24 08 01 00 00 	movl   $0x1,0x8(%esp)
80107bf2:	00 
80107bf3:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107bf6:	89 44 24 04          	mov    %eax,0x4(%esp)
80107bfa:	8b 45 08             	mov    0x8(%ebp),%eax
80107bfd:	89 04 24             	mov    %eax,(%esp)
80107c00:	e8 26 ff ff ff       	call   80107b2b <walkpgdir>
80107c05:	89 45 ec             	mov    %eax,-0x14(%ebp)
80107c08:	83 7d ec 00          	cmpl   $0x0,-0x14(%ebp)
80107c0c:	75 07                	jne    80107c15 <mappages+0x4e>
      return -1;
80107c0e:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80107c13:	eb 48                	jmp    80107c5d <mappages+0x96>
    if(*pte & PTE_P)
80107c15:	8b 45 ec             	mov    -0x14(%ebp),%eax
80107c18:	8b 00                	mov    (%eax),%eax
80107c1a:	83 e0 01             	and    $0x1,%eax
80107c1d:	85 c0                	test   %eax,%eax
80107c1f:	74 0c                	je     80107c2d <mappages+0x66>
      panic("remap");
80107c21:	c7 04 24 3c 8b 10 80 	movl   $0x80108b3c,(%esp)
80107c28:	e8 35 89 ff ff       	call   80100562 <panic>
    *pte = pa | perm | PTE_P;
80107c2d:	8b 45 18             	mov    0x18(%ebp),%eax
80107c30:	0b 45 14             	or     0x14(%ebp),%eax
80107c33:	83 c8 01             	or     $0x1,%eax
80107c36:	89 c2                	mov    %eax,%edx
80107c38:	8b 45 ec             	mov    -0x14(%ebp),%eax
80107c3b:	89 10                	mov    %edx,(%eax)
    if(a == last)
80107c3d:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107c40:	3b 45 f0             	cmp    -0x10(%ebp),%eax
80107c43:	75 08                	jne    80107c4d <mappages+0x86>
      break;
80107c45:	90                   	nop
    a += PGSIZE;
    pa += PGSIZE;
...
80107c4b:	eb 10                	jmp    80107c5d <mappages+0x96>
    a += PGSIZE;
80107c4d:	81 45 f4 00 10 00 00 	addl   $0x1000,-0xc(%ebp)
    pa += PGSIZE;
80107c54:	81 45 14 00 10 00 00 	addl   $0x1000,0x14(%ebp)
  }
80107c5b:	eb 8e                	jmp    80107beb <mappages+0x24>
}
80107c5d:	c9                   	leave  
80107c5e:	c3                   	ret    
...
80107c63:	83 ec 34             	sub    $0x34,%esp
  pde_t *pgdir;
  struct kmap *k;

  if((pgdir = (pde_t*)kalloc()) == 0)
80107c66:	e8 3e af ff ff       	call   80102ba9 <kalloc>
80107c6b:	89 45 f0             	mov    %eax,-0x10(%ebp)
80107c6e:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
80107c72:	75 0a                	jne    80107c7e <setupkvm+0x1f>
    return 0;
80107c74:	b8 00 00 00 00       	mov    $0x0,%eax
80107c79:	e9 84 00 00 00       	jmp    80107d02 <setupkvm+0xa3>
  memset(pgdir, 0, PGSIZE);
80107c7e:	c7 44 24 08 00 10 00 	movl   $0x1000,0x8(%esp)
80107c85:	00 
80107c86:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
80107c8d:	00 
80107c8e:	8b 45 f0             	mov    -0x10(%ebp),%eax
80107c91:	89 04 24             	mov    %eax,(%esp)
80107c94:	e8 34 d6 ff ff       	call   801052cd <memset>
  if (P2V(PHYSTOP) > (void*)DEVSPACE)
    panic("PHYSTOP too high");
  for(k = kmap; k < &kmap[NELEM(kmap)]; k++)
80107c99:	c7 45 f4 c0 b4 10 80 	movl   $0x8010b4c0,-0xc(%ebp)
80107ca0:	eb 54                	jmp    80107cf6 <setupkvm+0x97>
    if(mappages(pgdir, k->virt, k->phys_end - k->phys_start,
80107ca2:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107ca5:	8b 48 0c             	mov    0xc(%eax),%ecx
80107ca8:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107cab:	8b 50 04             	mov    0x4(%eax),%edx
80107cae:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107cb1:	8b 58 08             	mov    0x8(%eax),%ebx
80107cb4:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107cb7:	8b 40 04             	mov    0x4(%eax),%eax
80107cba:	29 c3                	sub    %eax,%ebx
80107cbc:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107cbf:	8b 00                	mov    (%eax),%eax
80107cc1:	89 4c 24 10          	mov    %ecx,0x10(%esp)
80107cc5:	89 54 24 0c          	mov    %edx,0xc(%esp)
80107cc9:	89 5c 24 08          	mov    %ebx,0x8(%esp)
80107ccd:	89 44 24 04          	mov    %eax,0x4(%esp)
80107cd1:	8b 45 f0             	mov    -0x10(%ebp),%eax
80107cd4:	89 04 24             	mov    %eax,(%esp)
80107cd7:	e8 eb fe ff ff       	call   80107bc7 <mappages>
80107cdc:	85 c0                	test   %eax,%eax
80107cde:	79 12                	jns    80107cf2 <setupkvm+0x93>
                (uint)k->phys_start, k->perm) < 0) {
      freevm(pgdir);
80107ce0:	8b 45 f0             	mov    -0x10(%ebp),%eax
80107ce3:	89 04 24             	mov    %eax,(%esp)
80107ce6:	e8 26 05 00 00       	call   80108211 <freevm>
      return 0;
80107ceb:	b8 00 00 00 00       	mov    $0x0,%eax
80107cf0:	eb 10                	jmp    80107d02 <setupkvm+0xa3>
  for(k = kmap; k < &kmap[NELEM(kmap)]; k++)
80107cf2:	83 45 f4 10          	addl   $0x10,-0xc(%ebp)
80107cf6:	81 7d f4 00 b5 10 80 	cmpl   $0x8010b500,-0xc(%ebp)
80107cfd:	72 a3                	jb     80107ca2 <setupkvm+0x43>
    }
  return pgdir;
80107cff:	8b 45 f0             	mov    -0x10(%ebp),%eax
}
80107d02:	83 c4 34             	add    $0x34,%esp
80107d05:	5b                   	pop    %ebx
80107d06:	5d                   	pop    %ebp
80107d07:	c3                   	ret    
...
80107d0b:	83 ec 08             	sub    $0x8,%esp
  kpgdir = setupkvm();
80107d0e:	e8 4c ff ff ff       	call   80107c5f <setupkvm>
80107d13:	a3 64 67 11 80       	mov    %eax,0x80116764
  switchkvm();
80107d18:	e8 02 00 00 00       	call   80107d1f <switchkvm>
}
80107d1d:	c9                   	leave  
80107d1e:	c3                   	ret    
...
80107d25:	a1 64 67 11 80       	mov    0x80116764,%eax
80107d2a:	05 00 00 00 80       	add    $0x80000000,%eax
80107d2f:	89 04 24             	mov    %eax,(%esp)
80107d32:	e8 92 fa ff ff       	call   801077c9 <lcr3>
}
80107d37:	c9                   	leave  
80107d38:	c3                   	ret    
...
80107d3c:	57                   	push   %edi
80107d3d:	56                   	push   %esi
80107d3e:	53                   	push   %ebx
80107d3f:	83 ec 1c             	sub    $0x1c,%esp
  if(p == 0)
80107d42:	83 7d 08 00          	cmpl   $0x0,0x8(%ebp)
80107d46:	75 0c                	jne    80107d54 <switchuvm+0x1b>
    panic("switchuvm: no process");
80107d48:	c7 04 24 42 8b 10 80 	movl   $0x80108b42,(%esp)
80107d4f:	e8 0e 88 ff ff       	call   80100562 <panic>
  if(p->kstack == 0)
80107d54:	8b 45 08             	mov    0x8(%ebp),%eax
80107d57:	8b 40 08             	mov    0x8(%eax),%eax
80107d5a:	85 c0                	test   %eax,%eax
80107d5c:	75 0c                	jne    80107d6a <switchuvm+0x31>
    panic("switchuvm: no kstack");
80107d5e:	c7 04 24 58 8b 10 80 	movl   $0x80108b58,(%esp)
80107d65:	e8 f8 87 ff ff       	call   80100562 <panic>
  if(p->pgdir == 0)
80107d6a:	8b 45 08             	mov    0x8(%ebp),%eax
80107d6d:	8b 40 04             	mov    0x4(%eax),%eax
80107d70:	85 c0                	test   %eax,%eax
80107d72:	75 0c                	jne    80107d80 <switchuvm+0x47>
    panic("switchuvm: no pgdir");
80107d74:	c7 04 24 6d 8b 10 80 	movl   $0x80108b6d,(%esp)
80107d7b:	e8 e2 87 ff ff       	call   80100562 <panic>

  pushcli();
80107d80:	e8 43 d4 ff ff       	call   801051c8 <pushcli>
  mycpu()->gdt[SEG_TSS] = SEG16(STS_T32A, &mycpu()->ts,
80107d85:	e8 61 c3 ff ff       	call   801040eb <mycpu>
80107d8a:	89 c3                	mov    %eax,%ebx
80107d8c:	e8 5a c3 ff ff       	call   801040eb <mycpu>
80107d91:	83 c0 08             	add    $0x8,%eax
80107d94:	89 c7                	mov    %eax,%edi
80107d96:	e8 50 c3 ff ff       	call   801040eb <mycpu>
80107d9b:	83 c0 08             	add    $0x8,%eax
80107d9e:	c1 e8 10             	shr    $0x10,%eax
80107da1:	89 c6                	mov    %eax,%esi
80107da3:	e8 43 c3 ff ff       	call   801040eb <mycpu>
80107da8:	83 c0 08             	add    $0x8,%eax
80107dab:	c1 e8 18             	shr    $0x18,%eax
80107dae:	66 c7 83 98 00 00 00 	movw   $0x67,0x98(%ebx)
80107db5:	67 00 
80107db7:	66 89 bb 9a 00 00 00 	mov    %di,0x9a(%ebx)
80107dbe:	89 f1                	mov    %esi,%ecx
80107dc0:	88 8b 9c 00 00 00    	mov    %cl,0x9c(%ebx)
80107dc6:	0f b6 93 9d 00 00 00 	movzbl 0x9d(%ebx),%edx
80107dcd:	83 e2 f0             	and    $0xfffffff0,%edx
80107dd0:	83 ca 09             	or     $0x9,%edx
80107dd3:	88 93 9d 00 00 00    	mov    %dl,0x9d(%ebx)
80107dd9:	0f b6 93 9d 00 00 00 	movzbl 0x9d(%ebx),%edx
80107de0:	83 ca 10             	or     $0x10,%edx
80107de3:	88 93 9d 00 00 00    	mov    %dl,0x9d(%ebx)
80107de9:	0f b6 93 9d 00 00 00 	movzbl 0x9d(%ebx),%edx
...
80107e00:	83 ca 80             	or     $0xffffff80,%edx
80107e03:	88 93 9d 00 00 00    	mov    %dl,0x9d(%ebx)
80107e09:	0f b6 93 9e 00 00 00 	movzbl 0x9e(%ebx),%edx
80107e10:	83 e2 f0             	and    $0xfffffff0,%edx
80107e13:	88 93 9e 00 00 00    	mov    %dl,0x9e(%ebx)
80107e19:	0f b6 93 9e 00 00 00 	movzbl 0x9e(%ebx),%edx
80107e20:	83 e2 ef             	and    $0xffffffef,%edx
80107e23:	88 93 9e 00 00 00    	mov    %dl,0x9e(%ebx)
80107e29:	0f b6 93 9e 00 00 00 	movzbl 0x9e(%ebx),%edx
80107e30:	83 e2 df             	and    $0xffffffdf,%edx
...
80107e50:	83 e2 7f             	and    $0x7f,%edx
80107e53:	88 93 9e 00 00 00    	mov    %dl,0x9e(%ebx)
80107e59:	88 83 9f 00 00 00    	mov    %al,0x9f(%ebx)
                                sizeof(mycpu()->ts)-1, 0);
  mycpu()->gdt[SEG_TSS].s = 0;
80107e5f:	e8 87 c2 ff ff       	call   801040eb <mycpu>
80107e64:	0f b6 90 9d 00 00 00 	movzbl 0x9d(%eax),%edx
80107e6b:	83 e2 ef             	and    $0xffffffef,%edx
80107e6e:	88 90 9d 00 00 00    	mov    %dl,0x9d(%eax)
  mycpu()->ts.ss0 = SEG_KDATA << 3;
80107e74:	e8 72 c2 ff ff       	call   801040eb <mycpu>
80107e79:	66 c7 40 10 10 00    	movw   $0x10,0x10(%eax)
  mycpu()->ts.esp0 = (uint)p->kstack + KSTACKSIZE;
80107e7f:	e8 67 c2 ff ff       	call   801040eb <mycpu>
80107e84:	8b 55 08             	mov    0x8(%ebp),%edx
80107e87:	8b 52 08             	mov    0x8(%edx),%edx
80107e8a:	81 c2 00 10 00 00    	add    $0x1000,%edx
80107e90:	89 50 0c             	mov    %edx,0xc(%eax)
  // setting IOPL=0 in eflags *and* iomb beyond the tss segment limit
  // forbids I/O instructions (e.g., inb and outb) from user space
  mycpu()->ts.iomb = (ushort) 0xFFFF;
80107e93:	e8 53 c2 ff ff       	call   801040eb <mycpu>
80107e98:	66 c7 40 6e ff ff    	movw   $0xffff,0x6e(%eax)
  ltr(SEG_TSS << 3);
80107e9e:	c7 04 24 28 00 00 00 	movl   $0x28,(%esp)
80107ea5:	e8 09 f9 ff ff       	call   801077b3 <ltr>
  lcr3(V2P(p->pgdir));  // switch to process's address space
80107eaa:	8b 45 08             	mov    0x8(%ebp),%eax
80107ead:	8b 40 04             	mov    0x4(%eax),%eax
80107eb0:	05 00 00 00 80       	add    $0x80000000,%eax
80107eb5:	89 04 24             	mov    %eax,(%esp)
80107eb8:	e8 0c f9 ff ff       	call   801077c9 <lcr3>
  popcli();
80107ebd:	e8 52 d3 ff ff       	call   80105214 <popcli>
}
80107ec2:	83 c4 1c             	add    $0x1c,%esp
80107ec5:	5b                   	pop    %ebx
80107ec6:	5e                   	pop    %esi
80107ec7:	5f                   	pop    %edi
80107ec8:	5d                   	pop    %ebp
...
80107ed9:	c7 04 24 81 8b 10 80 	movl   $0x80108b81,(%esp)
80107ee0:	e8 7d 86 ff ff       	call   80100562 <panic>
  mem = kalloc();
80107ee5:	e8 bf ac ff ff       	call   80102ba9 <kalloc>
...
80107f03:	e8 c5 d3 ff ff       	call   801052cd <memset>
  mappages(pgdir, 0, PGSIZE, V2P(mem), PTE_W|PTE_U);
80107f08:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107f0b:	05 00 00 00 80       	add    $0x80000000,%eax
80107f10:	c7 44 24 10 06 00 00 	movl   $0x6,0x10(%esp)
80107f17:	00 
80107f18:	89 44 24 0c          	mov    %eax,0xc(%esp)
80107f1c:	c7 44 24 08 00 10 00 	movl   $0x1000,0x8(%esp)
80107f23:	00 
80107f24:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
80107f2b:	00 
80107f2c:	8b 45 08             	mov    0x8(%ebp),%eax
80107f2f:	89 04 24             	mov    %eax,(%esp)
80107f32:	e8 90 fc ff ff       	call   80107bc7 <mappages>
  memmove(mem, init, sz);
80107f37:	8b 45 10             	mov    0x10(%ebp),%eax
80107f3a:	89 44 24 08          	mov    %eax,0x8(%esp)
...
80107f4b:	e8 4c d4 ff ff       	call   8010539c <memmove>
}
80107f50:	c9                   	leave  
80107f51:	c3                   	ret    
...
80107f55:	83 ec 28             	sub    $0x28,%esp
  uint i, pa, n;
  pte_t *pte;
...
80107f62:	74 0c                	je     80107f70 <loaduvm+0x1e>
    panic("loaduvm: addr must be page aligned");
80107f64:	c7 04 24 9c 8b 10 80 	movl   $0x80108b9c,(%esp)
80107f6b:	e8 f2 85 ff ff       	call   80100562 <panic>
  for(i = 0; i < sz; i += PGSIZE){
80107f70:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%ebp)
80107f77:	e9 a6 00 00 00       	jmp    80108022 <loaduvm+0xd0>
    if((pte = walkpgdir(pgdir, addr+i, 0)) == 0)
80107f7c:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107f7f:	8b 55 0c             	mov    0xc(%ebp),%edx
80107f82:	01 d0                	add    %edx,%eax
80107f84:	c7 44 24 08 00 00 00 	movl   $0x0,0x8(%esp)
80107f8b:	00 
80107f8c:	89 44 24 04          	mov    %eax,0x4(%esp)
80107f90:	8b 45 08             	mov    0x8(%ebp),%eax
80107f93:	89 04 24             	mov    %eax,(%esp)
80107f96:	e8 90 fb ff ff       	call   80107b2b <walkpgdir>
80107f9b:	89 45 ec             	mov    %eax,-0x14(%ebp)
80107f9e:	83 7d ec 00          	cmpl   $0x0,-0x14(%ebp)
80107fa2:	75 0c                	jne    80107fb0 <loaduvm+0x5e>
      panic("loaduvm: address should exist");
80107fa4:	c7 04 24 bf 8b 10 80 	movl   $0x80108bbf,(%esp)
80107fab:	e8 b2 85 ff ff       	call   80100562 <panic>
    pa = PTE_ADDR(*pte);
80107fb0:	8b 45 ec             	mov    -0x14(%ebp),%eax
80107fb3:	8b 00                	mov    (%eax),%eax
80107fb5:	25 00 f0 ff ff       	and    $0xfffff000,%eax
80107fba:	89 45 e8             	mov    %eax,-0x18(%ebp)
    if(sz - i < PGSIZE)
80107fbd:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107fc0:	8b 55 18             	mov    0x18(%ebp),%edx
80107fc3:	29 c2                	sub    %eax,%edx
80107fc5:	89 d0                	mov    %edx,%eax
80107fc7:	3d ff 0f 00 00       	cmp    $0xfff,%eax
80107fcc:	77 0f                	ja     80107fdd <loaduvm+0x8b>
      n = sz - i;
80107fce:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107fd1:	8b 55 18             	mov    0x18(%ebp),%edx
80107fd4:	29 c2                	sub    %eax,%edx
80107fd6:	89 d0                	mov    %edx,%eax
80107fd8:	89 45 f0             	mov    %eax,-0x10(%ebp)
80107fdb:	eb 07                	jmp    80107fe4 <loaduvm+0x92>
    else
      n = PGSIZE;
80107fdd:	c7 45 f0 00 10 00 00 	movl   $0x1000,-0x10(%ebp)
    if(readi(ip, P2V(pa), offset+i, n) != n)
80107fe4:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107fe7:	8b 55 14             	mov    0x14(%ebp),%edx
80107fea:	8d 0c 02             	lea    (%edx,%eax,1),%ecx
80107fed:	8b 45 e8             	mov    -0x18(%ebp),%eax
80107ff0:	05 00 00 00 80       	add    $0x80000000,%eax
80107ff5:	8b 55 f0             	mov    -0x10(%ebp),%edx
80107ff8:	89 54 24 0c          	mov    %edx,0xc(%esp)
80107ffc:	89 4c 24 08          	mov    %ecx,0x8(%esp)
80108000:	89 44 24 04          	mov    %eax,0x4(%esp)
80108004:	8b 45 10             	mov    0x10(%ebp),%eax
80108007:	89 04 24             	mov    %eax,(%esp)
8010800a:	e8 eb 9d ff ff       	call   80101dfa <readi>
8010800f:	3b 45 f0             	cmp    -0x10(%ebp),%eax
80108012:	74 07                	je     8010801b <loaduvm+0xc9>
      return -1;
80108014:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80108019:	eb 18                	jmp    80108033 <loaduvm+0xe1>
  for(i = 0; i < sz; i += PGSIZE){
8010801b:	81 45 f4 00 10 00 00 	addl   $0x1000,-0xc(%ebp)
80108022:	8b 45 f4             	mov    -0xc(%ebp),%eax
80108025:	3b 45 18             	cmp    0x18(%ebp),%eax
80108028:	0f 82 4e ff ff ff    	jb     80107f7c <loaduvm+0x2a>
  }
  return 0;
8010802e:	b8 00 00 00 00       	mov    $0x0,%eax
}
80108033:	c9                   	leave  
80108034:	c3                   	ret    
...
80108038:	83 ec 38             	sub    $0x38,%esp
  char *mem;
  uint a;

  if(newsz >= KERNBASE)
8010803b:	8b 45 10             	mov    0x10(%ebp),%eax
8010803e:	85 c0                	test   %eax,%eax
80108040:	79 0a                	jns    8010804c <allocuvm+0x17>
    return 0;
80108042:	b8 00 00 00 00       	mov    $0x0,%eax
80108047:	e9 fd 00 00 00       	jmp    80108149 <allocuvm+0x114>
  if(newsz < oldsz)
8010804c:	8b 45 10             	mov    0x10(%ebp),%eax
8010804f:	3b 45 0c             	cmp    0xc(%ebp),%eax
80108052:	73 08                	jae    8010805c <allocuvm+0x27>
    return oldsz;
80108054:	8b 45 0c             	mov    0xc(%ebp),%eax
80108057:	e9 ed 00 00 00       	jmp    80108149 <allocuvm+0x114>

  a = PGROUNDUP(oldsz);
8010805c:	8b 45 0c             	mov    0xc(%ebp),%eax
8010805f:	05 ff 0f 00 00       	add    $0xfff,%eax
80108064:	25 00 f0 ff ff       	and    $0xfffff000,%eax
80108069:	89 45 f4             	mov    %eax,-0xc(%ebp)
  for(; a < newsz; a += PGSIZE){
8010806c:	e9 c9 00 00 00       	jmp    8010813a <allocuvm+0x105>
    mem = kalloc();
80108071:	e8 33 ab ff ff       	call   80102ba9 <kalloc>
80108076:	89 45 f0             	mov    %eax,-0x10(%ebp)
    if(mem == 0){
80108079:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
8010807d:	75 2f                	jne    801080ae <allocuvm+0x79>
      cprintf("allocuvm out of memory\n");
8010807f:	c7 04 24 dd 8b 10 80 	movl   $0x80108bdd,(%esp)
...
8010809f:	e8 a7 00 00 00       	call   8010814b <deallocuvm>
      return 0;
801080a4:	b8 00 00 00 00       	mov    $0x0,%eax
801080a9:	e9 9b 00 00 00       	jmp    80108149 <allocuvm+0x114>
    }
    memset(mem, 0, PGSIZE);
801080ae:	c7 44 24 08 00 10 00 	movl   $0x1000,0x8(%esp)
801080b5:	00 
801080b6:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
801080bd:	00 
801080be:	8b 45 f0             	mov    -0x10(%ebp),%eax
801080c1:	89 04 24             	mov    %eax,(%esp)
801080c4:	e8 04 d2 ff ff       	call   801052cd <memset>
    if(mappages(pgdir, (char*)a, PGSIZE, V2P(mem), PTE_W|PTE_U) < 0){
801080c9:	8b 45 f0             	mov    -0x10(%ebp),%eax
801080cc:	8d 90 00 00 00 80    	lea    -0x80000000(%eax),%edx
801080d2:	8b 45 f4             	mov    -0xc(%ebp),%eax
801080d5:	c7 44 24 10 06 00 00 	movl   $0x6,0x10(%esp)
801080dc:	00 
801080dd:	89 54 24 0c          	mov    %edx,0xc(%esp)
...
801080f3:	e8 cf fa ff ff       	call   80107bc7 <mappages>
801080f8:	85 c0                	test   %eax,%eax
801080fa:	79 37                	jns    80108133 <allocuvm+0xfe>
      cprintf("allocuvm out of memory (2)\n");
801080fc:	c7 04 24 f5 8b 10 80 	movl   $0x80108bf5,(%esp)
80108103:	e8 c0 82 ff ff       	call   801003c8 <cprintf>
      deallocuvm(pgdir, newsz, oldsz);
...
8010811c:	e8 2a 00 00 00       	call   8010814b <deallocuvm>
      kfree(mem);
80108121:	8b 45 f0             	mov    -0x10(%ebp),%eax
80108124:	89 04 24             	mov    %eax,(%esp)
80108127:	e8 e7 a9 ff ff       	call   80102b13 <kfree>
      return 0;
8010812c:	b8 00 00 00 00       	mov    $0x0,%eax
80108131:	eb 16                	jmp    80108149 <allocuvm+0x114>
  for(; a < newsz; a += PGSIZE){
80108133:	81 45 f4 00 10 00 00 	addl   $0x1000,-0xc(%ebp)
8010813a:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010813d:	3b 45 10             	cmp    0x10(%ebp),%eax
80108140:	0f 82 2b ff ff ff    	jb     80108071 <allocuvm+0x3c>
    }
  }
  return newsz;
...
80108157:	72 08                	jb     80108161 <deallocuvm+0x16>
    return oldsz;
80108159:	8b 45 0c             	mov    0xc(%ebp),%eax
8010815c:	e9 ae 00 00 00       	jmp    8010820f <deallocuvm+0xc4>
...
80108171:	e9 8a 00 00 00       	jmp    80108200 <deallocuvm+0xb5>
...
8010818b:	e8 9b f9 ff ff       	call   80107b2b <walkpgdir>
80108190:	89 45 f0             	mov    %eax,-0x10(%ebp)
    if(!pte)
80108193:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
80108197:	75 16                	jne    801081af <deallocuvm+0x64>
      a = PGADDR(PDX(a) + 1, 0, 0) - PGSIZE;
80108199:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010819c:	c1 e8 16             	shr    $0x16,%eax
8010819f:	83 c0 01             	add    $0x1,%eax
801081a2:	c1 e0 16             	shl    $0x16,%eax
801081a5:	2d 00 10 00 00       	sub    $0x1000,%eax
801081aa:	89 45 f4             	mov    %eax,-0xc(%ebp)
801081ad:	eb 4a                	jmp    801081f9 <deallocuvm+0xae>
    else if((*pte & PTE_P) != 0){
801081af:	8b 45 f0             	mov    -0x10(%ebp),%eax
801081b2:	8b 00                	mov    (%eax),%eax
801081b4:	83 e0 01             	and    $0x1,%eax
801081b7:	85 c0                	test   %eax,%eax
801081b9:	74 3e                	je     801081f9 <deallocuvm+0xae>
      pa = PTE_ADDR(*pte);
801081bb:	8b 45 f0             	mov    -0x10(%ebp),%eax
801081be:	8b 00                	mov    (%eax),%eax
801081c0:	25 00 f0 ff ff       	and    $0xfffff000,%eax
801081c5:	89 45 ec             	mov    %eax,-0x14(%ebp)
      if(pa == 0)
801081c8:	83 7d ec 00          	cmpl   $0x0,-0x14(%ebp)
801081cc:	75 0c                	jne    801081da <deallocuvm+0x8f>
        panic("kfree");
801081ce:	c7 04 24 11 8c 10 80 	movl   $0x80108c11,(%esp)
801081d5:	e8 88 83 ff ff       	call   80100562 <panic>
      char *v = P2V(pa);
801081da:	8b 45 ec             	mov    -0x14(%ebp),%eax
801081dd:	05 00 00 00 80       	add    $0x80000000,%eax
801081e2:	89 45 e8             	mov    %eax,-0x18(%ebp)
      kfree(v);
801081e5:	8b 45 e8             	mov    -0x18(%ebp),%eax
801081e8:	89 04 24             	mov    %eax,(%esp)
801081eb:	e8 23 a9 ff ff       	call   80102b13 <kfree>
      *pte = 0;
801081f0:	8b 45 f0             	mov    -0x10(%ebp),%eax
801081f3:	c7 00 00 00 00 00    	movl   $0x0,(%eax)
  for(; a  < oldsz; a += PGSIZE){
801081f9:	81 45 f4 00 10 00 00 	addl   $0x1000,-0xc(%ebp)
80108200:	8b 45 f4             	mov    -0xc(%ebp),%eax
80108203:	3b 45 0c             	cmp    0xc(%ebp),%eax
80108206:	0f 82 6a ff ff ff    	jb     80108176 <deallocuvm+0x2b>
    }
  }
  return newsz;
...
80108214:	83 ec 28             	sub    $0x28,%esp
  uint i;

  if(pgdir == 0)
80108217:	83 7d 08 00          	cmpl   $0x0,0x8(%ebp)
8010821b:	75 0c                	jne    80108229 <freevm+0x18>
    panic("freevm: no pgdir");
8010821d:	c7 04 24 17 8c 10 80 	movl   $0x80108c17,(%esp)
80108224:	e8 39 83 ff ff       	call   80100562 <panic>
  deallocuvm(pgdir, KERNBASE, 0);
80108229:	c7 44 24 08 00 00 00 	movl   $0x0,0x8(%esp)
80108230:	00 
80108231:	c7 44 24 04 00 00 00 	movl   $0x80000000,0x4(%esp)
80108238:	80 
80108239:	8b 45 08             	mov    0x8(%ebp),%eax
8010823c:	89 04 24             	mov    %eax,(%esp)
8010823f:	e8 07 ff ff ff       	call   8010814b <deallocuvm>
  for(i = 0; i < NPDENTRIES; i++){
80108244:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%ebp)
8010824b:	eb 45                	jmp    80108292 <freevm+0x81>
    if(pgdir[i] & PTE_P){
...
80108263:	74 29                	je     8010828e <freevm+0x7d>
...
8010827b:	05 00 00 00 80       	add    $0x80000000,%eax
80108280:	89 45 f0             	mov    %eax,-0x10(%ebp)
      kfree(v);
80108283:	8b 45 f0             	mov    -0x10(%ebp),%eax
80108286:	89 04 24             	mov    %eax,(%esp)
80108289:	e8 85 a8 ff ff       	call   80102b13 <kfree>
  for(i = 0; i < NPDENTRIES; i++){
8010828e:	83 45 f4 01          	addl   $0x1,-0xc(%ebp)
80108292:	81 7d f4 ff 03 00 00 	cmpl   $0x3ff,-0xc(%ebp)
80108299:	76 b2                	jbe    8010824d <freevm+0x3c>
    }
  }
  kfree((char*)pgdir);
8010829b:	8b 45 08             	mov    0x8(%ebp),%eax
8010829e:	89 04 24             	mov    %eax,(%esp)
801082a1:	e8 6d a8 ff ff       	call   80102b13 <kfree>
}
801082a6:	c9                   	leave  
801082a7:	c3                   	ret    
...
801082ab:	83 ec 28             	sub    $0x28,%esp
  pte_t *pte;

  pte = walkpgdir(pgdir, uva, 0);
801082ae:	c7 44 24 08 00 00 00 	movl   $0x0,0x8(%esp)
801082b5:	00 
801082b6:	8b 45 0c             	mov    0xc(%ebp),%eax
801082b9:	89 44 24 04          	mov    %eax,0x4(%esp)
801082bd:	8b 45 08             	mov    0x8(%ebp),%eax
801082c0:	89 04 24             	mov    %eax,(%esp)
801082c3:	e8 63 f8 ff ff       	call   80107b2b <walkpgdir>
801082c8:	89 45 f4             	mov    %eax,-0xc(%ebp)
  if(pte == 0)
801082cb:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
801082cf:	75 0c                	jne    801082dd <clearpteu+0x35>
    panic("clearpteu");
801082d1:	c7 04 24 28 8c 10 80 	movl   $0x80108c28,(%esp)
801082d8:	e8 85 82 ff ff       	call   80100562 <panic>
  *pte &= ~PTE_U;
801082dd:	8b 45 f4             	mov    -0xc(%ebp),%eax
801082e0:	8b 00                	mov    (%eax),%eax
801082e2:	83 e0 fb             	and    $0xfffffffb,%eax
801082e5:	89 c2                	mov    %eax,%edx
...
801082f1:	83 ec 48             	sub    $0x48,%esp
  pde_t *d;
  pte_t *pte;
  uint pa, i, flags;
  char *mem;
  ...
  if((d = setupkvm()) == 0)
801082f4:	e8 66 f9 ff ff       	call   80107c5f <setupkvm>
801082f9:	89 45 f0             	mov    %eax,-0x10(%ebp)
801082fc:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
80108300:	75 0a                	jne    8010830c <copyuvm+0x1e>
    return 0;
80108302:	b8 00 00 00 00       	mov    $0x0,%eax
80108307:	e9 03 01 00 00       	jmp    8010840f <copyuvm+0x121>
  for(i = 0; i < sz; i += PGSIZE){
8010830c:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%ebp)
80108313:	e9 d6 00 00 00       	jmp    801083ee <copyuvm+0x100>
...
8010832d:	e8 f9 f7 ff ff       	call   80107b2b <walkpgdir>
80108332:	89 45 ec             	mov    %eax,-0x14(%ebp)
80108335:	83 7d ec 00          	cmpl   $0x0,-0x14(%ebp)
80108339:	75 0c                	jne    80108347 <copyuvm+0x59>
      panic("copyuvm: pte should exist");
8010833b:	c7 04 24 32 8c 10 80 	movl   $0x80108c32,(%esp)
80108342:	e8 1b 82 ff ff       	call   80100562 <panic>
    if(!(*pte & PTE_P))
80108347:	8b 45 ec             	mov    -0x14(%ebp),%eax
8010834a:	8b 00                	mov    (%eax),%eax
8010834c:	83 e0 01             	and    $0x1,%eax
8010834f:	85 c0                	test   %eax,%eax
80108351:	75 0c                	jne    8010835f <copyuvm+0x71>
      panic("copyuvm: page not present");
80108353:	c7 04 24 4c 8c 10 80 	movl   $0x80108c4c,(%esp)
8010835a:	e8 03 82 ff ff       	call   80100562 <panic>
    pa = PTE_ADDR(*pte);
8010835f:	8b 45 ec             	mov    -0x14(%ebp),%eax
80108362:	8b 00                	mov    (%eax),%eax
80108364:	25 00 f0 ff ff       	and    $0xfffff000,%eax
80108369:	89 45 e8             	mov    %eax,-0x18(%ebp)
    flags = PTE_FLAGS(*pte);
8010836c:	8b 45 ec             	mov    -0x14(%ebp),%eax
8010836f:	8b 00                	mov    (%eax),%eax
80108371:	25 ff 0f 00 00       	and    $0xfff,%eax
80108376:	89 45 e4             	mov    %eax,-0x1c(%ebp)
    if((mem = kalloc()) == 0)
80108379:	e8 2b a8 ff ff       	call   80102ba9 <kalloc>
8010837e:	89 45 e0             	mov    %eax,-0x20(%ebp)
80108381:	83 7d e0 00          	cmpl   $0x0,-0x20(%ebp)
80108385:	75 02                	jne    80108389 <copyuvm+0x9b>
      goto bad;
80108387:	eb 76                	jmp    801083ff <copyuvm+0x111>
    memmove(mem, (char*)P2V(pa), PGSIZE);
80108389:	8b 45 e8             	mov    -0x18(%ebp),%eax
8010838c:	05 00 00 00 80       	add    $0x80000000,%eax
80108391:	c7 44 24 08 00 10 00 	movl   $0x1000,0x8(%esp)
80108398:	00 
80108399:	89 44 24 04          	mov    %eax,0x4(%esp)
8010839d:	8b 45 e0             	mov    -0x20(%ebp),%eax
801083a0:	89 04 24             	mov    %eax,(%esp)
801083a3:	e8 f4 cf ff ff       	call   8010539c <memmove>
    if(mappages(d, (void*)i, PGSIZE, V2P(mem), flags) < 0) {
801083a8:	8b 55 e4             	mov    -0x1c(%ebp),%edx
801083ab:	8b 45 e0             	mov    -0x20(%ebp),%eax
801083ae:	8d 88 00 00 00 80    	lea    -0x80000000(%eax),%ecx
801083b4:	8b 45 f4             	mov    -0xc(%ebp),%eax
801083b7:	89 54 24 10          	mov    %edx,0x10(%esp)
801083bb:	89 4c 24 0c          	mov    %ecx,0xc(%esp)
801083bf:	c7 44 24 08 00 10 00 	movl   $0x1000,0x8(%esp)
801083c6:	00 
801083c7:	89 44 24 04          	mov    %eax,0x4(%esp)
801083cb:	8b 45 f0             	mov    -0x10(%ebp),%eax
801083ce:	89 04 24             	mov    %eax,(%esp)
801083d1:	e8 f1 f7 ff ff       	call   80107bc7 <mappages>
801083d6:	85 c0                	test   %eax,%eax
801083d8:	79 0d                	jns    801083e7 <copyuvm+0xf9>
      kfree(mem);
801083da:	8b 45 e0             	mov    -0x20(%ebp),%eax
801083dd:	89 04 24             	mov    %eax,(%esp)
801083e0:	e8 2e a7 ff ff       	call   80102b13 <kfree>
      goto bad;
801083e5:	eb 18                	jmp    801083ff <copyuvm+0x111>
  for(i = 0; i < sz; i += PGSIZE){
801083e7:	81 45 f4 00 10 00 00 	addl   $0x1000,-0xc(%ebp)
801083ee:	8b 45 f4             	mov    -0xc(%ebp),%eax
801083f1:	3b 45 0c             	cmp    0xc(%ebp),%eax
801083f4:	0f 82 1e ff ff ff    	jb     80108318 <copyuvm+0x2a>
    }
  }
  return d;
801083fa:	8b 45 f0             	mov    -0x10(%ebp),%eax
801083fd:	eb 10                	jmp    8010840f <copyuvm+0x121>

bad:
  freevm(d);
801083ff:	8b 45 f0             	mov    -0x10(%ebp),%eax
80108402:	89 04 24             	mov    %eax,(%esp)
80108405:	e8 07 fe ff ff       	call   80108211 <freevm>
  return 0;
...
80108414:	83 ec 28             	sub    $0x28,%esp
  pte_t *pte;
...
8010842c:	e8 fa f6 ff ff       	call   80107b2b <walkpgdir>
...
80108474:	89 45 f4             	mov    %eax,-0xc(%ebp)
  while(len > 0){
80108477:	e9 87 00 00 00       	jmp    80108503 <copyout+0x98>
    va0 = (uint)PGROUNDDOWN(va);
8010847c:	8b 45 0c             	mov    0xc(%ebp),%eax
8010847f:	25 00 f0 ff ff       	and    $0xfffff000,%eax
80108484:	89 45 ec             	mov    %eax,-0x14(%ebp)
...
80108494:	e8 78 ff ff ff       	call   80108411 <uva2ka>
80108499:	89 45 e8             	mov    %eax,-0x18(%ebp)
    if(pa0 == 0)
8010849c:	83 7d e8 00          	cmpl   $0x0,-0x18(%ebp)
801084a0:	75 07                	jne    801084a9 <copyout+0x3e>
      return -1;
801084a2:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
801084a7:	eb 69                	jmp    80108512 <copyout+0xa7>
    n = PGSIZE - (va - va0);
801084a9:	8b 45 0c             	mov    0xc(%ebp),%eax
801084ac:	8b 55 ec             	mov    -0x14(%ebp),%edx
801084af:	29 c2                	sub    %eax,%edx
801084b1:	89 d0                	mov    %edx,%eax
801084b3:	05 00 10 00 00       	add    $0x1000,%eax
801084b8:	89 45 f0             	mov    %eax,-0x10(%ebp)
    if(n > len)
801084bb:	8b 45 f0             	mov    -0x10(%ebp),%eax
801084be:	3b 45 14             	cmp    0x14(%ebp),%eax
801084c1:	76 06                	jbe    801084c9 <copyout+0x5e>
      n = len;
801084c3:	8b 45 14             	mov    0x14(%ebp),%eax
...
801084d1:	8b 45 e8             	mov    -0x18(%ebp),%eax
801084d4:	01 c2                	add    %eax,%edx
...
801084e4:	89 14 24             	mov    %edx,(%esp)
801084e7:	e8 b0 ce ff ff       	call   8010539c <memmove>
    len -= n;
801084ec:	8b 45 f0             	mov    -0x10(%ebp),%eax
801084ef:	29 45 14             	sub    %eax,0x14(%ebp)
    buf += n;
801084f2:	8b 45 f0             	mov    -0x10(%ebp),%eax
801084f5:	01 45 f4             	add    %eax,-0xc(%ebp)
    va = va0 + PGSIZE;
801084f8:	8b 45 ec             	mov    -0x14(%ebp),%eax
801084fb:	05 00 10 00 00       	add    $0x1000,%eax
80108500:	89 45 0c             	mov    %eax,0xc(%ebp)
  while(len > 0){
80108503:	83 7d 14 00          	cmpl   $0x0,0x14(%ebp)
80108507:	0f 85 6f ff ff ff    	jne    8010847c <copyout+0x11>
  }
  return 0;
